...
kernel_flash_kmeans_assign_highd_paired_ownerreduce_r39_reduce1_unroll_v1(unsigned long long* __restrict__ partial_keys, int* __restrict__ out, int B, int N, int K, int num_n_tiles, int K_slices)
{
