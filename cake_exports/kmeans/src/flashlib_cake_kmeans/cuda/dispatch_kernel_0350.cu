...
kernel_flash_kmeans_assign_d416_exactd_splitd_a4a579d1_v2(float* __restrict__ x_sq, float* __restrict__ c_sq, int32_t* __restrict__ out, const void* x_tmap, const void* c_tmap, int B, int N, int D, int K, int num_n_tiles, int K_tiles)
{
