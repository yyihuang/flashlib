...
kernel_flash_kmeans_assign_d480_splitk_reduce_d32k256_v1(float* __restrict__ partial_scores, int32_t* __restrict__ partial_indices, int32_t* __restrict__ out, int B, int N, int K, int num_n_tiles, int K_slices)
{
