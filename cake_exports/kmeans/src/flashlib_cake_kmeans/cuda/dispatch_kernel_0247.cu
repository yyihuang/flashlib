...
kernel_flash_kmeans_assign_d288_splitk_cta_0438_v1_reduce(float* __restrict__ partial_scores, int32_t* __restrict__ partial_indices, int32_t* __restrict__ out, int B, int N, int K, int num_n_tiles, int K_tiles)
{
