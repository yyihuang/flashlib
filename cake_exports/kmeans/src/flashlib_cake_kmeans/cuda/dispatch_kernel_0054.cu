        ...
        { // mma_main
            ...
            for (unsigned int tile_idx_1 = bid; tile_idx_1 < num_tiles_1; tile_idx_1 += num_bids) {
                ...
                for (int iter_k_1 = 0; iter_k_1 < K_tiles; iter_k_1++) {
                    ...
                    asm volatile("tcgen05.fence::after_thread_sync;");
                    int _mma_a_addr_2 = smem_x1_addr;
                    int _mma_a_lo_2 = make_warp_uniform((_mma_a_addr_2 >> 4) & 0x3FFF);
                    int _mma_b_addr_2 = smem_c_addr;
                    ...
                    "@leader tcgen05.mma.cta_group::1.kind::f16 [%2], da, db, id, p1;\n\t"
                    "}\n"
                    :: "r"(_mma_a_lo_2), "r"(_mma_b_lo_2), "r"(tmem_score_tmem), "r"(0));
                    asm volatile("tcgen05.fence::after_thread_sync;");
                    int _mma_a_addr_3 = smem_x1_addr + 16384;
                    int _mma_a_lo_3 = make_warp_uniform((_mma_a_addr_3 >> 4) & 0x3FFF);
                    int _mma_b_addr_3 = smem_c_addr + 32768;
                    ...
                    "@leader tcgen05.mma.cta_group::1.kind::f16 [%2], da, db, id, p1;\n\t"
                    "}\n"
                    :: "r"(_mma_a_lo_3), "r"(_mma_b_lo_3), "r"(tmem_score_tmem), "r"(1));
