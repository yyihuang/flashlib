...
kernel_flash_kmeans_assign_d288_splitk_cta_0438_v1_partial(float* __restrict__ c_sq, float* __restrict__ partial_scores, int32_t* __restrict__ partial_indices, const void* x_tmap, const void* c_tmap, int B, int N, int D, int K, int num_n_tiles, int K_tiles)
{
