...
kernel_flash_kmeans_assign_highd_paired_packedpartial_producer_7b3c_v1(const void* __restrict__ x_tmap, const void* __restrict__ c_tmap, float* __restrict__ c_sq, unsigned long long* __restrict__ partial_keys, int B, int N, int D, int K, int num_n_tiles, int K_tiles, int K_slices)
{
