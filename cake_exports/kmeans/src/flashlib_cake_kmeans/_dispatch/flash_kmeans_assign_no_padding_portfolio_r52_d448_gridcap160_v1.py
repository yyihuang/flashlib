...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_no_padding_portfolio_r52_d448_gridcap160_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 75776, "cta_group": 1, "threads": 192}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    if _r51._is_d448_paired(bsz=bsz, n_points=n_points, dim=dim, n_clusters=n_clusters):
        ...
        if k_slices != _r47.PAIRED_K_SLICES:
            raise ValueError(f'{ROUTE_ID} requires K_slices={_r47.PAIRED_K_SLICES}, got {k_slices}')
