...
flash_kmeans_assign_d480_splitk_partial_d32k256_v1 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_d480_splitk_producer_reducer_d32k256_v1:flash_kmeans_assign_d480_splitk_partial_d32k256_v1', 256)
flash_kmeans_assign_d480_splitk_reduce_d32k256_v1 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_d480_splitk_producer_reducer_d32k256_v1:flash_kmeans_assign_d480_splitk_reduce_d32k256_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_d480_splitk_producer_reducer_d32k256_v1:partial_ir"}'))
reduce_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_d480_splitk_producer_reducer_d32k256_v1:reduce_ir"}'))

def _verify_export_ir() -> Any:
    if os.environ.get(VERIFY_ENV) == 'reduce':
        return reduce_ir
    return partial_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_d480_splitk_producer_reducer_d32k256_v1:ir"}'))
