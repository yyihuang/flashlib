...
flash_kmeans_assign_cleanroom_tcgen05_d192_splitd_v1 = _decode_capture(_json_loads('{"__ir__": "flash_kmeans_assign_cleanroom_tcgen05_d192_splitd_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 198656, "cta_group": 1, "threads": 192}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "flash_kmeans_assign_cleanroom_tcgen05_d192_splitd_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 198656, "cta_group": 1, "threads": 192}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> Any:
    ...
    if dim != FEAT_D:
        raise ValueError(f'flash_kmeans_assign_cleanroom_tcgen05_d192_splitd_v1 requires D={FEAT_D}, got {dim}')
