...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    trace.update({'selected_route': ROUTE_ID, 'selected_entrypoint': f'{__name__}:launch_for_eval', 'selected_seed': SEED_ID, 'guard_id': 'guard_d352_exactd_splitk_c95c_v2', 'guard_condition': 'D == 352 and N/64 <= 32 and K/256 >= 4', 'reason': 'exact D352 D32-chunk producer removes D384 packing'})
