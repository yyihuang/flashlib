...
flash_kmeans_assign_d288_splitk_cta_0438_v1_partial = _ir_proxy('loom.examples.weave.flash_kmeans_assign_d288_splitk_cta_0438_v1:flash_kmeans_assign_d288_splitk_cta_0438_v1_partial', 256)
flash_kmeans_assign_d288_splitk_cta_0438_v1_reduce = _ir_proxy('loom.examples.weave.flash_kmeans_assign_d288_splitk_cta_0438_v1:flash_kmeans_assign_d288_splitk_cta_0438_v1_reduce', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_d288_splitk_cta_0438_v1:partial_ir"}'))
reduce_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_d288_splitk_cta_0438_v1:reduce_ir"}'))

def _verify_export_ir() -> Any:
    if os.environ.get('LOOM_FLASH_KMEANS_D288_SPLITK_CTA_0438_V1_VERIFY_KERNEL') == 'reduce':
        return reduce_ir
    return partial_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_d288_splitk_cta_0438_v1:ir"}'))
