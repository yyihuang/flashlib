...
def _compiled_pack_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0000"}, "kernel_flash_kmeans_assign_lowdim_pack_e50c_v1", 0, 256]}'))
...
def _compiled_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0001"}, "kernel_flash_kmeans_assign_lowdim_e50c_v1", 100352, 192]}'))
