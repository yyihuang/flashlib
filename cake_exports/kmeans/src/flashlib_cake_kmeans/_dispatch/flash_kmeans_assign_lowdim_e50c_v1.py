...
def _compiled_pack_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0341"}, "kernel_flash_kmeans_assign_lowdim_pack_e50c_v1", 0, 256]}'))

def _compiled_d64_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0342"}, "kernel_flash_kmeans_assign_microdim_6cd2_v1", 51200, 192]}'))
...
def _compiled_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0343"}, "kernel_flash_kmeans_assign_lowdim_e50c_v1", 100352, 192]}'))
