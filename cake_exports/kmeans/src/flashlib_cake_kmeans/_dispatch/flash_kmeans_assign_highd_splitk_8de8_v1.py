...
def _compiled_partial_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0330"}, "kernel_flash_kmeans_assign_highd_splitk_partial_8de8_v1", 51200, 192]}'))

def _compiled_reduce_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0331"}, "kernel_flash_kmeans_assign_highd_splitk_reduce_8de8_v1", 0, 128]}'))
...
def _compile_ir(ir_obj: Any) -> tuple[bytes, str, int, int]:
    ...
    return (cubin, f'kernel_{ir_obj.symbol}', int(smem_bytes), int(ir_obj.threads))
