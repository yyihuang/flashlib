...
flash_kmeans_assign_highd_splitk_partial_blockn64_g2r4_b5a6_v1 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_highd_splitk_blockn64_g2r4_b5a6_v1:flash_kmeans_assign_highd_splitk_partial_blockn64_g2r4_b5a6_v1', 256)
flash_kmeans_assign_highd_splitk_reduce_blockn64_g2r4_b5a6_v1 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_highd_splitk_blockn64_g2r4_b5a6_v1:flash_kmeans_assign_highd_splitk_reduce_blockn64_g2r4_b5a6_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_highd_splitk_blockn64_g2r4_b5a6_v1:partial_ir"}'))
reduce_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_highd_splitk_blockn64_g2r4_b5a6_v1:reduce_ir"}'))

def _verify_export_ir() -> Any:
    if os.environ.get('LOOM_FLASH_KMEANS_HIGHD_SPLITK_BLOCKN64_G2R4_B5A6_VERIFY_KERNEL') == 'reduce':
        return reduce_ir
    return partial_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_highd_splitk_blockn64_g2r4_b5a6_v1:ir"}'))
