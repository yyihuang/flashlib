...
def _compiled_partial_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0007"}, "kernel_flash_kmeans_assign_highd_splitk_partial_blockn64_g2r4_b5a6_v1", 43008, 192]}'))

def _compiled_reduce_kernel() -> tuple[bytes, str, int, int]:
    return _decode_capture(_json_loads('{"__tuple__": [{"__kernel_source__": "dispatch_kernel_0008"}, "kernel_flash_kmeans_assign_highd_splitk_reduce_blockn64_g2r4_b5a6_v1", 0, 256]}'))
...
def _partial_buffers(inputs: dict[str, Any], total_work: int) -> tuple[Any, Any]:
    ...
    cache = inputs.setdefault('_flash_kmeans_assign_highd_splitk_blockn64_g2r4_b5a6_v1_partials', {})
