...
flash_kmeans_assign_microdim_pack_6cd2_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:flash_kmeans_assign_microdim_pack_6cd2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
flash_kmeans_assign_microdim_6cd2_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:flash_kmeans_assign_microdim_6cd2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 51200, "cta_group": 1, "threads": 192}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 51200, "cta_group": 1, "threads": 192}'))
pack_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:pack_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> Any:
    ...
    block = (threads, 1, 1)
    args = [inputs['x_sq'], inputs['c_sq'], inputs['out'], tmap_x, tmap_c, bsz, n_points, dim, n_clusters, num_n_tiles, k_tiles]
    with CUDAKernel(cubin, kernel_name) as kernel:
