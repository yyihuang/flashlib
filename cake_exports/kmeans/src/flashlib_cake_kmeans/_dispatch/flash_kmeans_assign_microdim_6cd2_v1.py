...
flash_kmeans_assign_microdim_pack_6cd2_v1 = _decode_capture(_json_loads('{"__ir__": "flash_kmeans_assign_microdim_pack_6cd2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
flash_kmeans_assign_microdim_6cd2_v1 = _decode_capture(_json_loads('{"__ir__": "flash_kmeans_assign_microdim_6cd2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 51200, "cta_group": 1, "threads": 192}'))
ir = _decode_capture(_json_loads('{"__ir__": "flash_kmeans_assign_microdim_6cd2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 51200, "cta_group": 1, "threads": 192}'))
pack_ir = _decode_capture(_json_loads('{"__ir__": "flash_kmeans_assign_microdim_pack_6cd2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
