...
flash_kmeans_assign_microdim_pack_6cd2_v1 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:flash_kmeans_assign_microdim_pack_6cd2_v1', 256)
flash_kmeans_assign_microdim_6cd2_v1 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:flash_kmeans_assign_microdim_6cd2_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:ir"}'))
pack_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_microdim_6cd2_v1:pack_ir"}'))
