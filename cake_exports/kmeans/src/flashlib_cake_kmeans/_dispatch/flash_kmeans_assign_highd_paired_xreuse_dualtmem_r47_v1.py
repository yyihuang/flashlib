...
flash_kmeans_assign_highd_paired_xreuse_dualtmem_producer_r47_v1 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_highd_paired_xreuse_dualtmem_r47_v1:flash_kmeans_assign_highd_paired_xreuse_dualtmem_producer_r47_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_highd_paired_xreuse_dualtmem_r47_v1:partial_ir"}'))
reduce_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_highd_paired_xreuse_dualtmem_r47_v1:reduce_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return partial_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_highd_paired_xreuse_dualtmem_r47_v1:ir"}'))
