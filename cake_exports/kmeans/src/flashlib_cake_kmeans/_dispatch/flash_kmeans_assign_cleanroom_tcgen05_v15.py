...
flash_kmeans_assign_cleanroom_tcgen05_v15 = _ir_proxy('loom.examples.weave.flash_kmeans_assign_cleanroom_tcgen05_v15:flash_kmeans_assign_cleanroom_tcgen05_v15', 256)
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.flash_kmeans_assign_cleanroom_tcgen05_v15:ir"}'))
