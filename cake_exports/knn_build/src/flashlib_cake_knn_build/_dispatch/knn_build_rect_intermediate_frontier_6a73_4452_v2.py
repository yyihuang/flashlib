...
merge_k10_s8_cache_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache_rect4452_s8", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 8]], "cta_group": 1, "threads": 32}'))
merge_k10_s12_cache_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache_rect4452_s12", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 12]], "cta_group": 1, "threads": 32}'))
merge_k10_s16_cache_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache_rect4452_s16", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 16]], "cta_group": 1, "threads": 32}'))
merge_k10_s24_cache_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache_rect4452_s24", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 24]], "cta_group": 1, "threads": 32}'))
merge_k10_s32_cache_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache_rect4452_s32", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 32]], "cta_group": 1, "threads": 32}'))
...
def _rect_split_count() -> int:
    ...
    if split_count not in SUPPORTED_SPLITS:
        raise ValueError(f'LOOM_KNN_RECT_INTERMEDIATE_4452_SPLIT_COUNT must be one of {SUPPORTED_SPLITS}')
    return split_count
