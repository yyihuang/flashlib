...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_784a_cf51_q1_q16_q4096_seed_portfolio_full90_v1:ir"}'))
...
BASE_D5F8_ROUTE_ENTRYPOINT = f'{base_d5f8.MODULE}:launch_from_contract_inputs'
ROUTE_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
CANDIDATE_CF51_ONLY_ENTRYPOINT = f'{MODULE}:benchmark_candidate_cf51_only_full90_v1'
CANDIDATE_CF51_Q1_Q16_ENTRYPOINT = f'{MODULE}:benchmark_candidate_cf51_q1_q16_full90_v1'
CANDIDATE_CF51_Q1_Q16_Q4096_S4_ENTRYPOINT = f'{MODULE}:benchmark_candidate_cf51_q1_q16_q4096_s4_full90_v1'
...
PRODUCTION_ROUTE_MODULES = {**base_d5f8.PRODUCTION_ROUTE_MODULES, SEED_Q1024_CF51_ID: f'{q1024_cf51.MODULE}:launch_from_contract_inputs', SEED_Q1_5706_ID: f'{q1_5706.MODULE}:launch_from_contract_inputs', SEED_Q16_BDD2_ID: q16_bdd2.ROUTE_Q16_DUAL_2WARP_LARGEM_ENTRYPOINT, SEED_Q4096_S4_ID: q4096_s4.ROUTE_Q4096_K8_S4, BASE_D5F8_ID: BASE_D5F8_ROUTE_ENTRYPOINT}
...
def _candidate_config(candidate_key: str) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f'unknown full90 seed-portfolio candidate {candidate_key!r}') from exc
...
def _q1024_cf51_trace_record(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    return _seed_route_row(inputs, selected_seed=SEED_Q1024_CF51_ID, selected_route=q1024_cf51.route_for_contract_inputs(inputs), selected_entrypoint=f'{q1024_cf51.MODULE}:launch_from_contract_inputs', guard_id='cf51_q1024_k8_split16_guard', guard_condition='exact BF16 build B=1 Q=M=1024 D=128 K=8 split16', force_fallback=force_fallback)
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, time_flashlib: bool=True, include_q4096_s4_candidate: bool=True, candidate_keys: tuple[str, ...] | None=None) -> dict[str, str]:
    ...
    summary_path = out_dir / f'{denom_label}_dispatcher_synthesis_c3bf_cf51_bca0_5018_485e_v1.json'
