...
knn_build_rag_frontier_4b5c_k32_group_merge = _ir_proxy('loom.examples.weave.knn_build_rag_frontier_4b5c_v3:knn_build_rag_frontier_4b5c_k32_group_merge', 256)
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4b5c_v3:ir"}'))
