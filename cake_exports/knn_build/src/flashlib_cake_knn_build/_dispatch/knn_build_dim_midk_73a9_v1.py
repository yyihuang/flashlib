...
knn_build_dim_midk_73a9_d64_split_stage1 = _ir_proxy('loom.examples.weave.knn_build_dim_midk_73a9_v1:knn_build_dim_midk_73a9_d64_split_stage1', 256)
stage1_d64_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_73a9_v1:stage1_d64_split_ir"}'))
merge_generic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_73a9_v1:merge_generic_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_73a9_v1:ir"}'))
