...
knn_build_large_square_k32_stage1_chunkworst = _decode_capture(_json_loads('{"__ir__": "knn_build_large_square_k32_stage1_chunkworst", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 32]], "cta_group": 1, "threads": 192}'))
knn_build_large_square_k32_s2_warp8_merge = _decode_capture(_json_loads('{"__ir__": "knn_build_large_square_k32_s2_warp8_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 32]], "cta_group": 1, "threads": 256}'))
stage1_k32_prodcache_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_large_square_k32_stage1_chunkworst", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 32]], "cta_group": 1, "threads": 192}'))
merge_k32_s2_warp8_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_large_square_k32_s2_warp8_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 32]], "cta_group": 1, "threads": 256}'))
...
def _verify_export_ir() -> Any:
    ...
    return stage1_k32_prodcache_ir
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_large_square_k32_stage1_chunkworst", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 32]], "cta_group": 1, "threads": 192}'))
