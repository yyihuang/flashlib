...
knn_build_evolve_7bfc_split_stage1 = _ir_proxy('loom.examples.weave.knn_build_evolve_7bfc_split_v1:knn_build_evolve_7bfc_split_stage1', 256)
knn_build_evolve_7bfc_split_merge = _ir_proxy('loom.examples.weave.knn_build_evolve_7bfc_split_v1:knn_build_evolve_7bfc_split_merge', 256)
stage1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_v1:stage1_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_v1:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_v1:ir"}'))
