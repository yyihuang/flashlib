...
stage1_q8_k32_rowld_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_q8rowld_19b3_q8m64probe_v1:stage1_q8_k32_rowld_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_q8rowld_19b3_q8m64probe_v1:ir"}'))
