...
stage1_k64_s8_tailinf_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_k64split8_v1:stage1_k64_s8_tailinf_ir"}'))
merge_k64_s8_warp_select_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_k64split8_v1:merge_k64_s8_warp_select_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return stage1_k64_s8_tailinf_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_k64split8_v1:ir"}'))
