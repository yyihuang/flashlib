...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_b6d4_d15e_fd02_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def _params_for_label(label: str) -> dict[str, Any]:
    ...
    raise ValueError(f'unknown kNN build contract shape label: {label}')
