...
knn_build_rect_d64_cf49_s16_cached_merge = _decode_capture(_json_loads('{"__ir__": "knn_build_rect_d64_cf49_s16_cached_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 16]], "cta_group": 1, "threads": 8}'))
merge_s16_cached_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rect_d64_cf49_s16_cached_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 16]], "cta_group": 1, "threads": 8}'))
