...
ROUTE_RAG_MICROBATCH_S72_G8 = f'loom.examples.weave.knn_build_rag_microbatch_4a72_v1:rag_microbatch_4a72_k10_s{rag_seed.K10_SPLIT_COUNT}_g{rag_seed.K10_GROUP_COUNT}_fusedmerge'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_selected_portfolio_397b_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    candidate_path = out_dir / f'{denom}_dispatch_selected_portfolio_397b_v1.json'
    baseline_path = out_dir / f'{denom}_same_session_baseline_4a72_for_397b_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_selected_portfolio_397b_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_selected_portfolio_397b_v1.json'
