...
knn_build_common_d_5e7f_rag_d64_repair_stage1 = _decode_capture(_json_loads('{"__ir__": "knn_build_common_d_5e7f_rag_d64_repair_stage1", "arg_keys": ["tmap_query", "tmap_database", "query_sq", "database_sq", "partial_dists", "partial_indices", "B", "Q", "M", "K", "num_q_tiles", "db_tiles_per_split", "split_count", "total_work"], "cluster_dims": [1, 1, 1], "computed_smem_bytes": 17664, "constants": [["BLOCK_Q", 64], ["BLOCK_M", 64], ["K_TILE", 64], ["TOP_K_MAX", 10]], "cta_group": 1, "threads": 96}'))
stage1_d64_repair_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_common_d_5e7f_rag_d64_repair_stage1", "arg_keys": ["tmap_query", "tmap_database", "query_sq", "database_sq", "partial_dists", "partial_indices", "B", "Q", "M", "K", "num_q_tiles", "db_tiles_per_split", "split_count", "total_work"], "cluster_dims": [1, 1, 1], "computed_smem_bytes": 17664, "constants": [["BLOCK_Q", 64], ["BLOCK_M", 64], ["K_TILE", 64], ["TOP_K_MAX", 10]], "cta_group": 1, "threads": 96}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_common_d_5e7f_rag_d64_repair_stage1", "arg_keys": ["tmap_query", "tmap_database", "query_sq", "database_sq", "partial_dists", "partial_indices", "B", "Q", "M", "K", "num_q_tiles", "db_tiles_per_split", "split_count", "total_work"], "cluster_dims": [1, 1, 1], "computed_smem_bytes": 17664, "constants": [["BLOCK_Q", 64], ["BLOCK_M", 64], ["K_TILE", 64], ["TOP_K_MAX", 10]], "cta_group": 1, "threads": 96}'))
...
def _launch_d64_rag(inputs: dict[str, Any], label: str) -> None:
    ...
    _compiled_stage1().launch(grid=(stage1_grid, 1, 1), block=(D64_THREADS, 1, 1), args=pack_kernel_args(stage1_d64_repair_ir, tmap_query=tmap_query, tmap_database=tmap_database, query_sq=inputs['query_sq'], database_sq=inputs['database_sq'], partial_dists=partial_dists, partial_indices=partial_indices, B=bsz, Q=n_query, M=n_database, K=top_k, num_q_tiles=num_q_tiles, db_tiles_per_split=db_tiles_per_split, split_count=split_count, total_work=total_work), shared_mem=stage1_d64_repair_ir.computed_smem_bytes)
