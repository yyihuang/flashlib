...
knn_build_q4096_k8_fd9b_stage1_unordered_exact_prefill = _ir_proxy('loom.examples.weave.knn_build_q4096_k8_lowfloor_fd9b_v3:knn_build_q4096_k8_fd9b_stage1_unordered_exact_prefill', 256)
knn_build_q4096_k8_fd9b_merge_s4_unordered_warp_select = _ir_proxy('loom.examples.weave.knn_build_q4096_k8_lowfloor_fd9b_v3:knn_build_q4096_k8_fd9b_merge_s4_unordered_warp_select', 256)
stage1_k8_unordered_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_q4096_k8_lowfloor_fd9b_v3:stage1_k8_unordered_ir"}'))
stage1_k8_exact_prefill_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_q4096_k8_lowfloor_fd9b_v3:stage1_k8_exact_prefill_ir"}'))
merge_k8_warp_select_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_q4096_k8_lowfloor_fd9b_v3:merge_k8_warp_select_ir"}'))
