...
ROUTE_TAIL_K20_S4 = f'{MODULE}:q3072_k20_v20_s4'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_build_lowfloor_residual_b3ec_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 91392, "cta_group": 1, "threads": 512}'))
...
def route_trace_for_contract_shapes(shape_labels=TARGET_SHAPES, *, force_fallback: bool=False) -> list[dict[str, Any]]:
    ...
    for label in tuple(shape_labels):
        ...
        rows.append(baseline_1877._normalize_route_row({'shape_key': label, 'selected_route': route, 'selected_entrypoint': route, 'selected_seed': selected_seed, 'expected_seed': selected_seed, 'route_kind': 'specialized', 'route_source': 'shape-specific-seed', 'guard_id': f'b3ec_build_lowfloor_{selected_seed}', 'guard_condition': guard_conditions[selected_seed], 'matched_label': matched_label, 'baseline_1877_route': baseline_route, 'classification': 'seed-consumed'}))
    return rows
