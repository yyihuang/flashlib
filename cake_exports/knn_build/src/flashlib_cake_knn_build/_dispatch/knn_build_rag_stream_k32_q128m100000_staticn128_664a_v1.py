...
TOP_K_MAX = S128_K
knn_build_rag_stream_k32_q128m100000_staticn128_664a_stage1 = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_stream_k32_q128m100000_staticn128_664a_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 181504, "cta_group": 1, "threads": 256}'))
stage1_staticn128_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_stream_k32_q128m100000_staticn128_664a_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 181504, "cta_group": 1, "threads": 256}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_stream_k32_q128m100000_staticn128_664a_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 181504, "cta_group": 1, "threads": 256}'))
