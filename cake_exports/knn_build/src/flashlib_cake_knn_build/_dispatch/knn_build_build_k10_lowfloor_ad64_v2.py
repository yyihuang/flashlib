...
def _verify_export_ir() -> Any:
    ...
    return parent.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_build_k10_lowfloor_ad64_v2:ir"}'))
