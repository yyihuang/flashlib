...
knn_build_d64_q4096_c271_stage1_syncdrop = _ir_proxy('loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:knn_build_d64_q4096_c271_stage1_syncdrop', 256)
stage1_d64_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:stage1_d64_split_ir"}'))
merge_generic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_generic_ir"}'))

def _ir_with_constants(ir_obj: Any, *, suffix: str, **updates: int) -> Any:
    constants = tuple(((name, updates.get(name, value)) for name, value in ir_obj.constants))
    return replace(ir_obj, name=f'{ir_obj.name}_{suffix}', constants=constants)
merge_k10_s4_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s4_ir"}'))
merge_k10_s5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s5_ir"}'))
merge_k10_s6_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s6_ir"}'))
merge_k10_s8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s8_ir"}'))
