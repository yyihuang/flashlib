...
knn_build_d64_q4096_c271_stage1_syncdrop = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:knn_build_d64_q4096_c271_stage1_syncdrop", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 25856, "cta_group": 1, "threads": 192}'))
stage1_d64_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:stage1_d64_split_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 25856, "cta_group": 1, "threads": 192}'))
merge_generic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_generic_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))

def _ir_with_constants(ir_obj: Any, *, suffix: str, **updates: int) -> Any:
    constants = tuple(((name, updates.get(name, value)) for name, value in ir_obj.constants))
    return replace(ir_obj, name=f'{ir_obj.name}_{suffix}', constants=constants)
merge_k10_s4_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s4_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
merge_k10_s5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s5_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
merge_k10_s6_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s6_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
merge_k10_s8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:merge_k10_s8_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_q4096_c271_prodaxis_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 25856, "cta_group": 1, "threads": 192}'))
...
def route_name_for_inputs(inputs: dict[str, Any]) -> str:
    if _eligible_exact_q4096_d64(inputs):
        ...
        return ROUTE_D64_Q4096_SPLIT4_SYNCDROP.replace('split4_syncdrop', f'split{split_count}')
