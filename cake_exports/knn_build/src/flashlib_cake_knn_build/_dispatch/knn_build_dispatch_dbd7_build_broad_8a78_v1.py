...
def _verify_export_ir() -> Any:
    ...
    return base17b8.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_dbd7_build_broad_8a78_v1:ir"}'))
...
def _route_trace_record(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if expected_seed is None or force_fallback:
        ...
        if force_fallback and expected_seed is not None:
            ...
            row['guard_condition'] = f'forced fallback to 17b8; {expected_seed} disabled'
