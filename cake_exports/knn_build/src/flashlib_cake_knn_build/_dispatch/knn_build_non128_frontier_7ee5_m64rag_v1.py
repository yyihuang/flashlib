...
knn_build_non128_frontier_7ee5_m64rag_stage1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_7ee5_m64rag_v1:knn_build_non128_frontier_7ee5_m64rag_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 34048, "cta_group": 1, "threads": 96}'))
stage1_m64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_7ee5_m64rag_v1:stage1_m64_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 34048, "cta_group": 1, "threads": 96}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_7ee5_m64rag_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 34048, "cta_group": 1, "threads": 96}'))
