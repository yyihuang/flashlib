...
ROUTE_K1_ENTRYPOINT = f'{lowk_seed.ROUTE_PREFIX}:q512_lowk_s{lowk_seed.DEFAULT_Q512_SPLITS}'
ROUTE_K24_ENTRYPOINT = f'{MODULE}:k24_q4096_warpselect'
...
stage1_k24_unordered_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_split_cg2_u2_stage1_k32_unordered_k30unordered_1074k24unordered", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 24]], "cta_group": 1, "threads": 192}'))
knn_build_1074_k24_q4096_merge_s4_unordered_warp_select = _decode_capture(_json_loads('{"__ir__": "knn_build_1074_k24_q4096_merge_s4_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 24], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 128}'))
merge_k24_q4096_warp_select_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_1074_k24_q4096_merge_s4_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 24], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 128}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_split_cg2_u2_stage1_k32_unordered_k30unordered_1074k24unordered", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 24]], "cta_group": 1, "threads": 192}'))
