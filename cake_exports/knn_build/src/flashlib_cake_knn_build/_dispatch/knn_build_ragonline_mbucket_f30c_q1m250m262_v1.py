...
SPLIT_BY_M = _decode_capture(_json_loads('{"100000": 128, "131071": 128, "250000": 128, "262143": 128}'))
...
def _verify_export_ir() -> Any:
    ...
    return parent.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_ragonline_mbucket_f30c_q1m250m262_v1:ir"}'))
...
def route_for_contract_inputs(inputs: dict[str, Any], *, force_fallback: bool=False) -> str:
    if not force_fallback and _eligible_q1_large_halfrow(inputs):
        split_count, group_count = _halfrow_topology_for_inputs(inputs)
        return f'rag_online_mbucket_f30c_q1_halfrow_m{int(inputs['M'])}_s{split_count}_g{group_count}'
