...
BENCHMARK_ENTRYPOINT = ''.join([format(MODULE, ''), ':benchmark_knn_build_common_d_5e7f_rag_highd_v1'])
...
def _stage1_ir(feature_chunks: int) -> Any:
    return _ir_with_constants(m64_parent.stage1_m64_ir, suffix=''.join(['d', format(int(feature_chunks) * K_TILE, ''), '_5e7f_highd_v1']), FEATURE_CHUNKS=int(feature_chunks))
