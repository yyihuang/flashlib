...
ROUTE_Q4096_K8_S8 = f'{MODULE}:q4096_k8_v20_s8'
ROUTE_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
PARENT_DIRECT_ENTRYPOINT = parent_direct.ROUTE_ENTRYPOINT
CANDIDATE_ENTRYPOINT = f'{MODULE}:benchmark_candidate_784a_direct_q512_k456_q4096_k8_plus_6bc3_k8_v1'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_784a_6bc3_k8_q512k456_q4096k8_direct_fcf2_v1:ir"}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, time_flashlib: bool=True) -> dict[str, str]:
    ...
    payload_path = out_dir / f'{denom_label}_dispatch_784a_direct_q512k456_q4096k8_plus_6bc3_k8_v1.json'
    trace_path = out_dir / f'{denom_label}_route_trace_784a_direct_q512k456_q4096k8_plus_6bc3_k8_v1.json'
    forced_trace_path = out_dir / f'{denom_label}_forced_fallback_trace_784a_direct_q512k456_q4096k8_plus_6bc3_k8_v1.json'
    seed_matrix_path = out_dir / f'{denom_label}_seed_delta_matrix_784a_direct_q512k456_q4096k8_plus_6bc3_k8_v1.json'
