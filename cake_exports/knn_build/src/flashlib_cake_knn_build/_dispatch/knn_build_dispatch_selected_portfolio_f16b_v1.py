...
def _verify_export_ir() -> Any:
    ...
    if verify_kernel == 'q8192_k32_merge':
        ...
        return q8192_k32_seed._verify_export_ir()
    return base_f853.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_selected_portfolio_f16b_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
