...
BASELINE_ENTRYPOINT = f'{base17b8.MODULE}:benchmark_candidate_066c_69d6_plus_b8c7_full82_v1'
ROUTE_Q4_S144 = 'rag_microbatch_q4_k10_s144_g12_17b8_v1'
ROUTE_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
ROUTE_BASE_17B8_ENTRYPOINT = f'{base17b8.MODULE}:launch_from_contract_inputs(q4q64_mode=69d6)'
S144_SPLIT_COUNT = rag_faeb.S144_SPLIT_COUNT
S144_GROUP_COUNT = rag_faeb.S144_GROUP_COUNT_Q4
eval_mod = base17b8.eval_mod
SOURCE_TASKS = _decode_capture(_json_loads('{"candidate_066c_69d6_plus_b8c7_full82_v1": "loom.examples.weave.knn_build_dispatch_066c_b8c7_69d6_full82_v1:69d6_b8c7", "rag_microbatch_q4_k10_s144_17b8_v1": "weave-evolve-knn-build-17b8 / design_doc/active/generalize_auto_tuning_knn_build_round_116_17b8.md", "s144_parent_seed": "loom.examples.weave.knn_build_rag_microbucket_faeb_v1:candidate_q4_s144"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_q4_s144_17b8_v1:ir"}'))
