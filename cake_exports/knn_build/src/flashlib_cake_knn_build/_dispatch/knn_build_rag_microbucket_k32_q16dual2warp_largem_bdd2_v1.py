...
ROUTE_PARENT_56ED = f'{seed.MODULE}:launch_from_contract_inputs'
ROUTE_Q16_DUAL_2WARP_LARGEM_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_k32_q16dual2warp_largem_bdd2_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
...
def _dual2warp_largem_route_name(inputs: dict[str, Any], *, split_count: int) -> str:
    n_database = int(inputs.get('M', -1))
    return f'rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_q16_m{n_database}_k32_row16x256b_2cw_s{split_count}_r{seed.K32_ROWS4_ROWS_PER_CTA}_warpmerge'
