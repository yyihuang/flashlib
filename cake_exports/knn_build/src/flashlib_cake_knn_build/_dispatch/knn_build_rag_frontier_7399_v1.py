...
knn_build_rag_frontier_7399_k32_fused_group_final_merge = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_frontier_7399_k32_fused_group_final_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 2048, "cta_group": 1, "threads": 32}'))
fused_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_frontier_7399_k32_fused_group_final_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 2048, "cta_group": 1, "threads": 32}'))
...
def _verify_export_ir() -> Any:
    ...
    return fused_merge_ir
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_frontier_7399_k32_fused_group_final_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 2048, "cta_group": 1, "threads": 32}'))
