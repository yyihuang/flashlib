...
knn_build_rag_frontier_7399_k32_fused_group_final_merge = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_frontier_7399_k32_fused_group_final_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 2048, "constants": [["TOP_K_MAX", 32], ["GROUP_COUNT", 8], ["GROUP_SPLITS", 9]], "cta_group": 1, "threads": 32}'))
fused_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_frontier_7399_k32_fused_group_final_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 2048, "constants": [["TOP_K_MAX", 32], ["GROUP_COUNT", 8], ["GROUP_SPLITS", 9]], "cta_group": 1, "threads": 32}'))
...
def _verify_export_ir() -> Any:
    ...
    return fused_merge_ir
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_frontier_7399_k32_fused_group_final_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 2048, "constants": [["TOP_K_MAX", 32], ["GROUP_COUNT", 8], ["GROUP_SPLITS", 9]], "cta_group": 1, "threads": 32}'))
...
def route_for_contract_inputs(inputs: dict[str, Any]) -> str:
    ...
    if _eligible_k32_rag_frontier(inputs):
        return f'rag_frontier_k32_s{K32_SPLIT_COUNT}_g{K32_GROUP_COUNT}_fusedmerge7399'
