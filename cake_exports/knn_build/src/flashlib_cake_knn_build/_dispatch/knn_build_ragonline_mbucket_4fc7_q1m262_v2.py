...
def _launch_q1_m262_halfrow(inputs: dict[str, Any], *, split_count: int=SPLIT_COUNT_M262_HALF, group_count: int=GROUP_COUNT_M262_HALF) -> None:
    ...
    _compiled_stage1_q1_k10_m64_halfrow().launch(grid=(stage1_grid, 1, 1), block=(Q1_HALF_STAGE1_THREADS, 1, 1), args=[inputs['query_sq'], inputs['database_sq'], partial_dists, partial_indices, tmap_query, tmap_database, bsz, n_query, n_database, top_k, num_q_tiles, db_tiles_per_split, split_count, total_work], shared_mem=stage1_q1_k10_m64_halfrow_ir.computed_smem_bytes)
...
def route_for_contract_inputs(inputs: dict[str, Any], *, force_fallback: bool=False) -> str:
    if not force_fallback and _eligible_q1_m262_halfrow(inputs):
        return f'rag_online_mbucket_4fc7_q1m262_v2_halfrow_s{SPLIT_COUNT_M262_HALF}_g{GROUP_COUNT_M262_HALF}'
