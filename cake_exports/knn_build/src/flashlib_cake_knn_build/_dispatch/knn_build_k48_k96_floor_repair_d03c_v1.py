...
PRODUCTION_ROUTE_MODULES = _decode_capture(_json_loads('{"c13e_k96_q1024_229a_s2_exactprefill": "loom.examples.weave.knn_build_over64_k96_exactall_229a_v1:launch_from_contract_inputs", "candidate_fd9b_plus_01bb_2425_1b34_k5_bd76_k20_9334_k32_full90_v1": "loom.examples.weave.knn_build_dispatch_fd9b_floor_seed_portfolio_5720_full90_synthesis_v1:launch_from_contract_inputs", "d03c_k48_s4_warpselect_merge": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:launch_from_contract_inputs"}'))
stage1_k48_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:stage1_k48_ir"}'))
knn_build_k48_merge_s4_unordered_warp_select = _ir_proxy('loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:knn_build_k48_merge_s4_unordered_warp_select', 256)
merge_k48_warpselect_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:merge_k48_warpselect_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:ir"}'))
