...
ROUTE_K48_WARPSELECT = f'{MODULE}:k48_s4_warpselect_merge'
ROUTE_K96_Q1024 = k96_c13e.ROUTE_K96_ENTRYPOINT
ROUTE_PARENT_4399 = parent_4399.ROUTE_ENTRYPOINT
BENCHMARK_ENTRYPOINT = f'{MODULE}:benchmark_k48_k96_floor_repair_d03c_v1'
...
stage1_k48_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:stage1_k48_ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
knn_build_k48_merge_s4_unordered_warp_select = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:knn_build_k48_merge_s4_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
merge_k48_warpselect_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:merge_k48_warpselect_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, speedup_floor: float=1.2) -> dict[str, str]:
    ...
    labels = _shape_labels(shape_labels)
    denom_label = 'd03c_k48_k96_exact3' if labels == TARGET_SHAPES else f'custom_{len(labels)}'
    baseline_report = benchmark_baseline_4399(use_cupti=use_cupti, shape_labels=labels, benchmark_correctness=benchmark_correctness)
    ...
    payload_path = out_dir / f'{denom_label}_dispatch_d03c_k48_k96_v1.json'
    trace_path = out_dir / f'{denom_label}_route_trace_d03c_k48_k96_v1.json'
    forced_trace_path = out_dir / f'{denom_label}_forced_fallback_trace_d03c_k48_k96_v1.json'
    seed_matrix_path = out_dir / f'{denom_label}_seed_delta_matrix_d03c_k48_k96_v1.json'
