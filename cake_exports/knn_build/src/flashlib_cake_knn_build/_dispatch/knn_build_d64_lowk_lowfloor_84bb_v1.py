...
ROUTE_K1_ENTRYPOINT = f'{lowk_seed.ROUTE_PREFIX}:q512_lowk_s{Q512_SPLIT_COUNT}'
...
def _verify_export_ir() -> Any:
    ...
    return lowk_seed.stage1_q512_lowk_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d64_lowk_lowfloor_84bb_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
