...
ROUTE_RAG_Q16_K32_3505_V2 = f'rag_microbucket_3505_v2_q16_k32_tailinf_cta1_s{rag_3505_v2.K32_SPLIT_COUNT}_g{rag_3505_v2.K32_GROUP_COUNT}'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_faeb_cb00_3505v2_8940_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    candidate_path = out_dir / f'{denom}_dispatch_e3de_9138_bcb3_faeb_cb00_3505v2_8940_v1.json'
    baseline_2422_path = out_dir / f'{denom}_same_session_baseline_2422_for_8940_v1.json'
    baseline_6d62_path = out_dir / f'{denom}_same_session_baseline_6d62_for_8940_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_e3de_9138_bcb3_faeb_cb00_3505v2_8940_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_e3de_9138_bcb3_faeb_cb00_3505v2_8940_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_e3de_9138_bcb3_faeb_cb00_3505v2_8940_v1.json'
