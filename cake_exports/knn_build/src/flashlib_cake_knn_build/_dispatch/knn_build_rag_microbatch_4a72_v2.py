...
def _launch_rag_microbatch_fused_merge(inputs: dict[str, Any], *, split_count: int=K10_SPLIT_COUNT, group_count: int=K10_GROUP_COUNT) -> None:
    ...
    merge_launch = merge_kernel.prepare_launch(grid=(merge_grid, 1, 1), block=(K10_FUSED_MERGE_THREADS, 1, 1), args=[partial_dists, partial_indices, inputs['out_dists'], inputs['out_indices'], total_queries], shared_mem=fused_merge_ir.computed_smem_bytes)
