...
CTA_GROUP = 1
knn_build_rag_microbatch_4a72_v2_stage1_k10_cta1_maxtree = _ir_proxy('loom.examples.weave.knn_build_rag_microbatch_4a72_v2:knn_build_rag_microbatch_4a72_v2_stage1_k10_cta1_maxtree', 256)
stage1_cta1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_4a72_v2:stage1_cta1_ir"}'))
knn_build_rag_microbatch_4a72_v2_k10_fused_group_final_merge = _ir_proxy('loom.examples.weave.knn_build_rag_microbatch_4a72_v2:knn_build_rag_microbatch_4a72_v2_k10_fused_group_final_merge', 256)
fused_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_4a72_v2:fused_merge_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_4a72_v2:ir"}'))
