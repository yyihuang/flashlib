"""kNN build/search over-64 K96 coverage seed.
...
It keeps the existing tcgen05/TMA split stage-1 producer and unordered split
merge structure from the validated K32/K64 lineage, raises the static top-k
capacity to 96, and leaves all guard misses on the inherited Weave route.
"""
...
stage1_k96_over64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:stage1_k96_over64_ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
merge_k96_over64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:merge_k96_over64_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_build_k96_merge_s8_unordered_chunkprefill = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:knn_build_k96_merge_s8_unordered_chunkprefill", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
merge_k96_s8_chunkprefill_over64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:merge_k96_s8_chunkprefill_over64_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def benchmark_knn_build_over64_k96_a989_v1(*, use_cupti: bool | None=None) -> dict[str, Any]:
