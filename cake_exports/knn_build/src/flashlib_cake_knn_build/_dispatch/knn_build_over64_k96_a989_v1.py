...
stage1_k96_over64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:stage1_k96_over64_ir"}'))
merge_k96_over64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:merge_k96_over64_ir"}'))
knn_build_k96_merge_s8_unordered_chunkprefill = _ir_proxy('loom.examples.weave.knn_build_over64_k96_a989_v1:knn_build_k96_merge_s8_unordered_chunkprefill', 256)
merge_k96_s8_chunkprefill_over64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:merge_k96_s8_chunkprefill_over64_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_over64_k96_a989_v1:ir"}'))
