...
BENCHMARK_ENTRYPOINT = f'{MODULE}:benchmark_candidate_build_k96_d64_c13e_v1'
...
def route_trace_for_contract_shapes(shape_labels=TARGET_SHAPES, *, force_fallback: bool=False) -> list[dict[str, Any]]:
    ...
    for label in tuple(shape_labels):
        ...
        rows.append(selected_parent._normalize_route_row({'shape_key': label, 'selected_route': route, 'selected_entrypoint': selected_entrypoints[selected_seed], 'selected_seed': selected_seed, 'expected_seed': selected_seed, 'route_kind': 'specialized', 'route_source': 'shape-specific-seed', 'guard_id': f'c13e_k96_d64_buildfix_{selected_seed}', 'guard_condition': guard_conditions[selected_seed], 'matched_label': matched_label, 'parent_selected_route': parent_route, 'baseline_dispatcher_route': parent_row.get('selected_route'), 'classification': 'seed-consumed'}))
    return rows
