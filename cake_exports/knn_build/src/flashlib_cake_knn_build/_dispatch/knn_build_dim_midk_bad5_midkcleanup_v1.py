...
stage1_k24_s8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_midkcleanup_v1:stage1_k24_s8_ir"}'))
stage1_k28_s8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_midkcleanup_v1:stage1_k28_s8_ir"}'))
merge_k24_s8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_midkcleanup_v1:merge_k24_s8_ir"}'))
merge_k28_s8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_midkcleanup_v1:merge_k28_s8_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return stage1_k28_s8_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_midkcleanup_v1:ir"}'))
