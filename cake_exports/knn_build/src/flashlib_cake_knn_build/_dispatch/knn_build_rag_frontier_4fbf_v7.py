...
knn_build_rag_frontier_4fbf_v7_stage1_k32_sort4earlystop_tailinf = _ir_proxy('loom.examples.weave.knn_build_rag_frontier_4fbf_v7:knn_build_rag_frontier_4fbf_v7_stage1_k32_sort4earlystop_tailinf', 256)
stage1_k32_tailinf_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4fbf_v7:stage1_k32_tailinf_ir"}'))
knn_build_rag_frontier_4fbf_v7_k32_fused_group_final_merge = _ir_proxy('loom.examples.weave.knn_build_rag_frontier_4fbf_v7:knn_build_rag_frontier_4fbf_v7_k32_fused_group_final_merge', 256)
fused_merge_generalized_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4fbf_v7:fused_merge_generalized_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4fbf_v7:ir"}'))
