...
knn_build_ragonline_mbucket_ea43_q1m524_n128_stage1 = _decode_capture(_json_loads('{"__ir__": "knn_build_ragonline_mbucket_ea43_q1m524_n128_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 52992, "constants": [["BLOCK_Q", 64], ["BLOCK_M", 128], ["FEAT_D", 128], ["TOP_K_MAX", 10], ["ROWS_COVERED", 1]], "cta_group": 1, "threads": 96}'))
stage1_q1_k10_m64n128_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_ragonline_mbucket_ea43_q1m524_n128_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 52992, "constants": [["BLOCK_Q", 64], ["BLOCK_M", 128], ["FEAT_D", 128], ["TOP_K_MAX", 10], ["ROWS_COVERED", 1]], "cta_group": 1, "threads": 96}'))
...
def _launch_q1_m524_n128(inputs: dict[str, Any], *, split_count: int=Q1_N128_SPLIT, group_count: int=Q1_N128_GROUPS) -> None:
    ...
    _compiled_stage1_q1_k10_m64n128().launch(grid=(stage1_grid, 1, 1), block=(Q1_N128_STAGE1_THREADS, 1, 1), args=[inputs['query_sq'], inputs['database_sq'], partial_dists, partial_indices, tmap_query, tmap_database, bsz, n_query, n_database, top_k, num_q_tiles, db_tiles_per_split, split_count, total_work], shared_mem=stage1_q1_k10_m64n128_ir.computed_smem_bytes)
...
def route_for_contract_inputs(inputs: dict[str, Any], *, force_fallback: bool=False) -> str:
    if not force_fallback and _eligible_q1_m524_n128(inputs):
        return f'rag_online_mbucket_ea43_q1m524_n128_s{Q1_N128_SPLIT}_g{Q1_N128_GROUPS}'
...
def write_benchmark_artifacts(artifact_dir: str | os.PathLike[str], *, use_cupti: bool=True) -> dict[str, Any]:
    ...
    for name, payload in payloads.items():
        path = out_dir / f'ea43_q1m524_n128_{name}_1row_{suffix}.json'
    ...
    summary_path = out_dir / f'ea43_q1m524_n128_summary_1row_{suffix}.json'
