...
BASELINE_ENTRYPOINT = f'{base_d555.MODULE}:benchmark_candidate_d555_direct_residual_seeds'
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=TARGET_SHAPES, benchmark_correctness: bool=True, time_flashlib: bool=True) -> dict[str, str]:
    ...
    baseline_path = out_dir / f'{denom}_same_session_baseline_d555_for_faeb_q4q64_69d6_v1.json'
    candidate_path = out_dir / f'{denom}_dispatch_d555_faeb_q4q64_69d6_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_d555_faeb_q4q64_69d6_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_d555_faeb_q4q64_69d6_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_d555_faeb_q4q64_69d6_v1.json'
    baseline_path.write_text(json.dumps({'candidate_id': BASELINE_ID, 'measured_entrypoint': f'{MODULE}:benchmark_baseline_d555', 'measured_shape_labels': payload['measured_shape_labels'], 'timing_backend': payload['timing_backend'], 'denominator': denominator, 'benchmark_correctness_checked': payload['benchmark_correctness_checked'], 'benchmark_time_flashlib': payload['benchmark_time_flashlib'], 'tflops': payload['baseline_tflops'], 'all_correct': payload['baseline_all_correct'], 'performance_comparable': payload['baseline_performance_comparable'], 'contract_summary': payload['baseline_contract_summary'], 'contract_performance': payload['baseline_contract_performance'], 'route_trace': base_d555.route_trace_for_contract_shapes(shape_labels), 'route_trace_included': True, 'rank_objective': {'metric': 'tflops', 'direction': 'maximize', 'value': payload['baseline_tflops'], 'denominator': denominator}, 'report': payload['baseline_report']}, indent=2, sort_keys=True) + '\n')
