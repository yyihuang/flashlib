...
knn_build_k20_large_lowfanout_s2_warp_select = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_large_lowfanout_s2_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20]], "cta_group": 1, "threads": 128}'))
merge_k20_s2_warp_select_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_large_lowfanout_s2_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20]], "cta_group": 1, "threads": 128}'))
...
def _forced_split_count() -> int | None:
    ...
    if split_count not in (2, 4, 8):
        raise ValueError(f'unsupported K20 low-fanout split count: {split_count}')
    return split_count
