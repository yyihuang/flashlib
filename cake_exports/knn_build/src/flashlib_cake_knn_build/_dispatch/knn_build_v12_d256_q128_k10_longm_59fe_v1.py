...
def _stage1_ir() -> Any:
    ...
    return dc.replace(q128_parent.stage1_m64_ir, symbol=f'{q128_parent.stage1_m64_ir.symbol}_d256_q128_k10_59fe_v1', constants=constants)
