...
knn_build_rag_microbucket_k32_q16irreg2warp_a444_v2_stage1_q16_rowld1_2warp = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_microbucket_k32_q16irreg2warp_a444_v2_stage1_q16_rowld1_2warp", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 52480, "cta_group": 1, "threads": 128}'))
stage1_q16_rowld1_2warp_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_microbucket_k32_q16irreg2warp_a444_v2_stage1_q16_rowld1_2warp", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 52480, "cta_group": 1, "threads": 128}'))
...
def _warp_merge_ir(split_count: int) -> Any:
    ...
    return _ir_with_constants(base.k32_warp_row_merge_ir, suffix=f'k32s{split_count}r{K32_ROWS4_ROWS_PER_CTA}_a444_v2', TOP_K_MAX=K32_TOP_K_MAX, SPLIT_COUNT=split_count, SPLITS_PER_LANE=base._splits_per_lane(split_count), ROWS_PER_CTA=K32_ROWS4_ROWS_PER_CTA)
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_rag_microbucket_k32warpmerge_0077_v1_warp_row_merge_k32s148r4_a444_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
...
def _irreg2warp_route_name(inputs: dict[str, Any], *, split_count: int) -> str:
    ...
    return f'rag_microbucket_k32_q16irreg2warp_a444_v2_q16_m{n_database}_k32_row16x256b_2cw_s{split_count}_r{K32_ROWS4_ROWS_PER_CTA}_warpmerge'
...
def _launch_rowld1_2warp_rows4_merge(inputs: dict[str, Any], *, split_count: int) -> None:
    ...
    if top_k != K32_TOP_K_MAX:
        raise ValueError(f'k32 q16 irreg2warp only supports K={K32_TOP_K_MAX}, got K={top_k}')
    ...
    _compiled_stage1_q16_rowld1_2warp().launch(grid=(stage1_grid, 1, 1), block=(Q16_2WARP_STAGE1_THREADS, 1, 1), args=[inputs['query_sq'], inputs['database_sq'], partial_dists, partial_indices, tmap_query, tmap_database, bsz, n_query, n_database, top_k, num_q_tiles, db_tiles_per_split, split_count, total_work], shared_mem=stage1_ir.computed_smem_bytes)
