...
def _verify_export_ir() -> Any:
    ...
    return base.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_ragonline_mbucket_99fd_q1large_s144g12_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 36608, "cta_group": 1, "threads": 96}'))
...
def route_for_contract_inputs(inputs: dict[str, Any], *, force_fallback: bool=False) -> str:
    if not force_fallback and _eligible_q1large_s144(inputs):
        split_count, group_count = _topology_for_inputs(inputs)
        return f'rag_online_mbucket_99fd_q1large_s{split_count}_g{group_count}_m{int(inputs['M'])}'
