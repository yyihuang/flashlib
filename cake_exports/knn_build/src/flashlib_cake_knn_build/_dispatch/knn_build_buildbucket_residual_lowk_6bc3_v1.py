...
PRODUCTION_ROUTE_MODULES = _decode_capture(_json_loads('{"6bc3_fixedbuild_k10_v2": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_k5merge4tree_vmin_maxtree_k5tree_mintree_k10s4s7cache_t32r32_k10mintree_fixedbuild_dispatch_v2:launch_from_contract_inputs", "6bc3_v20_q2048_k8_static_s8": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_k5merge4tree_vmin_maxtree_k5tree_mintree_k10s4s7cache_t32r32_k10mintree_fixedbuild_dispatch_v2_k32split_v20:launch_from_contract_inputs", "6bc3_v20_q512_k2_generic_lowk": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_k5merge4tree_vmin_maxtree_k5tree_mintree_k10s4s7cache_t32r32_k10mintree_fixedbuild_dispatch_v2_k32split_v20:launch_from_contract_inputs", "6bc3_v20_q512_k8_static_s8": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_k5merge4tree_vmin_maxtree_k5tree_mintree_k10s4s7cache_t32r32_k10mintree_fixedbuild_dispatch_v2_k32split_v20:launch_from_contract_inputs", "candidate_17b8_lowmargin_1074_full82_v1": "loom.examples.weave.knn_build_dispatch_17b8_lowmargin_1074_full82_v1:launch_from_contract_inputs"}'))
SOURCE_TASKS = _decode_capture(_json_loads('{"6bc3_fixedbuild_k10_v2": "fixed-build dispatch v2 K10 path", "6bc3_v20_q2048_k8_static_s8": "v20 fixed-build lineage static K8 Q2048 path", "6bc3_v20_q512_k2_generic_lowk": "v20 fixed-build lineage generic low-K Q512 path", "6bc3_v20_q512_k8_static_s8": "v20 fixed-build lineage static K8 Q512 path", "candidate_17b8_lowmargin_1074_full82_v1": "a444/9db7 low-margin full82 baseline"}'))
...
def _verify_export_ir() -> Any:
    ...
    return build_v20.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_buildbucket_residual_lowk_6bc3_v1:ir"}'))
...
def _route_trace_record(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    return base17b8._normalize_route_row({'shape_key': inputs.get('label'), 'selected_route': route, 'selected_entrypoint': _selected_entrypoint(expected_seed), 'selected_seed': expected_seed, 'expected_seed': expected_seed, 'route_kind': 'specialized', 'route_source': 'shape-specific-seed', 'guard_id': f'6bc3_residual_lowk_{expected_seed}', 'guard_condition': _guard_condition(expected_seed), 'baseline_17b8_route': base_route, 'replaced_route': base_route, 'classification': 'seed-consumed'})
