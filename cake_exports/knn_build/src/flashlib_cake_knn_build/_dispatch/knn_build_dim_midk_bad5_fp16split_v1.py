...
stage1_d256_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_fp16split_v1:stage1_d256_split_ir"}'))
stage1_fp16_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_fp16split_v1:stage1_fp16_split_ir"}'))
merge_generic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_fp16split_v1:merge_generic_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return stage1_fp16_split_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_bad5_fp16split_v1:ir"}'))
