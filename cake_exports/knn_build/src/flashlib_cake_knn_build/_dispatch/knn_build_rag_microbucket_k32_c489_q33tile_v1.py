...
EXPANDED_SHAPES_BY_LABEL = _decode_capture(_json_loads('{"expanded_guard_boundary_q31_m100000_d128_k32": {"label": "expanded_guard_boundary_q31_m100000_d128_k32", "params": {"B": 1, "D": 128, "K": 32, "M": 100000, "Q": 31, "benchmark": true, "build": false, "check_correctness": true, "correctness_query_sample": 31, "dtype": "bfloat16", "recall_min": 0.999, "seed": 626331, "time_flashlib": true}}, "expanded_guard_boundary_q33_m100000_d128_k32": {"label": "expanded_guard_boundary_q33_m100000_d128_k32", "params": {"B": 1, "D": 128, "K": 32, "M": 100000, "Q": 33, "benchmark": true, "build": false, "check_correctness": true, "correctness_query_sample": 33, "dtype": "bfloat16", "recall_min": 0.999, "seed": 626333, "time_flashlib": true}}, "expanded_heldout_q40_m100000_d128_k32": {"label": "expanded_heldout_q40_m100000_d128_k32", "params": {"B": 1, "D": 128, "K": 32, "M": 100000, "Q": 40, "benchmark": true, "build": false, "check_correctness": true, "correctness_query_sample": 40, "dtype": "bfloat16", "recall_min": 0.999, "seed": 626340, "time_flashlib": true}}, "expanded_tail_q32_m100001_d128_k32": {"label": "expanded_tail_q32_m100001_d128_k32", "params": {"B": 1, "D": 128, "K": 32, "M": 100001, "Q": 32, "benchmark": true, "build": false, "check_correctness": true, "correctness_query_sample": 32, "dtype": "bfloat16", "recall_min": 0.999, "seed": 627001, "time_flashlib": true}}, "expanded_tail_q32_m99999_d128_k32": {"label": "expanded_tail_q32_m99999_d128_k32", "params": {"B": 1, "D": 128, "K": 32, "M": 99999, "Q": 32, "benchmark": true, "build": false, "check_correctness": true, "correctness_query_sample": 32, "dtype": "bfloat16", "recall_min": 0.999, "seed": 626999, "time_flashlib": true}}}'))
K32_Q33TILE_SPLIT_COUNT = _decode_capture(_json_loads('144'))
K32_Q33TILE_GROUP_COUNT = _decode_capture(_json_loads('12'))
ROUTE_Q33TILE_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_k32_c489_q33tile_v1:ir"}'))
...
def _q33tile_route_name(inputs: dict[str, Any], *, split_count: int, group_count: int) -> str:
    ...
    return f'rag_microbucket_k32_c489_q33tile_v1_q{n_query}_m{n_database}_k32_m64n64_row16x256b_s{split_count}_g{group_count}_fusedmerge'
...
def benchmark_knn_build_rag_microbucket_k32_c489_q33tile_v1(*, use_cupti: bool=True, shape_labels=TARGET_SHAPES, k32_q33tile_split_count: int=K32_Q33TILE_SPLIT_COUNT, k32_q33tile_group_count: int=K32_Q33TILE_GROUP_COUNT) -> dict[str, Any]:
    ...
    return {'contract': candidate_report['contract'], 'contract_version': candidate_report['contract_version'], 'measured_entrypoint': f'{MODULE}:benchmark_knn_build_rag_microbucket_k32_c489_q33tile_v1', 'candidate_entrypoint': ROUTE_Q33TILE_ENTRYPOINT, 'dispatch_v11_entrypoint': ROUTE_DISPATCH_V11_ENTRYPOINT, 'accelerated_shape_labels': list(TARGET_SHAPES), 'measured_shape_labels': list(shape_labels), 'timing_backend_requested': 'cupti' if use_cupti else 'cuda_event', 'producer_topology': {'q33_q40': f'e5db four-compute-warp ROW_16x256B tcgen05/TMA stage1 over one 64-row query tile with split={k32_q33tile_split_count}, group={k32_q33tile_group_count}', 'q31_q32tail': 'delegated to 0cb5 q31tail seed', 'comparison_baseline': 'current v11 common-D seed portfolio dispatcher'}, 'merge_topology': {'q33_q40': f'e5db fused split merge S{k32_q33tile_split_count}/G{k32_q33tile_group_count}', 'q31_q32tail': '0cb5 q31tail rows4 split-list merge'}, 'route_trace': route_trace_for_contract_shapes(shape_labels, k32_q33tile_split_count=k32_q33tile_split_count, k32_q33tile_group_count=k32_q33tile_group_count), 'target_rows': _per_shape_delta(candidate_report, dispatcher_report), 'summary': candidate_report['summary'], 'performance': candidate_report['performance'], 'correctness': candidate_report['correctness'], 'report': candidate_report, 'dispatch_v11_summary': dispatcher_report['summary'], 'dispatch_v11_performance': dispatcher_report['performance'], 'dispatch_v11_report': dispatcher_report}
...
def write_benchmark_artifact(artifact_dir: str | os.PathLike[str], *, use_cupti: bool=True, shape_labels=TARGET_SHAPES, k32_q33tile_split_count: int=K32_Q33TILE_SPLIT_COUNT, k32_q33tile_group_count: int=K32_Q33TILE_GROUP_COUNT) -> dict[str, str]:
    ...
    path = out_dir / f'c489_q33tile_{len(tuple(shape_labels))}row_s{k32_q33tile_split_count}_g{k32_q33tile_group_count}_{suffix}.json'
