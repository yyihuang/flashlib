...
knn_build_k30_q4096_6998_merge_s4_unordered_warp_select = _decode_capture(_json_loads('{"__ir__": "knn_build_k30_q4096_6998_merge_s4_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 30], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 128}'))
merge_k30_q4096_warp_select_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k30_q4096_6998_merge_s4_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 30], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 128}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k30_q4096_6998_merge_s4_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 30], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 128}'))
