...
knn_build_rag_microbucket_k32_f590_q32exact_v1_stage1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_k32_f590_q32exact_v1:knn_build_rag_microbucket_k32_f590_q32exact_v1_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 66816, "cta_group": 1, "threads": 128}'))
stage1_q32_exact_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_k32_f590_q32exact_v1:stage1_q32_exact_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 66816, "cta_group": 1, "threads": 128}'))
...
def _verify_export_ir() -> Any:
    ...
    return _stage1_q32_exact_ir()
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_k32_f590_q32exact_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 66816, "cta_group": 1, "threads": 128}'))
