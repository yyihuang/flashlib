...
BENCHMARK_ENTRYPOINT = f'{MODULE}:benchmark_knn_build_dispatch_q1m524_v3_d192_b10e_consumption_v1'
BASELINE_ENTRYPOINT = base.ROUTE_ENTRYPOINT
SEED_ID = 'd192_wide256_s8_b10e'
SEED_ENTRYPOINT = f'{seed_b10e.MODULE}:launch_from_contract_inputs'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_q1m524_v3_d192_b10e_consumption_v1:ir"}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    candidate_path = out_dir / f'{denom}_d192_b10e_candidate.json'
    baseline_path = out_dir / f'{denom}_e054_same_session_baseline.json'
    trace_path = out_dir / f'{denom}_d192_b10e_route_trace.json'
...
def write_checkpointed_full_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    progress_path = out_dir / f'{denom}_d192_b10e_progress.json'
    candidate_path = out_dir / f'{denom}_d192_b10e_candidate.json'
    baseline_path = out_dir / f'{denom}_e054_same_session_baseline.json'
    trace_path = out_dir / f'{denom}_d192_b10e_route_trace.json'
