...
def _q4_route_row(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if force_fallback:
        ...
        row['guard_id'] = f'forced_fallback_{Q4_S144_SEED_ID}_disabled'
