...
knn_build_fp16_d128_lowfloor_fd37_k10_s8_merge = _decode_capture(_json_loads('{"__ir__": "knn_build_fp16_d128_lowfloor_fd37_k10_s8_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 8]], "cta_group": 1, "threads": 32}'))
...
merge_k10_s8_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_fp16_d128_lowfloor_fd37_k10_s8_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 8]], "cta_group": 1, "threads": 32}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_fp16_d128_lowfloor_fd37_k10_s8_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 10], ["SPLIT_COUNT", 8]], "cta_group": 1, "threads": 32}'))
...
def _launch_fp16_s8_cached_merge(inputs: dict[str, Any]) -> None:
    ...
    stage1_kernel.launch(grid=(stage1_grid, 1, 1), block=(THREADS, 1, 1), args=[inputs['query_sq'], inputs['database_sq'], partial_dists, partial_indices, tmap_query, tmap_database, bsz, n_query, n_database, top_k, num_q_tiles, db_tiles_per_split, FP16_SPLITS, total_work], shared_mem=stage1_fp16_split_ir.computed_smem_bytes)
