...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_e3de_8712_bcb3_2cfd_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    candidate_path = out_dir / f'{denom}_dispatch_e3de_8712_bcb3_2cfd_v1.json'
    baseline_e3de_path = out_dir / f'{denom}_same_session_baseline_e3de_for_2cfd_v1.json'
    baseline_8700_path = out_dir / f'{denom}_same_session_baseline_8700_for_2cfd_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_e3de_8712_bcb3_2cfd_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_e3de_8712_bcb3_2cfd_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_e3de_8712_bcb3_2cfd_v1.json'
