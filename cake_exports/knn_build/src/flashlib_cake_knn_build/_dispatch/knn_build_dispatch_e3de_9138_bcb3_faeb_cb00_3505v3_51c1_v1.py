...
ROUTE_RAG_Q16_K32_3505_V3 = f'rag_microbucket_3505_v3_q16_k32_tailinf_cta1_u1_s{rag_3505_v3.K32_SPLIT_COUNT}_g{rag_3505_v3.K32_GROUP_COUNT}'
...
CANDIDATE_DISPATCHERS = (*base_8940.CANDIDATE_DISPATCHERS, {'id': 'baseline_8940', 'entrypoint': f'{MODULE}:benchmark_baseline_8940', 'consumed_seeds': (CB00_SEED_ID, FAEB_SEED_ID, SEED_3505_V2_ID), 'guard_plan': ('8940 cb00 exact Q1 M131071/M250000 bucket', '8940 faeb exact Q4/Q64 K10', '8940 3505 v2 exact Q16 K32', 'then inherited 4247 guard stack'), 'expected_shape_wins': (*Q1_CB00_SELECTED_TARGET_SHAPES, *RAG_MICROBUCKET_TARGET_SHAPES), 'fallback': ROUTE_BASE_4247, 'rejected_reason': 'same-session base dispatcher before consuming e7e5'}, {'id': 'candidate_8940_e7e5_51c1_v1', 'entrypoint': f'{MODULE}:benchmark_knn_build_dispatch_e3de_9138_bcb3_faeb_cb00_3505v3_51c1_v1', 'consumed_seeds': (CB00_SEED_ID, FAEB_SEED_ID, SEED_3505_V3_ID), 'guard_plan': ('8940 cb00 exact Q1 M131071/M250000 bucket', '8940 faeb exact Q4/Q64 K10', 'e7e5 3505 v3 exact Q16 K32', 'then inherited 4247 guard stack'), 'expected_shape_wins': (*Q1_CB00_SELECTED_TARGET_SHAPES, *RAG_MICROBUCKET_TARGET_SHAPES), 'fallback': ROUTE_BASE_4247, 'rejected_reason': None})
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_faeb_cb00_3505v3_51c1_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    candidate_path = out_dir / f'{denom}_dispatch_e3de_9138_bcb3_faeb_cb00_3505v3_51c1_v1.json'
    baseline_8940_path = out_dir / f'{denom}_same_session_baseline_8940_for_51c1_v1.json'
    baseline_2422_path = out_dir / f'{denom}_same_session_baseline_2422_for_51c1_v1.json'
    baseline_6d62_path = out_dir / f'{denom}_same_session_baseline_6d62_for_51c1_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_e3de_9138_bcb3_faeb_cb00_3505v3_51c1_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_e3de_9138_bcb3_faeb_cb00_3505v3_51c1_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_e3de_9138_bcb3_faeb_cb00_3505v3_51c1_v1.json'
