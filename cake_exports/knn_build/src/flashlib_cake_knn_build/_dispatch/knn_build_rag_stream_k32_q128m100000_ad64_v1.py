...
ROUTE_Q128_M100000_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
...
def _route_name(*, split_count: int, group_count: int) -> str:
    return f'rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s{split_count}_g{group_count}'
