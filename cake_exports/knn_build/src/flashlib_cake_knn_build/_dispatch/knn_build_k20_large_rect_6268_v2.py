...
knn_build_k20_large_rect_s3_warp_select = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_large_rect_s3_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20]], "cta_group": 1, "threads": 128}'))
merge_k20_s3_warp_select_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_large_rect_s3_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20]], "cta_group": 1, "threads": 128}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k20_s3_warp_select_ir
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_large_rect_s3_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20]], "cta_group": 1, "threads": 128}'))
...
def _forced_split_count() -> int | None:
    ...
    if split_count not in (2, 3, 4, 8):
        raise ValueError(f'unsupported K20 split count for 6268 route: {split_count}')
    return split_count
