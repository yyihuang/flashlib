...
ROUTE_K96_WARPSELECT = f'{MODULE}:k96_q1024_s2_warpselect_merge'
...
stage1_k48_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:stage1_k48_ir"}'))
merge_k48_warpselect_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:merge_k48_warpselect_ir"}'))
stage1_k96_exact_prefill_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:stage1_k96_exact_prefill_ir"}'))
...
PRODUCTION_ROUTE_MODULES = _decode_capture(_json_loads('{"candidate_d03c_v2_k48_k96_warpselect_floor_repair": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:launch_from_contract_inputs", "candidate_fd9b_plus_01bb_2425_1b34_k5_bd76_k20_9334_k32_full90_v1": "loom.examples.weave.knn_build_dispatch_fd9b_floor_seed_portfolio_5720_full90_synthesis_v1:launch_from_contract_inputs", "d03c_k48_s4_warpselect_merge": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v1:launch_from_contract_inputs", "d03c_v2_k96_q1024_s2_warpselect_merge": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:launch_from_contract_inputs"}'))
knn_build_k96_merge_s2_unordered_warp_select = _ir_proxy('loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:knn_build_k96_merge_s2_unordered_warp_select', 256)
merge_k96_s2_warpselect_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:merge_k96_s2_warpselect_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k96_s2_warpselect_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_k48_k96_floor_repair_d03c_v2:ir"}'))
...
def _launch_k96_q1024_warpselect(inputs: dict[str, Any]) -> None:
    ...
    stage1_kernel.launch_cluster(grid=(stage1_grid, 1, 1), block=(k96_229a.STAGE1_THREADS, 1, 1), args=[inputs['query_sq'], inputs['database_sq'], partial_dists, partial_indices, tmap_query, tmap_database, bsz, n_query, n_database, top_k, num_q_tile_pairs, db_tiles_per_split, split_count, total_work], cluster_dims=(k96_229a.CTA_GROUP, 1, 1), shared_mem=stage1_k96_exact_prefill_ir.computed_smem_bytes)
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, speedup_floor: float=1.2) -> dict[str, str]:
    ...
    labels = _shape_labels(shape_labels)
    denom_label = 'd03c_v2_k48_k96_exact3' if labels == TARGET_SHAPES else f'custom_{len(labels)}'
    baseline_report = benchmark_baseline_4399(use_cupti=use_cupti, shape_labels=labels, benchmark_correctness=benchmark_correctness)
    ...
    baseline_path = out_dir / f'{denom_label}_same_session_baseline_4399_core_k5.json'
    payload_path = out_dir / f'{denom_label}_dispatch_d03c_k48_k96_v2.json'
    trace_path = out_dir / f'{denom_label}_route_trace_d03c_k48_k96_v2.json'
    forced_trace_path = out_dir / f'{denom_label}_forced_fallback_trace_d03c_k48_k96_v2.json'
    seed_matrix_path = out_dir / f'{denom_label}_seed_delta_matrix_d03c_k48_k96_v2.json'
