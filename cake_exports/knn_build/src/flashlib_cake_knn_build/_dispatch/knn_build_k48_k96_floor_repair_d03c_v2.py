...
stage1_k48_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_split_cg2_u2_stage1_k32_unordered_k48over32", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 48]], "cta_group": 1, "threads": 192}'))
merge_k48_warpselect_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k48_merge_s4_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 48], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 128}'))
stage1_k96_exact_prefill_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k96_stage1_exact_prefill_q1024_k96over64exactprefillq1024_e5db", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 96]], "cta_group": 1, "threads": 192}'))
...
knn_build_k96_merge_s2_unordered_warp_select = _decode_capture(_json_loads('{"__ir__": "knn_build_k96_merge_s2_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 96], ["SPLIT_COUNT", 2]], "cta_group": 1, "threads": 128}'))
merge_k96_s2_warpselect_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k96_merge_s2_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 96], ["SPLIT_COUNT", 2]], "cta_group": 1, "threads": 128}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k96_s2_warpselect_ir
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k96_merge_s2_unordered_warp_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 96], ["SPLIT_COUNT", 2]], "cta_group": 1, "threads": 128}'))
