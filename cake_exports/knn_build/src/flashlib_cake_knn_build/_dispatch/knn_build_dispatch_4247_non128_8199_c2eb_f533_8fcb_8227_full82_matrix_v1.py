...
ROUTE_D96_ENTRYPOINT = f'{seed_d96.MODULE}:launch_from_contract_inputs'
ROUTE_D320_ENTRYPOINT = f'{seed_d320.MODULE}:launch_from_contract_inputs'
ROUTE_D768_ENTRYPOINT = f'{seed_d768.MODULE}:launch_from_contract_inputs'
ROUTE_K32_ENTRYPOINT = f'{seed_k32.MODULE}:launch_from_contract_inputs'
...
def _producer_for_seed(seed_id: str, label: str) -> str:
    ...
    if seed_id == SEED_D768_ID:
        return f'm64_d768_fusedmerge_g{seed_d768.D768_GROUP_COUNT}'
    if seed_id == SEED_K32_ID:
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, candidate_key: str | None=None) -> dict[str, str]:
    ...
    baseline_path = out_dir / f'{denom}_same_session_baseline_8199_widecombine_for_split148_matrix_v1.json'
    summary_path = out_dir / f'{denom}_f533_split148_matrix_summary_v1.json'
