...
def _verify_export_ir() -> Any:
    ...
    if verify_kernel == 'k64_merge_s8_warp_select':
        ...
        return k64_split8._verify_export_ir()
    return base_e51c.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_selected_portfolio_f8c3_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
