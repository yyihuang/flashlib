...
stage1_d256_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8199_widecombine_v1:stage1_d256_ir"}'))
stage1_d384_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8199_widecombine_v1:stage1_d384_ir"}'))
pad_bf16_rows_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8199_widecombine_v1:pad_bf16_rows_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8199_widecombine_v1:merge_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    if verify_kernel == 'merge':
        return merge_ir
    return stage1_d384_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8199_widecombine_v1:ir"}'))
