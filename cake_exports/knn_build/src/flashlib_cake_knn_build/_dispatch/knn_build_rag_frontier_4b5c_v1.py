...
merge_k32_s32_cache_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k32s32_4b5c", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 32], ["SPLIT_COUNT", 32]], "cta_group": 1, "threads": 32}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k32_s32_cache_ir
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k32s32_4b5c", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 32], ["SPLIT_COUNT", 32]], "cta_group": 1, "threads": 32}'))
...
def _launch_k32_rag_frontier_s32(inputs: dict[str, Any]) -> None:
    ...
    stage1_kernel.launch_cluster(grid=(stage1_grid, 1, 1), block=(STAGE1_THREADS, 1, 1), args=[inputs['query_sq'], inputs['database_sq'], partial_dists, partial_indices, tmap_query, tmap_database, bsz, n_query, n_database, top_k, num_q_tile_pairs, db_tiles_per_split, K32_SPLIT_COUNT, total_work], cluster_dims=(CTA_GROUP, 1, 1), shared_mem=parent_k32.stage1_k32_ir.computed_smem_bytes)
