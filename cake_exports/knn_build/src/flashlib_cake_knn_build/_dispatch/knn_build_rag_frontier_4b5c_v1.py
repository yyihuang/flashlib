...
merge_k32_s32_cache_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4b5c_v1:merge_k32_s32_cache_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k32_s32_cache_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4b5c_v1:ir"}'))
