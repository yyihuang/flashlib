...
knn_build_rag_microbucket_faeb_v2_k32_wide_fused_group_final_merge = _ir_proxy('loom.examples.weave.knn_build_rag_microbucket_faeb_v2:knn_build_rag_microbucket_faeb_v2_k32_wide_fused_group_final_merge', 256)
wide_fused_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_faeb_v2:wide_fused_merge_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return rag_m64.stage1_m64_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_faeb_v2:ir"}'))
