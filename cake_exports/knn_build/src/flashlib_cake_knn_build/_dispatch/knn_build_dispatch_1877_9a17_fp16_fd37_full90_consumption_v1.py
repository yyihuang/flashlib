...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_1877_9a17_fp16_fd37_full90_consumption_v1:ir"}'))
...
BENCHMARK_ENTRYPOINT = f'{MODULE}:benchmark_candidate_fp16_fd37_full90_v1'
...
def _candidate_kernel_fn(candidate_key: str) -> Callable[[dict[str, Any]], None]:
    ...
    raise ValueError(f'unknown fd37 FP16 full90 candidate {candidate_key!r}')
...
def _fp16_trace_row(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if force_fallback:
        ...
        row['guard_id'] = f'forced_fallback_{SEED_FP16_D128_K10_ID}_disabled'
        row['guard_condition'] = f'forced fallback to 1877+9a17; {SEED_FP16_D128_K10_ID} disabled'
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, time_flashlib: bool=True, speedup_floor: float=1.2) -> dict[str, str]:
    ...
    baseline_path = out_dir / f'{denom_label}_same_session_baseline_9a17_v1.json'
    payload_path = out_dir / f'{denom_label}_dispatch_1877_plus_9a17_fp16_fd37_v1.json'
    trace_path = out_dir / f'{denom_label}_route_trace_1877_plus_9a17_fp16_fd37_v1.json'
    forced_trace_path = out_dir / f'{denom_label}_forced_fallback_trace_1877_plus_9a17_fp16_fd37_v1.json'
    seed_matrix_path = out_dir / f'{denom_label}_seed_delta_matrix_1877_plus_9a17_fp16_fd37_v1.json'
    summary_path = out_dir / f'{denom_label}_dispatcher_consumption_1877_9a17_fp16_fd37_v1.json'
