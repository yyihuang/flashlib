...
generic_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_vmin_maxtree_v1:generic_merge_ir"}'))
merge_k10_s4_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_vmin_maxtree_v1:merge_k10_s4_ir"}'))
merge_k10_s7_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_vmin_maxtree_v1:merge_k10_s7_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_vmin_maxtree_v1:merge_ir"}'))
knn_build_evolve_7bfc_split_cg2_stage1_batch8_cond4_vmin_maxtree = _ir_proxy('loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_vmin_maxtree_v1:knn_build_evolve_7bfc_split_cg2_stage1_batch8_cond4_vmin_maxtree', 256)
stage1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_vmin_maxtree_v1:stage1_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_evolve_7bfc_split_cg2_u2_smallmedfan_rag7_k10merge_stage1batch_cond4_vmin_maxtree_v1:ir"}'))
