...
ROUTE_Q16_K32 = f'rag_microbucket_3505_q16_k32_tailinf_s{K32_SPLIT_COUNT}_g{K32_GROUP_COUNT}'
...
def _verify_export_ir() -> Any:
    ...
    return q16_tailinf.stage1_k32_tailinf_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbucket_3505_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def route_for_contract_inputs(inputs: dict[str, Any], *, k32_split_count: int=K32_SPLIT_COUNT, k32_group_count: int=K32_GROUP_COUNT) -> str:
    ...
    if _eligible_q16_k32(inputs):
        return f'rag_microbucket_3505_q16_k32_tailinf_s{k32_split_count}_g{k32_group_count}'
...
def _target_rows(candidate_report: dict[str, Any], faeb_report: dict[str, Any], base_report: dict[str, Any], *, k32_split_count: int, k32_group_count: int) -> dict[str, Any]:
    ...
    for label in TARGET_SHAPES:
        ...
        route = f'rag_microbucket_3505_q16_k32_tailinf_s{k32_split_count}_g{k32_group_count}' if label == Q16_K32_SHAPE else ROUTE_Q4_K10 if label == Q4_K10_SHAPE else ROUTE_Q64_K10
