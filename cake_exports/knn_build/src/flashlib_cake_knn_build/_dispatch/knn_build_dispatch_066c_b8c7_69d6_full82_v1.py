...
BASE_D555_ENTRYPOINT = f'{dispatch_066c.MODULE}:benchmark_baseline_d555'
BASE_066C_ENTRYPOINT = f'{dispatch_066c.MODULE}:benchmark_candidate_rag_microbatch_k10_q4q64_m64_3505_d555_v1'
ROUTE_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
ROUTE_BASE_066C_ENTRYPOINT = f'{dispatch_066c.MODULE}:launch_from_contract_inputs'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_066c_b8c7_69d6_full82_v1:ir"}'))
...
def _q4q64_seed_for_mode(q4q64_mode: str) -> str:
    ...
    raise ValueError(f'unknown q4q64 mode {q4q64_mode!r}')
...
def _q4q64_trace_record(inputs: dict[str, Any], *, q4q64_mode: str, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if force_fallback:
        ...
        row['guard_id'] = f'forced_fallback_{q4q64_mode}_q4q64_disabled'
        row['guard_condition'] = f'forced fallback to d555; {q4q64_mode} Q4/Q64 seed disabled'
        row['classification'] = 'guard-miss'
        return _normalize_route_row(row)
    if q4q64_mode == Q4Q64_MODE_3505:
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, time_flashlib: bool=True) -> dict[str, str]:
    ...
    baseline_d555_path = out_dir / f'{denom_label}_same_session_baseline_d555_for_066c_b8c7_69d6_v1.json'
    baseline_066c_path = out_dir / f'{denom_label}_same_session_baseline_066c_q4q64_3505_v1.json'
    candidate_3505_path = out_dir / f'{denom_label}_dispatch_066c_3505_plus_b8c7_v1.json'
    candidate_69d6_path = out_dir / f'{denom_label}_dispatch_066c_69d6_plus_b8c7_v1.json'
    route_trace_3505_path = out_dir / f'{denom_label}_route_trace_066c_3505_plus_b8c7_v1.json'
    route_trace_69d6_path = out_dir / f'{denom_label}_route_trace_066c_69d6_plus_b8c7_v1.json'
    forced_trace_3505_path = out_dir / f'{denom_label}_forced_fallback_trace_066c_3505_plus_b8c7_v1.json'
    forced_trace_69d6_path = out_dir / f'{denom_label}_forced_fallback_trace_066c_69d6_plus_b8c7_v1.json'
    seed_matrix_path = out_dir / f'{denom_label}_seed_delta_matrix_066c_b8c7_69d6_v1.json'
    synthesis_path = out_dir / f'{denom_label}_dispatcher_synthesis_066c_b8c7_69d6_v1.json'
    baseline_d555_path.write_text(json.dumps(_baseline_sidecar(baseline_d555, candidate_id=str(BASE_D555_ID), measured_entrypoint=f'{MODULE}:benchmark_baseline_d555', denominator=denominator, timing_backend=timing_backend, benchmark_correctness=benchmark_correctness, time_flashlib=time_flashlib), indent=2, sort_keys=True) + '\n', encoding='utf-8')
    baseline_066c_path.write_text(json.dumps(_baseline_sidecar(baseline_066c, candidate_id=BASE_066C_ID, measured_entrypoint=f'{MODULE}:benchmark_baseline_066c', denominator=denominator, timing_backend=timing_backend, benchmark_correctness=benchmark_correctness, time_flashlib=time_flashlib), indent=2, sort_keys=True) + '\n', encoding='utf-8')
