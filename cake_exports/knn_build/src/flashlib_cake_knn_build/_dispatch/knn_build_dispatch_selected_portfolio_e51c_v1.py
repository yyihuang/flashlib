...
def _verify_export_ir() -> Any:
    ...
    if verify_kernel == 'midk_9b2c_merge_k28_unordered':
        ...
        return midk_9b2c._verify_export_ir()
    return base_f552.ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_selected_portfolio_e51c_v1:ir", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
...
def _route_with_policy(inputs: dict[str, Any], *, force_fallback: bool=False, midk_policy: str='selected') -> str:
    ...
    if midk_policy == 'selected':
        ...
        raise ValueError(f'unknown midK routing policy: {midk_policy}')
    return base_f552.route_for_contract_inputs(inputs)
