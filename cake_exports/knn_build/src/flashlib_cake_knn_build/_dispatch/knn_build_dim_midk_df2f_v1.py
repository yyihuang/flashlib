...
from . import knn_build_evolve_7bfc_d256_twomma_knn_build_dispatch_slurm_0610_6329_v23 as dim_d256
...
knn_build_dim_midk_df2f_d256_split_stage1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_df2f_v1:knn_build_dim_midk_df2f_d256_split_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 99584, "cta_group": 1, "threads": 192}'))
knn_build_dim_midk_df2f_fp16_split_stage1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_df2f_v1:knn_build_dim_midk_df2f_fp16_split_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
stage1_d256_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_df2f_v1:stage1_d256_split_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 99584, "cta_group": 1, "threads": 192}'))
stage1_fp16_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_df2f_v1:stage1_fp16_split_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 50432, "cta_group": 1, "threads": 192}'))
merge_generic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_df2f_v1:merge_generic_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dim_midk_df2f_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 99584, "cta_group": 1, "threads": 192}'))
