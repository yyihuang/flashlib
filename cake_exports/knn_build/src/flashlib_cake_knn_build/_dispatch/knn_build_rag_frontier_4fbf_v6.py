...
knn_build_rag_frontier_4fbf_stage1_k32_sort4earlystop_tailinf = _ir_proxy('loom.examples.weave.knn_build_rag_frontier_4fbf_v6:knn_build_rag_frontier_4fbf_stage1_k32_sort4earlystop_tailinf', 256)
stage1_k32_tailinf_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4fbf_v6:stage1_k32_tailinf_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_4fbf_v6:ir"}'))
