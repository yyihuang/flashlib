...
stage1_d320tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d320tail_ir"}'))
stage1_d256_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d256_ir"}'))
stage1_d384_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d384_ir"}'))
stage1_m64_d768_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_m64_d768_ir"}'))
pad_bf16_rows_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:pad_bf16_rows_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:merge_ir"}'))
knn_build_non128_frontier_8227_d320tail_stage1 = _ir_proxy('loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:knn_build_non128_frontier_8227_d320tail_stage1', 256)
stage1_d320tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d320tail_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    if verify_kernel == 'merge':
        return merge_ir
    return stage1_d320tail_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:ir"}'))
