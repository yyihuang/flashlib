...
stage1_d320tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d320tail_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 124160, "cta_group": 1, "threads": 192}'))
stage1_d256_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d256_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 99584, "cta_group": 1, "threads": 192}'))
stage1_d384_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d384_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 148736, "cta_group": 1, "threads": 192}'))
stage1_m64_d768_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_m64_d768_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 34048, "cta_group": 1, "threads": 96}'))
pad_bf16_rows_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:pad_bf16_rows_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
knn_build_non128_frontier_8227_d320tail_stage1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:knn_build_non128_frontier_8227_d320tail_stage1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 124160, "cta_group": 1, "threads": 192}'))
stage1_d320tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:stage1_d320tail_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 124160, "cta_group": 1, "threads": 192}'))
...
def _verify_export_ir() -> Any:
    ...
    if verify_kernel == 'merge':
        return merge_ir
    return stage1_d320tail_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_8227_d320tail_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 124160, "cta_group": 1, "threads": 192}'))
