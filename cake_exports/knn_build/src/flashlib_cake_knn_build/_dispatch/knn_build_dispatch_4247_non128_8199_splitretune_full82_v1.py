...
CANDIDATE_DISPATCHERS = _decode_capture(_json_loads('{"__tuple__": [{"consumed_seeds": {"__tuple__": ["large_square_k20k32", "over64_k96", "baseline_7c3a_rag_k10", "rag_frontier_7399_k10", "rag_frontier_7399_k32_replaced", "rag_frontier_4fbf_k32", "rect_smallq_largem_d15e", "baseline_7c3a_policy", "fallback", "dim_d64_73a9", "current_exact_k32_dispatcher", "base_7399_d15e_dispatcher", "rag_frontier_7399_k32", "dim_d256_df2f", "dim_fp16_d128_df2f", "base_dispatch", "rect_intermediate_4452_s8", "base_champion_6b59", "base_k32_d64_62b1", "default_k96_a330", "large_tail_a4f6", "midk_81aa_q2048_k24_k28", "midk_9b2c_q4096_k28", "base_f552", "midk_bad5_k64split8", "base_e51c", "midk_f8c3_q4096_k64_split8_a194", "base_f8c3", "lowk_b193_q512_s4", "lowk_b193_q1024_k16_s16", "large_square_5407_q8192_k32_s2", "base_f853", "lowk_b193_q512_k4_k5_k6_s4", "base_f16b", "rag_microbatch_b2ec_s72_g8", "base_4a72", "rag_m64_s128_0c69", "rag_s144_g12_cta1_059f", "rag_s144_g8_cta1_4982_read_ref_parameterized", "base_397b", "d64_fdd7_aa88_v2", "base_8700", "rect_d64_cf49_v3_9138", "q1_mbucket_aa88_q1m_v3_bcb3", "over64_k96_a2f8_v1_generated_v8", "base_e3de"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:benchmark_knn_build_dispatch_e3de_9138_bcb3_4247_v1", "expected_shape_wins": {"__tuple__": ["build_large_b1_q8192_m8192_d128_k20", "build_large_b1_q8192_m8192_d128_k32", "build_over64_stress_qm2048_k96", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "rag_batch_b2_q256_m50000_d128_k10", "rag_irregular_b1_q512_m131071_d128_k10", "search_rect_b1_q1024_m8192_d128_k10", "build_dim_sweep_b1_q2048_m2048_d64_k10", "build_dim_sweep_b1_q2048_m2048_d256_k10", "build_dtype_fp16_b1_q2048_m2048_d128_k10", "search_rect_b1_q2048_m32768_d128_k10", "build_large_tail_b1_q6144_m6144_d128_k20", "build_k_sweep_qm2048_k24", "build_k_sweep_qm2048_k28", "build_k_sweep_qm4096_k28", "build_over32_stress_qm2048_k64", "build_over32_stress_qm4096_k64", "build_k_sweep_qm512_k1", "build_k_sweep_qm512_k2", "build_k_sweep_qm1024_k16", "build_k_sweep_qm512_k4", "build_k_sweep_qm512_k5", "build_k_sweep_qm512_k6", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q32_m100000_d128_k10", "build_dim_sweep_b1_q1024_m1024_d64_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10", "search_rect_b1_q1024_m32768_d64_k10", "rag_online_b1_q1_m100000_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "build_over64_stress_qm1024_k96", "build_over64_stress_qm4096_k96"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["exported 4247 guard stack"]}, "id": "baseline_exported_4247", "rejected_reason": "same-session exported-registry baseline"}, {"consumed_seeds": {"__tuple__": ["non128_frontier_8199_splitretune_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_4247_non128_8199_splitretune_full82_v1:benchmark_knn_build_dispatch_4247_non128_8199_splitretune_full82_v1", "expected_shape_wins": {"__tuple__": ["build_dim_sweep_b1_q1024_m1024_d96_k10", "build_dim_sweep_b1_q2048_m2048_d192_k10", "build_highd_b1_q1024_m1024_d320_k10", "search_rect_highd_b1_q512_m12000_d320_k10", "rag_microbatch_highd_b1_q16_m50000_d768_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["five exact split-retuned non-D128 frontier guards", "then exported 4247 guard stack"]}, "id": "candidate_4247_non128_8199_splitretune_full82_v1", "rejected_reason": null}]}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_4247_non128_8199_splitretune_full82_v1:ir"}'))
...
def _non128_trace_record(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    return {'shape_key': label, 'selected_route': route, 'selected_entrypoint': ROUTE_NON128_ENTRYPOINT, 'selected_seed': SEED_NON128_ID, 'expected_seed': SEED_NON128_ID, 'route_kind': 'specialized', 'route_source': 'shape-specific-seed', 'guard_id': '8199_splitretune_non128_exact_shape_guard', 'guard_condition': f'exact BF16 B={spec['B']} Q={spec['Q']} M={spec['M']} D={spec['D']} K={spec['K']} build={spec['build']}', 'coverage': 'consumes 8199 split-retuned non-D128 frontier seed before exported 4247 fallback', 'consumed_seed': SEED_NON128_ID, 'replaced_route': base_4247.route_for_contract_inputs(inputs), 'base_4247_route': base_4247.route_for_contract_inputs(inputs), 'feature_chunks': spec['feature_chunks'], 'split_count': non128_seed._split_count_for_label(label), 'preprocess_stage': f'd{int(spec['D'])}_weave_pad_to_d{int(spec['feature_chunks']) * non128_seed.K_TILE}' if int(spec['D']) != int(spec['feature_chunks']) * non128_seed.K_TILE else None, 'targeted_seed_timing_backend': 'cupti', 'targeted_seed_kernel_ms': targeted['kernel_ms'], 'targeted_seed_ratio_vs_flashlib': targeted['ratio_vs_flashlib'], 'row_selection': targeted, 'classification': 'seed-consumed', 'dispatcher_kernel_ms': None, 'shape_specific_kernel_ms': targeted['kernel_ms'], 'relative_speedup_vs_baseline': None}
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    candidate_path = out_dir / f'{denom}_dispatch_4247_non128_8199_splitretune_full82_v1.json'
    baseline_path = out_dir / f'{denom}_same_session_baseline_4247_for_non128_8199_splitretune_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_4247_non128_8199_splitretune_full82_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_4247_non128_8199_splitretune_full82_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_4247_non128_8199_splitretune_full82_v1.json'
