...
PRODUCTION_ROUTE_MODULES = {**base_ed1c.PRODUCTION_ROUTE_MODULES, SEED_E5C1_ID: ROUTE_E5C1_ENTRYPOINT, 'base_ed1c': f'{base_ed1c.MODULE}:launch_from_contract_inputs'}
CANDIDATE_DISPATCHERS = _decode_capture(_json_loads('{"__tuple__": [{"consumed_seeds": {"__tuple__": ["registered_c142_v8_k96_coverage"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_c142_3505_q32rowld_19b3_v1:benchmark_current_registry_c142", "expected_shape_wins": {"__tuple__": ["build_large_b1_q8192_m8192_d128_k20", "build_large_b1_q8192_m8192_d128_k32", "build_over64_stress_qm2048_k96", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "rag_batch_b2_q256_m50000_d128_k10", "rag_irregular_b1_q512_m131071_d128_k10", "search_rect_b1_q1024_m8192_d128_k10", "build_dim_sweep_b1_q2048_m2048_d64_k10", "build_dim_sweep_b1_q2048_m2048_d256_k10", "build_dtype_fp16_b1_q2048_m2048_d128_k10", "search_rect_b1_q2048_m32768_d128_k10", "build_large_tail_b1_q6144_m6144_d128_k20", "build_k_sweep_qm2048_k24", "build_k_sweep_qm2048_k28", "build_k_sweep_qm4096_k28", "build_over32_stress_qm2048_k64", "build_over32_stress_qm4096_k64", "build_k_sweep_qm512_k1", "build_k_sweep_qm512_k2", "build_k_sweep_qm1024_k16", "build_k_sweep_qm512_k4", "build_k_sweep_qm512_k5", "build_k_sweep_qm512_k6", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q32_m100000_d128_k10", "build_dim_sweep_b1_q1024_m1024_d64_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10", "search_rect_b1_q1024_m32768_d64_k10", "rag_online_b1_q1_m100000_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "build_over64_stress_qm1024_k96", "build_over64_stress_qm4096_k96"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["registered benchmark_data knn_build c142 guard stack"]}, "id": "current_registry_c142", "rejected_reason": "current exported dispatcher baseline; not retargeted by this lane"}, {"consumed_seeds": {"__tuple__": ["registered_c142_v8_k96_coverage", "rag_microbucket_3505_v7_752a_consumption"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_c142_3505_q32rowld_19b3_v1:benchmark_baseline_ed1c_v7", "expected_shape_wins": {"__tuple__": ["rag_microbatch_b1_q4_m100000_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_microbatch_b1_q32_m100000_d128_k10", "rag_microbatch_b1_q64_m100000_d128_k10", "rag_microbatch_largek_b1_q8_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q32_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32"]}, "fallback": "loom.examples.weave.knn_build_dispatch_c142_3505_replay_ed1c_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["3505_v7 exact microbucket guards before registered c142", "then registered c142 guard stack"]}, "id": "baseline_ed1c_c142_3505v7", "rejected_reason": "current clean full77 champion baseline for e5c1 consumption"}, {"consumed_seeds": {"__tuple__": ["registered_c142_v8_k96_coverage", "rag_microbucket_3505_v7_752a_consumption", "rag_microbucket_q32rowld_e5db_v1_q32_row16x256b"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_c142_3505_q32rowld_19b3_v1:benchmark_knn_build_dispatch_c142_3505v7_q32rowld_19b3_v1", "expected_shape_wins": {"__tuple__": ["rag_microbatch_largek_b1_q32_m100000_d128_k32"]}, "fallback": "loom.examples.weave.knn_build_dispatch_c142_3505_replay_ed1c_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["e5c1 exact BF16 non-build B=1 Q=32 M=100000 D=128 K=32 guard before ed1c", "then ed1c 3505_v7 exact microbucket guards", "then registered c142 guard stack"]}, "id": "candidate_ed1c_plus_q32rowld_19b3", "rejected_reason": null}]}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_c142_3505_q32rowld_19b3_v1:ir"}'))
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    combined_path = out_dir / f'{denom}_same_session_c142_ed1c_q32rowld_19b3_v1.json'
    baseline_c142_path = out_dir / f'{denom}_same_session_baseline_c142_for_19b3_v1.json'
    baseline_ed1c_path = out_dir / f'{denom}_same_session_baseline_ed1c_for_19b3_v1.json'
    candidate_path = out_dir / f'{denom}_dispatch_c142_3505v7_q32rowld_19b3_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_c142_3505v7_q32rowld_19b3_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_c142_3505v7_q32rowld_19b3_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_c142_ed1c_q32rowld_19b3_v1.json'
