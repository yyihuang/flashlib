...
stage1_d96exact_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:stage1_d96exact_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 38144, "cta_group": 1, "threads": 192}'))
stage1_d256_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:stage1_d256_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 99584, "cta_group": 1, "threads": 192}'))
stage1_d320tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:stage1_d320tail_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 124160, "cta_group": 1, "threads": 192}'))
stage1_m64_d768_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:stage1_m64_d768_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 34048, "cta_group": 1, "threads": 96}'))
fused_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:fused_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 1024, "cta_group": 1, "threads": 32}'))
merge_generic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:merge_generic_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
knn_build_non128_frontier_3d5a_k10_merge_s8_rowbase_cache = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:knn_build_non128_frontier_3d5a_k10_merge_s8_rowbase_cache", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
merge_k10_s8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:merge_k10_s8_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k10_s8_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_non128_frontier_3d5a_cachedmerge_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
