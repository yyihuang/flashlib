"""Full82 non-D128 widecombine dispatcher-consumption wrapper over 4247.
...
the five round-8199 widecombine frontier rows. Guard misses stay on the inherited 4247
...
from . import knn_build_dispatch_4247_non128_8199_splitretune_full82_v1 as baseline_splitretune
from . import knn_build_non128_frontier_8199_widecombine_v1 as non128_seed
MODULE = 'loom.examples.weave.knn_build_dispatch_4247_non128_8199_widecombine_full82_v1'
SEED_NON128_ID = 'non128_frontier_8199_widecombine_v1'
ROUTE_NON128_ENTRYPOINT = f'{non128_seed.MODULE}:launch_from_contract_inputs'
...
CANDIDATE_DISPATCHERS = _decode_capture(_json_loads('{"__tuple__": [{"consumed_seeds": {"__tuple__": ["non128_frontier_8199_splitretune_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_4247_non128_8199_splitretune_full82_v1:benchmark_knn_build_dispatch_4247_non128_8199_splitretune_full82_v1", "expected_shape_wins": {"__tuple__": ["build_large_b1_q8192_m8192_d128_k20", "build_large_b1_q8192_m8192_d128_k32", "build_over64_stress_qm2048_k96", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "rag_batch_b2_q256_m50000_d128_k10", "rag_irregular_b1_q512_m131071_d128_k10", "search_rect_b1_q1024_m8192_d128_k10", "build_dim_sweep_b1_q2048_m2048_d64_k10", "build_dim_sweep_b1_q2048_m2048_d256_k10", "build_dtype_fp16_b1_q2048_m2048_d128_k10", "search_rect_b1_q2048_m32768_d128_k10", "build_large_tail_b1_q6144_m6144_d128_k20", "build_k_sweep_qm2048_k24", "build_k_sweep_qm2048_k28", "build_k_sweep_qm4096_k28", "build_over32_stress_qm2048_k64", "build_over32_stress_qm4096_k64", "build_k_sweep_qm512_k1", "build_k_sweep_qm512_k2", "build_k_sweep_qm1024_k16", "build_k_sweep_qm512_k4", "build_k_sweep_qm512_k5", "build_k_sweep_qm512_k6", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q32_m100000_d128_k10", "build_dim_sweep_b1_q1024_m1024_d64_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10", "search_rect_b1_q1024_m32768_d64_k10", "rag_online_b1_q1_m100000_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "build_over64_stress_qm1024_k96", "build_over64_stress_qm4096_k96", "build_dim_sweep_b1_q1024_m1024_d96_k10", "build_dim_sweep_b1_q2048_m2048_d192_k10", "build_highd_b1_q1024_m1024_d320_k10", "search_rect_highd_b1_q512_m12000_d320_k10", "rag_microbatch_highd_b1_q16_m50000_d768_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["five exact splitretune non-D128 frontier guards", "then exported 4247 guard stack"]}, "id": "baseline_4247_non128_8199_splitretune_full82_v1", "rejected_reason": "same-session splitretune full82 baseline"}, {"consumed_seeds": {"__tuple__": ["non128_frontier_8199_widecombine_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_4247_non128_8199_widecombine_full82_v1:benchmark_knn_build_dispatch_4247_non128_8199_widecombine_full82_v1", "expected_shape_wins": {"__tuple__": ["build_dim_sweep_b1_q1024_m1024_d96_k10", "build_dim_sweep_b1_q2048_m2048_d192_k10", "build_highd_b1_q1024_m1024_d320_k10", "search_rect_highd_b1_q512_m12000_d320_k10", "rag_microbatch_highd_b1_q16_m50000_d768_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["five exact widecombine non-D128 frontier guards", "then exported 4247 guard stack"]}, "id": "candidate_4247_non128_8199_widecombine_full82_v1", "rejected_reason": null}]}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_4247_non128_8199_widecombine_full82_v1:ir"}'))
...
def candidate_baseline_splitretune(inputs: dict[str, Any]) -> None:
    baseline_splitretune.launch_from_contract_inputs(inputs)
...
def _base_route_trace_record(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    row['baseline_dispatcher_route'] = baseline_splitretune.route_for_contract_inputs(inputs)
...
def _non128_trace_record(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    feature_dim = non128_seed._feature_dim_for_label(label)
    return {'shape_key': label, 'selected_route': route, 'selected_entrypoint': ROUTE_NON128_ENTRYPOINT, 'selected_seed': SEED_NON128_ID, 'expected_seed': SEED_NON128_ID, 'route_kind': 'specialized', 'route_source': 'shape-specific-seed', 'guard_id': '8199_widecombine_non128_exact_shape_guard', 'guard_condition': f'exact BF16 B={spec['B']} Q={spec['Q']} M={spec['M']} D={spec['D']} K={spec['K']} build={spec['build']}', 'coverage': 'consumes 8199 widecombine non-D128 frontier seed before exported 4247 fallback', 'consumed_seed': SEED_NON128_ID, 'replaced_route': baseline_splitretune.route_for_contract_inputs(inputs), 'baseline_dispatcher_route': baseline_splitretune.route_for_contract_inputs(inputs), 'base_4247_route': base_4247.route_for_contract_inputs(inputs), 'feature_chunks': spec['feature_chunks'], 'feature_dim': feature_dim, 'producer': non128_seed._producer_for_label(label), 'split_count': non128_seed._split_count_for_label(label), 'preprocess_stage': f'd{int(spec['D'])}_weave_pad_to_d{feature_dim}' if int(spec['D']) != feature_dim else None, 'targeted_seed_timing_backend': 'cupti', 'targeted_seed_kernel_ms': targeted['kernel_ms'], 'targeted_seed_ratio_vs_flashlib': targeted['ratio_vs_flashlib'], 'row_selection': targeted, 'classification': 'seed-consumed', 'dispatcher_kernel_ms': None, 'shape_specific_kernel_ms': targeted['kernel_ms'], 'relative_speedup_vs_baseline': None}
...
def _route_trace_record(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    if force_fallback and non128_seed._target_label_for_inputs(inputs) is not None:
        ...
        row['guard_id'] = 'forced_fallback_8199_widecombine_non128_disabled'
        row['guard_condition'] = 'forced fallback to exported 4247; 8199 widecombine non-D128 overlay disabled'
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    payload = benchmark_knn_build_dispatch_4247_non128_8199_widecombine_full82_v1(use_cupti=use_cupti, shape_labels=shape_labels)
    out_dir = Path(artifact_dir)
    out_dir.mkdir(parents=True, exist_ok=True)
    denom = _denominator_label(shape_labels)
    candidate_path = out_dir / f'{denom}_dispatch_4247_non128_8199_widecombine_full82_v1.json'
    baseline_path = out_dir / f'{denom}_same_session_baseline_splitretune_for_non128_8199_widecombine_v1.json'
    route_trace_path = out_dir / f'{denom}_route_trace_4247_non128_8199_widecombine_full82_v1.json'
    forced_trace_path = out_dir / f'{denom}_forced_fallback_trace_4247_non128_8199_widecombine_full82_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_4247_non128_8199_widecombine_full82_v1.json'
