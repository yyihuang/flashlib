...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:ir"}'))
...
CANDIDATE_9A17_ONLY_ENTRYPOINT = f'{MODULE}:benchmark_candidate_9a17_only_full90_v1'
CANDIDATE_B644_ONLY_ENTRYPOINT = f'{MODULE}:benchmark_candidate_b644_only_full90_v1'
CANDIDATE_6A35_D64_ENTRYPOINT = f'{MODULE}:benchmark_candidate_6a35_d64_only_full90_v1'
CANDIDATE_B644_6A35_ENTRYPOINT = f'{MODULE}:benchmark_candidate_b644_6a35_full90_v1'
CANDIDATE_9A17_B644_ENTRYPOINT = f'{MODULE}:benchmark_candidate_9a17_b644_full90_v1'
CANDIDATE_9A17_6A35_ENTRYPOINT = f'{MODULE}:benchmark_candidate_9a17_6a35_full90_v1'
CANDIDATE_COMBINED_ENTRYPOINT = f'{MODULE}:benchmark_candidate_9a17_b644_6a35_full90_v1'
...
PRODUCTION_ROUTE_MODULES = {**base1877.PRODUCTION_ROUTE_MODULES, **rag_9a17.PRODUCTION_ROUTE_MODULES, **build_b644.PRODUCTION_ROUTE_MODULES, SEED_6A35_D64_ID: f'{d64_6a35.MODULE}:launch_from_contract_inputs', BASE_1877_ID: BASE_1877_ROUTE_ENTRYPOINT}
...
def _candidate_config(candidate_key: str) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f'unknown full90 1877/9a17/b644/6a35 candidate {candidate_key!r}') from exc
...
def _seed_trace_for_module(seed_module, label: str) -> dict[str, Any]:
    if seed_module is d64_6a35:
        ...
        return {'shape_key': label, 'selected_route': route, 'selected_entrypoint': f'{d64_6a35.MODULE}:launch_from_contract_inputs', 'selected_seed': SEED_6A35_D64_ID, 'expected_seed': SEED_6A35_D64_ID, 'route_kind': 'specialized', 'route_source': 'shape-specific-seed', 'guard_id': f'selective_6a35_{SEED_6A35_D64_ID}', 'guard_condition': 'exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered', 'matched_label': d64_6a35.TARGET_SHAPE, 'classification': 'seed-consumed'}
...
def _candidate_kernel_fn(candidate_key: str) -> Callable[[dict[str, Any]], None]:
    ...
    raise ValueError(f'unknown full90 1877/9a17/b644/6a35 candidate {candidate_key!r}')
...
CANDIDATE_CONFIGS = _decode_capture(_json_loads('{"1877_plus_6a35_d64": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_6a35_d64_only_full90_v1", "candidate_id": "candidate_1877_plus_6a35_d64_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:candidate_6a35_d64_only_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": ["d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "rejected_reason": "single exact D64 diagnostic; misses 9a17 and b644 rows", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}}, "1877_plus_9a17_6a35_d64": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_6a35_full90_v1", "candidate_id": "candidate_1877_plus_9a17_6a35_d64_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:candidate_9a17_6a35_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact-two residual RAG/search guards", "6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": ["rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "rejected_reason": "legal combination; measured only when requested", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}}, "1877_plus_9a17_b644_exact5": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_b644_full90_v1", "candidate_id": "candidate_1877_plus_9a17_b644_exact5_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:candidate_9a17_b644_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact-two residual RAG/search guards", "b644 exact-five build low-floor guards", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": ["rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4"]}, "rejected_reason": "legal combination; measured only when requested", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4"]}}, "1877_plus_9a17_b644_exact5_6a35_d64": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_b644_6a35_full90_v1", "candidate_id": "candidate_1877_plus_9a17_b644_exact5_6a35_d64_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:candidate_9a17_b644_6a35_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact-two residual RAG/search guards", "b644 exact-five build low-floor guards", "6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": ["rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "rejected_reason": "selected only if same-session full90 no-regression passes", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}}, "1877_plus_9a17_residual_rag_search": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_only_full90_v1", "candidate_id": "candidate_1877_plus_9a17_residual_rag_search_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:candidate_9a17_only_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact BF16 non-build B=1 Q=128 M=100000 D=128 K=32 guard", "9a17 exact BF16 non-build B=1 Q=1024 M=8192 D=128 K=10 guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": ["rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1"]}, "rejected_reason": "diagnostic replay of the cca8 9a17-only candidate", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1"]}}, "1877_plus_b644_exact5": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_b644_only_full90_v1", "candidate_id": "candidate_1877_plus_b644_exact5_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:candidate_b644_only_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["b644 exact BF16 build B=1 Q=M=512 D=128 K=2 split4 guard", "b644 exact BF16 build B=1 Q=M=4096 D=128 K=8 split4 guard", "b644 exact BF16 build B=1 Q=M=2048 D=128 K in {11,13} guard", "b644 exact BF16 build B=1 Q=M=3072 D=128 K=20 split4 guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": ["d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4"]}, "rejected_reason": "single seed-bank diagnostic; misses 9a17 and 6a35 D64 rows", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4"]}}, "1877_plus_b644_exact5_6a35_d64": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_b644_6a35_full90_v1", "candidate_id": "candidate_1877_plus_b644_exact5_6a35_d64_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:candidate_b644_6a35_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["b644 exact-five build low-floor guards", "6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": ["d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "rejected_reason": "build-only portfolio; selected only if full90 aggregate wins without 9a17", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}}, "ad64_plus_best_per_shape_build_k10_plus_ceb3": {"benchmark_entrypoint": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:benchmark_candidate_best_build_ceb3_full90_v1", "candidate_id": "candidate_ad64_plus_best_build_k10_plus_ceb3_full90_v1", "entrypoint": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "new_seed_ids": {"__tuple__": []}, "rejected_reason": "same-session 1877 full90 champion baseline", "selected_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1"]}}}'))
CANDIDATE_DISPATCHERS = _decode_capture(_json_loads('{"__tuple__": [{"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:benchmark_candidate_best_build_ceb3_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_ad64_plus_best_build_k10_plus_ceb3_full90_v1", "rejected_reason": "same-session 1877 full90 champion baseline"}, {"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_only_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact BF16 non-build B=1 Q=128 M=100000 D=128 K=32 guard", "9a17 exact BF16 non-build B=1 Q=1024 M=8192 D=128 K=10 guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_1877_plus_9a17_residual_rag_search_full90_v1", "rejected_reason": "diagnostic replay of the cca8 9a17-only candidate"}, {"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_b644_only_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["b644 exact BF16 build B=1 Q=M=512 D=128 K=2 split4 guard", "b644 exact BF16 build B=1 Q=M=4096 D=128 K=8 split4 guard", "b644 exact BF16 build B=1 Q=M=2048 D=128 K in {11,13} guard", "b644 exact BF16 build B=1 Q=M=3072 D=128 K=20 split4 guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_1877_plus_b644_exact5_full90_v1", "rejected_reason": "single seed-bank diagnostic; misses 9a17 and 6a35 D64 rows"}, {"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_6a35_d64_only_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_1877_plus_6a35_d64_full90_v1", "rejected_reason": "single exact D64 diagnostic; misses 9a17 and b644 rows"}, {"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_b644_6a35_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["b644 exact-five build low-floor guards", "6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_1877_plus_b644_exact5_6a35_d64_full90_v1", "rejected_reason": "build-only portfolio; selected only if full90 aggregate wins without 9a17"}, {"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_b644_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact-two residual RAG/search guards", "b644 exact-five build low-floor guards", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_1877_plus_9a17_b644_exact5_full90_v1", "rejected_reason": "legal combination; measured only when requested"}, {"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_6a35_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact-two residual RAG/search guards", "6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_1877_plus_9a17_6a35_d64_full90_v1", "rejected_reason": "legal combination; measured only when requested"}, {"consumed_seeds": {"__tuple__": ["q1024_k8_195e_v1", "ragonline_mbucket_5706_q1v10_smix_s144_g12", "rag_microbucket_k32_q16dual2warp_largem_bdd2_v1_rowld1_2warp_rows4", "rag_microbucket_k32_q24rowld2_24dc_v1_rowld2_rows4", "rag_stream_k32_q128rowld_60fb_v1_rowld_rows4", "4757_fixedbuild_k10_v2_q512_q1024_b2_q1536_q6144", "ad64_fixedbuild_k10_v2_q512_q1024_q1536_q2048_b2q1024", "rag_microbatch_k10_q8_s128_q16_s136_4757_v1", "rag_stream_k32_q128_m100000_ad64_v1_4fbf_v6_s72g8", "d15e_rect_smallq_largem_v1", "d43e_lowk_q512_k2_s4", "c3bf_direct_v20_q4096_k8_s4", "d43e_midk_k11k13_e080", "b3ec_v20_q3072_k20_s4", "d64_q4096_c271_split4_unordered_sortedemit_v1"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_1877_9a17_b644_6a35_full90_selective_v1:benchmark_candidate_9a17_b644_6a35_full90_v1", "expected_shape_wins": {"__tuple__": ["build_qm1024_d128_k8", "rag_online_b1_q1_m100000_d128_k10", "rag_online_b1_q1_m65536_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "rag_online_irregular_b1_q1_m262143_d128_k10", "rag_online_irregular_b1_q1_m524287_d128_k10", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32", "rag_microbatch_largek_b1_q16_m250000_d128_k32", "rag_microbatch_largek_b1_q24_m100000_d128_k32", "rag_stream_largek_b1_q128_m131071_d128_k32", "build_k_sweep_qm512_k10", "build_qm1024_d128_k10", "build_batch_b2_q1024_m1024_d128_k10", "build_tail_b1_q1536_m1536_d128_k10", "build_large_b1_q6144_m6144_d128_k10", "build_qm2048_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "search_rect_b1_q1024_m8192_d128_k10", "build_k_sweep_qm512_k2", "build_qm4096_d128_k8", "build_k_sweep_qm2048_k11", "build_k_sweep_qm2048_k13", "build_tail_b1_q3072_m3072_d128_k20", "build_dim_sweep_b1_q4096_m4096_d64_k10"]}, "fallback": "loom.examples.weave.knn_build_dispatch_ad64_1b8f_4b51_ceb3_full90_synthesis_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["9a17 exact-two residual RAG/search guards", "b644 exact-five build low-floor guards", "6a35 exact BF16 build B=1 Q=M=4096 D=64 K=10 split4 unordered guard", "4b51 exact BF16 build K10 guard for unique Q2048 row", "1b8f exact BF16 build K10 guard for Q512/Q1024/B2-Q1024/Q1536/Q6144 rows", "ceb3 exact BF16 non-build B=1 Q in {8,16} M=100000 D=128 K=10 guard", "b0e2 exact BF16 non-build B=1 Q=128 M=131071 D=128 K=32 rowld rows4 guard", "603d/24dc exact BF16 non-build B=1 Q=24 M=100000 D=128 K=32 rowld2 rows4 guard", "cf51 exact BF16 build Q=M=1024 D=128 K=8 split16", "bca0 exact BF16 non-build Q=1 D=128 K=10 M in {65536,100000,131071,250000,262143,524287}", "5018 exact BF16 non-build Q=16 D=128 K=32 M in {100000,131071,250000}", "c3bf/d5f8 full90 Weave fallback"]}, "id": "candidate_1877_plus_9a17_b644_exact5_6a35_d64_full90_v1", "rejected_reason": "selected only if same-session full90 no-regression passes"}]}'))
...
def _seed_trace_record(inputs: dict[str, Any], *, seed_module, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if force_fallback:
        ...
        row['guard_id'] = f'forced_fallback_{seed_id}_disabled'
        row['guard_condition'] = f'forced fallback to 1877 baseline; {seed_id} disabled'
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, time_flashlib: bool=True, candidate_keys: tuple[str, ...] | None=None) -> dict[str, str]:
    ...
    baseline_path = out_dir / f'{denom_label}_same_session_baseline_1877_v1.json'
    ...
    for candidate_key in selected_candidate_keys:
        ...
        payload_path = out_dir / f'{denom_label}_dispatch_{candidate_key}_v1.json'
        trace_path = out_dir / f'{denom_label}_route_trace_{candidate_key}_v1.json'
        forced_trace_path = out_dir / f'{denom_label}_forced_fallback_trace_{candidate_key}_v1.json'
        seed_matrix_path = out_dir / f'{denom_label}_seed_delta_matrix_{candidate_key}_v1.json'
        ...
        artifacts[f'{candidate_key}_payload'] = str(payload_path)
        artifacts[f'{candidate_key}_route_trace'] = str(trace_path)
        artifacts[f'{candidate_key}_forced_fallback_trace'] = str(forced_trace_path)
        artifacts[f'{candidate_key}_seed_delta_matrix'] = str(seed_matrix_path)
    ...
    summary_path = out_dir / f'{denom_label}_dispatcher_synthesis_1877_9a17_b644_6a35_selective_v1.json'
