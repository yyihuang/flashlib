...
ROUTE_Q32 = f'{MODULE}:q32_m64_s128_g8'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_k10_q4q8q16q32q64_4757_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 91392, "cta_group": 1, "threads": 512}'))
...
def _seed_route_row(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if force_fallback:
        ...
        row['guard_id'] = f'forced_fallback_{Q4Q64_SEED_ID}_disabled'
...
def _q32_route_row(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if force_fallback:
        ...
        row['guard_id'] = f'forced_fallback_{Q32_SEED_ID}_disabled'
