...
knn_build_rag_microbatch_4a72_k10_fused_group_final_merge = _ir_proxy('loom.examples.weave.knn_build_rag_microbatch_4a72_v1:knn_build_rag_microbatch_4a72_k10_fused_group_final_merge', 256)
fused_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_4a72_v1:fused_merge_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_4a72_v1:ir"}'))
