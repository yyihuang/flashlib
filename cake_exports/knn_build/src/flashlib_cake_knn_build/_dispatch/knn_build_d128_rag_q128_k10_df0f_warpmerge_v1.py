...
ROUTE_WARPMERGE = f'{MODULE}:split74_warpmerge'
ROUTE_ENTRYPOINT = f'{MODULE}:launch_from_contract_inputs'
BENCHMARK_ENTRYPOINT = f'{MODULE}:benchmark_knn_build_d128_rag_q128_k10_df0f_warpmerge_v1'
...
knn_build_d128_rag_q128_k10_s74_warp_merge = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d128_rag_q128_k10_df0f_warpmerge_v1:knn_build_d128_rag_q128_k10_s74_warp_merge", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
merge_k10_s74_warp_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d128_rag_q128_k10_df0f_warpmerge_v1:merge_k10_s74_warp_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k10_s74_warp_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d128_rag_q128_k10_df0f_warpmerge_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
...
def _launch_split74_warpmerge(inputs: dict[str, Any]) -> None:
    ...
    _compiled_stage1().launch_cluster(grid=(stage1_grid, 1, 1), block=(parent_lowk.STAGE1_THREADS, 1, 1), args=[inputs['query_sq'], inputs['database_sq'], partial_dists, partial_indices, tmap_query, tmap_database, bsz, n_query, n_database, top_k, num_q_tile_pairs, db_tiles_per_split, SPLIT_COUNT, total_work], cluster_dims=(parent_lowk.CTA_GROUP, 1, 1), shared_mem=parent_lowk.stage1_ir.computed_smem_bytes)
