...
knn_build_d128_rag_q128_k10_s74_warp_merge = _ir_proxy('loom.examples.weave.knn_build_d128_rag_q128_k10_df0f_warpmerge_v1:knn_build_d128_rag_q128_k10_s74_warp_merge', 256)
merge_k10_s74_warp_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d128_rag_q128_k10_df0f_warpmerge_v1:merge_k10_s74_warp_ir"}'))
...
def _verify_export_ir() -> Any:
    ...
    return merge_k10_s74_warp_ir
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_d128_rag_q128_k10_df0f_warpmerge_v1:ir"}'))
