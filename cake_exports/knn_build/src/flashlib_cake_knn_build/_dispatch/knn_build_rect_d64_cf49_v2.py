...
sorted split merge. Guard misses delegate to the current 8700 Weave dispatcher;
no external runtime fallback is introduced.
"""
...
stage1_d64_split_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rect_d64_cf49_v2:stage1_d64_split_ir"}'))
merge_generic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rect_d64_cf49_v2:merge_generic_ir"}'))
knn_build_rect_d64_cf49_s16_cached_merge = _ir_proxy('loom.examples.weave.knn_build_rect_d64_cf49_v2:knn_build_rect_d64_cf49_s16_cached_merge', 256)
merge_s16_cached_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rect_d64_cf49_v2:merge_s16_cached_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rect_d64_cf49_v2:ir"}'))
...
def benchmark_knn_build_rect_d64_cf49_v2(*, use_cupti: bool=True) -> dict[str, Any]:
