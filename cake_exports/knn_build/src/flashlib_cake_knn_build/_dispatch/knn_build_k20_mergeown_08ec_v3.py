...
knn_build_k20_mergeown_08ec_s4_rowbase_lane = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_mergeown_08ec_s4_rowbase_lane", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 32}'))
merge_k20_s4_rowbase_lane_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_mergeown_08ec_s4_rowbase_lane", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 32}'))
knn_build_k20_mergeown_08ec_warp8_select = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_mergeown_08ec_warp8_select", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 256}'))
merge_k20_s2_warp8_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_mergeown_08ec_warp8_select_s2warp8", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20], ["SPLIT_COUNT", 2]], "cta_group": 1, "threads": 256}'))
merge_k20_s4_warp8_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k20_mergeown_08ec_warp8_select_s4warp8", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 256}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_k32_merge_s4_unordered_k20unordered", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["TOP_K_MAX", 20], ["SPLIT_COUNT", 4]], "cta_group": 1, "threads": 32}'))
...
def _merge_k20_warp8_ir_for_split_count(split_count: int) -> Any:
    ...
    if split_count == Q4096_SPLIT_COUNT:
        return merge_k20_s4_warp8_ir
    raise ValueError(f'unsupported warp8 split_count={split_count}')
...
def benchmark_k20_mergeown_08ec_v3(*, use_cupti: bool=False) -> dict[str, Any]:
    ...
    merge_owner = {label: f'split{split_counts[label]}_{('warp8' if merge_mode == 'tailwarp8' and split_counts[label] == TAIL_SPLIT_COUNT else 'warp4' if merge_mode == 'tailwarp8' else merge_mode)}' for label in split_counts}
