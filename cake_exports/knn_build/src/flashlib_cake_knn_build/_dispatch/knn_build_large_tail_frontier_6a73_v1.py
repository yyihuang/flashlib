...
def _large_tail_split_count() -> int:
    ...
    if split_count not in SUPPORTED_SPLITS:
        raise ValueError(f'LOOM_KNN_LARGE_TAIL_6A73_SPLIT_COUNT must be one of {SUPPORTED_SPLITS}')
    return split_count
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_evolve_7bfc_split_cg2_u2_stage1_k20split", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 20]], "cta_group": 1, "threads": 192}'))
