...
knn_build_common_d_generic_direct_v1 = _decode_capture(_json_loads('{"__ir__": "knn_build_common_d_generic_direct_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 20480, "constants": [["K_MAX_", 10], ["THREADS_", 256]], "cta_group": 1, "threads": 256}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_build_common_d_generic_direct_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 20480, "constants": [["K_MAX_", 10], ["THREADS_", 256]], "cta_group": 1, "threads": 256}'))
