...
knn_build_common_d_generic_direct_v1 = _ir_proxy('loom.examples.weave.knn_build_common_d_generic_fallback_v1:knn_build_common_d_generic_direct_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_common_d_generic_fallback_v1:ir"}'))
