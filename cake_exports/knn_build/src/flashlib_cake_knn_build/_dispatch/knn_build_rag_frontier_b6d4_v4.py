...
knn_build_rag_frontier_b6d4_stage1_k32_chunked = _ir_proxy('loom.examples.weave.knn_build_rag_frontier_b6d4_v4:knn_build_rag_frontier_b6d4_stage1_k32_chunked', 256)
stage1_k32_chunked_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_b6d4_v4:stage1_k32_chunked_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_frontier_b6d4_v4:ir"}'))
