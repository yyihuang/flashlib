...
CANDIDATE_DISPATCHERS = _decode_capture(_json_loads('{"__tuple__": [{"consumed_seeds": {"__tuple__": ["d64_fdd7_aa88_v2", "rect_d64_cf49_v3_9138", "q1_mbucket_aa88_q1m_v3_bcb3"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_c142_3505_replay_ed1c_v1:benchmark_baseline_c142", "expected_shape_wins": {"__tuple__": ["build_large_b1_q8192_m8192_d128_k20", "build_large_b1_q8192_m8192_d128_k32", "build_over64_stress_qm2048_k96", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_stream_largek_b1_q128_m100000_d128_k32", "rag_batch_b2_q256_m50000_d128_k10", "rag_irregular_b1_q512_m131071_d128_k10", "search_rect_b1_q1024_m8192_d128_k10", "build_dim_sweep_b1_q2048_m2048_d64_k10", "build_dim_sweep_b1_q2048_m2048_d256_k10", "build_dtype_fp16_b1_q2048_m2048_d128_k10", "search_rect_b1_q2048_m32768_d128_k10", "build_large_tail_b1_q6144_m6144_d128_k20", "build_k_sweep_qm2048_k24", "build_k_sweep_qm2048_k28", "build_k_sweep_qm4096_k28", "build_over32_stress_qm2048_k64", "build_over32_stress_qm4096_k64", "build_k_sweep_qm512_k1", "build_k_sweep_qm512_k2", "build_k_sweep_qm1024_k16", "build_k_sweep_qm512_k4", "build_k_sweep_qm512_k5", "build_k_sweep_qm512_k6", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q32_m100000_d128_k10", "build_dim_sweep_b1_q1024_m1024_d64_k10", "build_dim_sweep_b1_q4096_m4096_d64_k10", "search_rect_b1_q1024_m32768_d64_k10", "rag_online_b1_q1_m100000_d128_k10", "rag_online_irregular_b1_q1_m131071_d128_k10", "rag_online_large_m_b1_q1_m250000_d128_k10", "build_over64_stress_qm1024_k96", "build_over64_stress_qm4096_k96"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["registered c142 guard stack with K96 coverage"]}, "id": "baseline_c142_registered", "rejected_reason": "same-session full77 baseline"}, {"consumed_seeds": {"__tuple__": ["rag_microbucket_3505_v6_41b8_replay"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_c142_3505_replay_ed1c_v1:benchmark_knn_build_dispatch_c142_3505v6_replay_ed1c_v1", "expected_shape_wins": {"__tuple__": ["rag_microbatch_largek_b1_q8_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q32_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["3505_v6 exact BF16 non-build B=1 D=128 K32 Q8/Q16/Q32 guards before c142", "then registered c142 guard stack"]}, "id": "candidate_c142_3505v6_3e0c_replay_ed1c_v1", "rejected_reason": null}, {"consumed_seeds": {"__tuple__": ["rag_microbucket_3505_v7_752a_consumption"]}, "entrypoint": "loom.examples.weave.knn_build_dispatch_c142_3505_replay_ed1c_v1:benchmark_knn_build_dispatch_c142_3505v7_replay_ed1c_v1", "expected_shape_wins": {"__tuple__": ["rag_microbatch_b1_q4_m100000_d128_k10", "rag_microbatch_b1_q8_m100000_d128_k10", "rag_microbatch_b1_q16_m100000_d128_k10", "rag_microbatch_b1_q32_m100000_d128_k10", "rag_microbatch_b1_q64_m100000_d128_k10", "rag_microbatch_largek_b1_q8_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m100000_d128_k32", "rag_microbatch_largek_b1_q32_m100000_d128_k32", "rag_microbatch_largek_b1_q16_m131071_d128_k32"]}, "fallback": "loom.examples.weave.knn_build_dispatch_e3de_9138_bcb3_4247_v1:launch_from_contract_inputs", "guard_plan": {"__tuple__": ["3505_v7 exact BF16 non-build B=1 D=128 K10 Q4/Q8/Q16/Q32/Q64 guards before c142", "3505_v7 exact BF16 non-build B=1 D=128 K32 Q8/Q16/Q32 guards before c142", "then registered c142 guard stack"]}, "id": "candidate_c142_3505v7_752a_consumption_ed1c_v1", "rejected_reason": null}]}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_c142_3505_replay_ed1c_v1:ir"}'))
...
def _route_trace_record(inputs: dict[str, Any], *, seed_mode: SeedMode='v6', force_fallback: bool=False, enable_microbucket: bool=True) -> dict[str, Any]:
    if force_fallback and enable_microbucket and _eligible_for_mode(inputs, seed_mode):
        ...
        row['guard_id'] = f'forced_fallback_ed1c_3505_{seed_mode}_disabled'
        row['guard_condition'] = f'forced fallback to registered c142; ed1c 3505_{seed_mode} overlay disabled'
...
def _benchmark_candidate(*, seed_mode: SeedMode, use_cupti: bool=True, shape_labels=None, baseline_report: dict[str, Any] | None=None, other_candidate_report: dict[str, Any] | None=None) -> dict[str, Any]:
    ...
    return _benchmark_payload(seed_mode=seed_mode, candidate_report=candidate_report, baseline_report=baseline_report, other_candidate_report=other_candidate_report, use_cupti=use_cupti, shape_labels=shape_labels, measured_function=f'benchmark_knn_build_dispatch_c142_3505{seed_mode}_replay_ed1c_v1')
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None) -> dict[str, str]:
    ...
    combined_path = out_dir / f'{denom}_same_session_c142_3505_replay_ed1c_v1.json'
    baseline_path = out_dir / f'{denom}_same_session_baseline_c142_for_ed1c_v1.json'
    v6_path = out_dir / f'{denom}_dispatch_c142_3505v6_replay_ed1c_v1.json'
    v7_path = out_dir / f'{denom}_dispatch_c142_3505v7_replay_ed1c_v1.json'
    v6_trace_path = out_dir / f'{denom}_route_trace_c142_3505v6_replay_ed1c_v1.json'
    v7_trace_path = out_dir / f'{denom}_route_trace_c142_3505v7_replay_ed1c_v1.json'
    v6_forced_path = out_dir / f'{denom}_forced_fallback_trace_c142_3505v6_replay_ed1c_v1.json'
    v7_forced_path = out_dir / f'{denom}_forced_fallback_trace_c142_3505v7_replay_ed1c_v1.json'
    seed_matrix_path = out_dir / f'{denom}_seed_delta_matrix_c142_3505_replay_ed1c_v1.json'
