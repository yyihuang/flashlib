...
ROUTE_Q4_S144 = f'{MODULE}:q4_s144_g12'
ROUTE_Q8_S144 = f'{MODULE}:q8_s144_g12'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_rag_microbatch_k10_q4q8q32_s144_d5ac_v1:ir"}'))
...
def _route_trace_record(inputs: dict[str, Any], *, force_fallback: bool=False) -> dict[str, Any]:
    ...
    if force_fallback or not _eligible_s144(inputs):
        ...
        if force_fallback and _eligible_s144(inputs):
            ...
            row['guard_id'] = f'forced_fallback_{S144_SEED_ID}_disabled'
