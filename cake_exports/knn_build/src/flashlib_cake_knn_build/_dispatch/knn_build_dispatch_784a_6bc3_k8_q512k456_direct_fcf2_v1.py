...
CANDIDATE_ENTRYPOINT = f'{MODULE}:benchmark_candidate_784a_direct_q512_k456_plus_6bc3_k8_full82_v1'
PARENT_FCF2_BENCH_ENTRYPOINT = f'{MODULE}:benchmark_parent_784a_plus_6bc3_k8_selective'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_dispatch_784a_6bc3_k8_q512k456_direct_fcf2_v1:ir"}'))
...
def _candidate_config(candidate_key: str) -> dict[str, Any]:
    try:
        ...
        raise ValueError(f'unknown fcf2 direct-Q512K456 candidate {candidate_key!r}') from exc
...
def _candidate_kernel_fn(candidate_key: str) -> Callable[[dict[str, Any]], None]:
    ...
    raise ValueError(f'unknown fcf2 direct-Q512K456 candidate {candidate_key!r}')
...
def write_benchmark_artifacts(artifact_dir: str | Path, *, use_cupti: bool=True, shape_labels=None, benchmark_correctness: bool=True, time_flashlib: bool=True) -> dict[str, str]:
    ...
    baseline_path = out_dir / f'{denom_label}_same_session_baseline_784a_005f_for_q512k456_direct_v1.json'
    parent_path = out_dir / f'{denom_label}_same_session_parent_fcf2_6bc3_k8_for_q512k456_direct_v1.json'
    payload_path = out_dir / f'{denom_label}_dispatch_784a_direct_q512k456_plus_6bc3_k8_v1.json'
    trace_path = out_dir / f'{denom_label}_route_trace_784a_direct_q512k456_plus_6bc3_k8_v1.json'
    forced_trace_path = out_dir / f'{denom_label}_forced_fallback_trace_784a_direct_q512k456_plus_6bc3_k8_v1.json'
    seed_matrix_path = out_dir / f'{denom_label}_seed_delta_matrix_784a_direct_q512k456_plus_6bc3_k8_v1.json'
    ...
    artifacts[f'{CANDIDATE_Q512K456_DIRECT}_payload'] = str(payload_path)
    artifacts[f'{CANDIDATE_Q512K456_DIRECT}_route_trace'] = str(trace_path)
    artifacts[f'{CANDIDATE_Q512K456_DIRECT}_forced_fallback_trace'] = str(forced_trace_path)
    artifacts[f'{CANDIDATE_Q512K456_DIRECT}_seed_delta_matrix'] = str(seed_matrix_path)
    ...
    summary_path = out_dir / f'{denom_label}_dispatcher_consumption_784a_q512k456_direct_plus_6bc3_k8_v1.json'
