...
stage1_d768_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_common_d_eeff_search_d768_v1:stage1_d768_ir"}'))
...
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_common_d_eeff_search_d768_v1:merge_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_common_d_eeff_search_d768_v1:ir"}'))
