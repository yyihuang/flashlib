...
knn_build_ragonline_mbucket_aa88_q1m_s72_k10_coop_merge = _ir_proxy('loom.examples.weave.knn_build_ragonline_mbucket_aa88_q1m_v3:knn_build_ragonline_mbucket_aa88_q1m_s72_k10_coop_merge', 256)

def _ir_with_constants(ir_obj: Any, *, suffix: str, **updates: int) -> Any:
    constants = tuple(((name, updates.get(name, value)) for name, value in ir_obj.constants))
    return replace(ir_obj, name=f'{ir_obj.name}_{suffix}', constants=constants)
coop_merge_s72_k10_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_ragonline_mbucket_aa88_q1m_v3:coop_merge_s72_k10_ir"}'))
coop_merge_s74_k10_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_ragonline_mbucket_aa88_q1m_v3:coop_merge_s74_k10_ir"}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_build_ragonline_mbucket_aa88_q1m_v3:ir"}'))
