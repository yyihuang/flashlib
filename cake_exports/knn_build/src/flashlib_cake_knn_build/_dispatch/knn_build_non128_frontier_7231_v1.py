...
def _pad_ir(d_pad: int) -> Any:
    ...
    return dc.replace(pad_bf16_rows_ir, symbol=f'{pad_bf16_rows_ir.symbol}_d{int(d_pad)}', constants=constants)
...
def _stage1_ir(feature_chunks: int) -> Any:
    ...
    return dc.replace(stage1_base_ir, symbol=f'{stage1_base_ir.symbol}_d{feature_chunks * K_TILE}', constants=constants)
