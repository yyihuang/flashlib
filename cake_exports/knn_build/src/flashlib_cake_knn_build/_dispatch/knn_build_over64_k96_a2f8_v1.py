...
knn_build_k96_stage1_sort4_chunked = _decode_capture(_json_loads('{"__ir__": "knn_build_k96_stage1_sort4_chunked", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 96]], "cta_group": 1, "threads": 192}'))
stage1_k96_sort4_chunked_over64_ir = _decode_capture(_json_loads('{"__ir__": "knn_build_k96_stage1_sort4_chunked_k96over64sort4chunked", "cluster_dims": [2, 1, 1], "computed_smem_bytes": 50432, "constants": [["BLOCK_Q", 128], ["BLOCK_M", 64], ["FEAT_D", 128], ["TOP_K_MAX", 96]], "cta_group": 1, "threads": 192}'))
