...
kernel_knn_build_common_d_56f3_d256_q1024_k10_merge_rowbase_cache_s16(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
