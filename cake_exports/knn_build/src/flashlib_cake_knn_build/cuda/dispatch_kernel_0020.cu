...
kernel_knn_build_d64_build_aa88_k10_merge_s8_rowbase_cache_s4(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
