...
kernel_knn_build_non128_frontier_3d5a_k10_merge_s8_rowbase_cache(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
