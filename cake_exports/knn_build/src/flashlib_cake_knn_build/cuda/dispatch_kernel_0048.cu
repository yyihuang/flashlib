...
kernel_knn_build_evolve_7bfc_k32_merge_s4_unordered_k12unordered(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
