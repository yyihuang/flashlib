...
kernel_knn_build_ragonline_mbucket_aa88_q1m_s72_k10_coop_merge_s74_m250(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
