...
kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_e080k11s8exact(float* __restrict__ partial_dists, int32_t* __restrict__ partial_indices, float* __restrict__ out_dists, int32_t* __restrict__ out_indices, int total_queries)
{
