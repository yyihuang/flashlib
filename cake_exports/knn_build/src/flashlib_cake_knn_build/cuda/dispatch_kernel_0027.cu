...
kernel_knn_build_non128_frontier_4be7_d768fused_merge_s16g8_4be7_d768fused_v1(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
