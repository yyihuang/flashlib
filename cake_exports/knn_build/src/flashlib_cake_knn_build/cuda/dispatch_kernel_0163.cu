...
kernel_knn_build_rag_frontier_7399_k32_fused_group_final_merge(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
