...
kernel_knn_build_1074_k24_q4096_merge_s4_unordered_warp_select(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
