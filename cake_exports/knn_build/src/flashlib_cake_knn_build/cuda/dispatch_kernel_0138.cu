...
kernel_knn_build_evolve_7bfc_k10_merge_s7(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int B, int Q, int total_queries)
{
