            ...
            for (unsigned int work_idx_2 = cluster_id; work_idx_2 < total_work; work_idx_2 += num_clusters) {
                                ...
                                for (int vec_col_1 = 0; vec_col_1 < 4; vec_col_1++) {
                                    ...
                                    if (db_idx_1 < M) {
                                        ...
                                        if (dist_1 < worst_d) {
                                            ...
                                            int cmp_all_1 = ((best_d[4] > max0123_d_1) ? 1 : 0);
                                            worst_d = ((cmp_all_1 != 0) ? best_d[4] : max0123_d_1);
                                            worst_pos = ((cmp_all_1 != 0) ? 4 : max0123_p_1);
                                        }
                                    }
                                }
                            }
                ...
                if (valid_q != 0) {
                    ...
                    for (int out_k = 0; out_k < TOP_K_SMALL; out_k++) {
                        int cmp01_2 = ((best_d[1] < best_d[0]) ? 1 : 0);
                        float min01_d = ((cmp01_2 != 0) ? best_d[1] : best_d[0]);
                        int min01_i = ((cmp01_2 != 0) ? best_i[1] : best_i[0]);
                        int min01_p = ((cmp01_2 != 0) ? 1 : 0);
                        int cmp23_2 = ((best_d[3] < best_d[2]) ? 1 : 0);
                        float min23_d = ((cmp23_2 != 0) ? best_d[3] : best_d[2]);
                        int min23_i = ((cmp23_2 != 0) ? best_i[3] : best_i[2]);
                        int min23_p = ((cmp23_2 != 0) ? 3 : 2);
                        int cmp0123_2 = ((min23_d < min01_d) ? 1 : 0);
                        float min0123_d = ((cmp0123_2 != 0) ? min23_d : min01_d);
                        int min0123_i = ((cmp0123_2 != 0) ? min23_i : min01_i);
                        int min0123_p = ((cmp0123_2 != 0) ? min23_p : min01_p);
                        int cmp_all_2 = ((best_d[4] < min0123_d) ? 1 : 0);
                        float selected_d = ((cmp_all_2 != 0) ? best_d[4] : min0123_d);
                        int selected_i = ((cmp_all_2 != 0) ? best_i[4] : min0123_i);
                        int selected_pos = ((cmp_all_2 != 0) ? 4 : min0123_p);
                        if (out_k < K) {
