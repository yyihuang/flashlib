...
kernel_knn_build_d128_rag_q128_k10_s74_warp_merge(float* __restrict__ partial_dists, int32_t* __restrict__ partial_indices, float* __restrict__ out_dists, int32_t* __restrict__ out_indices, int total_queries)
{
    ...
    if (row < total_queries) {
        ...
        int pos0 = 0;
        float d0 = (float)partial_dists[base0];
            ...
            if (lane == winner_lane) {
                if (winner_src == 0) {
                    ...
                    if (out_k + 1 < TOP_K_MAX) {
                        ...
                        d0 = (float)partial_dists[next_addr0];
                    ...
                    if (out_k + 1 < TOP_K_MAX) {
                        ...
                        d1 = (float)partial_dists[next_addr1];
                    ...
                    if (out_k + 1 < TOP_K_MAX) {
                        ...
                        d2 = (float)partial_dists[next_addr2];
