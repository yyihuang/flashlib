...
kernel_knn_build_evolve_7bfc_d64_tcgen05_base(float* __restrict__ query_sq, float* __restrict__ database_sq, float* __restrict__ out_dists, int32_t* __restrict__ out_indices, const void* tmap_query, const void* tmap_database, int B, int Q, int M, int K, int num_q_tiles, int num_db_tiles, int total_tiles)
{
