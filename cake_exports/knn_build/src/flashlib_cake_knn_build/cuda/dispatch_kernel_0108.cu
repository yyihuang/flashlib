...
kernel_knn_build_rag_microbucket_k32warpmerge_0077_v1_warp_row_merge_k32s144r4_0077_v1(float* __restrict__ partial_dists, int* __restrict__ partial_indices, float* __restrict__ out_dists, int* __restrict__ out_indices, int total_queries)
{
