...
- Source repository: ``
- Source commit: ``
- Generated at: `2026-07-02T22:46:14.876544+00:00`

## Latest Recorded Results

Validated the complete 58-shape Cake ledger on 2026-07-02 using an NVIDIA
GB200 (`sm_100a`) allocation. All 58 shapes passed semantic correctness, exact
...
| `dispatch_kernel_0069` | `kernel_knn_build_evolve_7bfc_k20_merge_s4_unordered_warp_select` | `standard` | 256 | 0 |
| `dispatch_kernel_0070` | `kernel_knn_build_k64_stage1_tailinf_k64over32tailinfsplitgrid` | `standard` | 256 | 0 |
| `dispatch_kernel_0071` | `kernel_knn_build_k64_merge_s8_unordered_warp_select_k64over32s8warpselect` | `standard` | 256 | 0 |
| `dispatch_kernel_0072` | `kernel_knn_build_k96_stage1_exact_prefill_q1024_k96over64exactprefillq1024_e5db` | `standard` | 256 | 0 |
| `dispatch_kernel_0073` | `kernel_knn_build_k96_merge_s8_unordered_chunkprefill_k96over64s2chunkprefill_f9d1` | `standard` | 256 | 0 |
| `dispatch_kernel_0074` | `kernel_knn_build_k96_merge_s8_unordered_chunkprefill_k96over64s4chunkprefill_f9d1` | `standard` | 256 | 0 |
| `dispatch_kernel_0075` | `kernel_knn_build_rag_stream_k10_q128_1bed_rowld_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0076` | `kernel_knn_build_rag_stream_k10_s72_warp_row_merge_34da` | `standard` | 256 | 0 |
| `dispatch_kernel_0077` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k10s72_4e09` | `standard` | 256 | 0 |
| `dispatch_kernel_0078` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k10s64_3d97` | `standard` | 256 | 0 |
| `dispatch_kernel_0079` | `kernel_knn_build_evolve_7bfc_v1` | `standard` | 256 | 0 |
| `dispatch_kernel_0080` | `kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1_k32_unordered` | `standard` | 256 | 0 |
| `dispatch_kernel_0081` | `kernel_knn_build_evolve_7bfc_k32_merge_s4_unordered` | `standard` | 256 | 0 |
| `dispatch_kernel_0082` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache` | `standard` | 256 | 0 |
| `dispatch_kernel_0083` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k12s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0084` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k20s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0085` | `kernel_knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache_k8s7` | `standard` | 256 | 0 |
| `dispatch_kernel_0086` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k20s16` | `standard` | 256 | 0 |
| `dispatch_kernel_0087` | `kernel_knn_build_evolve_7bfc_split_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0088` | `kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0089` | `kernel_knn_build_evolve_7bfc_split_cg2_stage1_batch8_cond4_vmin_threshold_k5_mintree` | `standard` | 256 | 0 |
| `dispatch_kernel_0090` | `kernel_knn_build_evolve_7bfc_k5_merge_s4_tree_rowbase` | `standard` | 256 | 0 |
| `dispatch_kernel_0091` | `kernel_knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache` | `standard` | 256 | 0 |
| `dispatch_kernel_0092` | `kernel_knn_build_evolve_7bfc_split_cg2_stage1_batch8_cond4_vmin_maxtree` | `standard` | 256 | 0 |
| `dispatch_kernel_0093` | `kernel_knn_build_evolve_7bfc_k10_merge_s4` | `standard` | 256 | 0 |
| `dispatch_kernel_0094` | `kernel_knn_build_evolve_7bfc_k10_merge_s7` | `standard` | 256 | 0 |
| `dispatch_kernel_0095` | `kernel_knn_build_evolve_7bfc_split_cg2_stage1_batch8_cond4_vmin_threshold_k5_mintree` | `standard` | 256 | 0 |
| `dispatch_kernel_0096` | `kernel_knn_build_evolve_7bfc_k5_merge_s4_tree_rowbase` | `standard` | 256 | 0 |
| `dispatch_kernel_0097` | `kernel_knn_build_evolve_7bfc_k10_merge_s4_rowbase_cache` | `standard` | 256 | 0 |
| `dispatch_kernel_0098` | `kernel_knn_build_evolve_7bfc_fp16_d128_base` | `standard` | 256 | 0 |
| `dispatch_kernel_0099` | `kernel_knn_build_evolve_7bfc_d256_twomma_base` | `standard` | 256 | 0 |
| `dispatch_kernel_0100` | `kernel_knn_build_evolve_7bfc_d64_tcgen05_base` | `standard` | 256 | 0 |
| `dispatch_kernel_0101` | `kernel_knn_build_evolve_7bfc_k20_merge_s4_unordered_warp_select_splitmajor` | `standard` | 256 | 0 |
| `dispatch_kernel_0102` | `kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1_k32_unordered_k20unordered` | `standard` | 256 | 0 |
| `dispatch_kernel_0103` | `kernel_knn_build_k20_large_lowfanout_s2_warp_select` | `standard` | 256 | 0 |
| `dispatch_kernel_0104` | `kernel_knn_build_k20_mergeown_08ec_s4_rowbase_lane` | `standard` | 256 | 0 |
| `dispatch_kernel_0105` | `kernel_knn_build_k20_large_rect_s3_warp_select` | `standard` | 256 | 0 |
| `dispatch_kernel_0106` | `kernel_knn_build_rag_microbucket_q32rowld_e5db_v1_stage1_q32_k32_m64` | `standard` | 256 | 0 |
| `dispatch_kernel_0107` | `kernel_knn_build_rag_microbatch_m64_d4f7_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0108` | `kernel_knn_build_evolve_7bfc_split_cg2_stage1_batch8_cond4_vmin_maxtree` | `standard` | 256 | 0 |
| `dispatch_kernel_0109` | `kernel_knn_build_rag_frontier_b6d4_stage1_k32_sort4earlystop` | `standard` | 256 | 0 |
| `dispatch_kernel_0110` | `kernel_knn_build_rag_frontier_7399_k32_fused_group_final_merge` | `standard` | 256 | 0 |
| `dispatch_kernel_0111` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k32s32_4b5c` | `standard` | 256 | 0 |
| `dispatch_kernel_0112` | `kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1_k32_unordered_k96over64` | `standard` | 256 | 0 |
| `dispatch_kernel_0113` | `kernel_knn_build_k96_merge_s8_unordered_chunkprefill_k96over64s8chunkprefill` | `standard` | 256 | 0 |
| `dispatch_kernel_0114` | `kernel_knn_build_rag_frontier_b6d4_stage1_k32_chunked` | `standard` | 256 | 0 |
| `dispatch_kernel_0115` | `kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1_k32_unordered` | `standard` | 256 | 0 |
| `dispatch_kernel_0116` | `kernel_knn_build_evolve_7bfc_k32_merge_s4_unordered` | `standard` | 256 | 0 |
| `dispatch_kernel_0117` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache` | `standard` | 256 | 0 |
| `dispatch_kernel_0118` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k12s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0119` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k20s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0120` | `kernel_knn_build_evolve_7bfc_k10_merge_s7_rowbase_cache_k8s7` | `standard` | 256 | 0 |
| `dispatch_kernel_0121` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k8s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0122` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_k20s16` | `standard` | 256 | 0 |
| `dispatch_kernel_0123` | `kernel_knn_build_rag_frontier_4fbf_v7_stage1_k32_sort4earlystop_tailinf` | `standard` | 256 | 0 |
| `dispatch_kernel_0124` | `kernel_knn_build_rag_frontier_4fbf_stage1_k32_sort4earlystop_tailinf` | `standard` | 256 | 0 |
| `dispatch_kernel_0125` | `kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1_bad5k24s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0126` | `kernel_knn_build_evolve_7bfc_split_cg2_u2_stage1_bad5k28s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0127` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_bad5k24s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0128` | `kernel_knn_build_evolve_7bfc_k30_merge_s8_rowbase_cache_bad5k28s8` | `standard` | 256 | 0 |
| `dispatch_kernel_0129` | `kernel_knn_build_large_square_k32_s2_warp_select` | `standard` | 256 | 0 |
| `dispatch_kernel_0130` | `kernel_knn_build_rag_microbatch_4a72_v2_stage1_k10_cta1_maxtree` | `standard` | 256 | 0 |
| `dispatch_kernel_0131` | `kernel_knn_build_rect_d64_cf49_s16_cached_merge` | `standard` | 256 | 0 |
| `dispatch_kernel_0132` | `kernel_knn_build_ragonline_mbucket_aa88_q1m_s72_k10_coop_merge` | `standard` | 256 | 0 |
| `dispatch_kernel_0133` | `kernel_knn_build_ragonline_mbucket_aa88_q1m_s72_k10_coop_merge_s74_m250` | `standard` | 256 | 0 |
| `dispatch_kernel_0134` | `kernel_knn_build_rag_microbucket_5093_v1_stage1_k32_tailinf_cta1_compactwarp` | `standard` | 256 | 0 |
| `dispatch_kernel_0135` | `kernel_knn_build_rag_microbucket_3505_v3_stage1_k32_tailinf_cta1` | `standard` | 256 | 0 |
| `dispatch_kernel_0136` | `kernel_knn_build_rect_d64_cf49_s16_cached_merge` | `standard` | 256 | 0 |
| `dispatch_kernel_0137` | `kernel_knn_build_k96_stage1_sort4_chunked_k96over64sort4chunked` | `standard` | 256 | 0 |
...
| `dispatch_kernel_0187` | `kernel_knn_build_v12_d64_tail_017a_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0188` | `kernel_knn_build_common_d_5e7f_rag_d64_repair_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0189` | `kernel_knn_build_rag_microbucket_k32_q32rowld2exact_f653_v1_stage1_q32rowld2exact_f653_v1` | `standard` | 256 | 0 |
| `dispatch_kernel_0190` | `kernel_knn_build_k96_merge_s2_unordered_warp_select` | `standard` | 256 | 0 |
| `dispatch_kernel_0191` | `kernel_knn_build_ragonline_mbucket_ea43_q1m524_n128_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0192` | `kernel_knn_build_non128_frontier_7231_stage1_d256` | `standard` | 256 | 0 |
| `dispatch_kernel_0193` | `kernel_knn_build_common_d_1438_rag_d64_m128_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0194` | `kernel_knn_build_non128_frontier_7231_stage1_d768` | `standard` | 256 | 0 |
| `dispatch_kernel_0195` | `kernel_knn_build_rag_microbucket_k32_q32rowld2exact_s141_72d1_v1_stage1_q32rowld2exact_f653_v1` | `standard` | 256 | 0 |
| `dispatch_kernel_0196` | `kernel_knn_build_rag_stream_k32_q128m100000_staticn128_664a_stage1` | `standard` | 256 | 0 |
| `dispatch_kernel_0197` | `kernel_knn_build_q1m524_workfeed_s147_g21_register_merge` | `standard` | 256 | 0 |
