...
knn_search_q1_tile_reduce_partial_v1 = get_kernel('knn_search_q1_tile_reduce_partial_v1')


def launch_knn_search_q1_tile_reduce_partial_v1(
    *args,
    grid: tuple[int, int, int],
    block: tuple[int, int, int] | None = None,
    shared_mem: int | None = None,
    ...
    return knn_search_q1_tile_reduce_partial_v1.launch(
        *args,
        grid=grid,
        block=block,
        shared_mem=shared_mem,
...
knn_search_q1_tile_reduce_merge_v1 = get_kernel('knn_search_q1_tile_reduce_merge_v1')


def launch_knn_search_q1_tile_reduce_merge_v1(
    *args,
    grid: tuple[int, int, int],
    block: tuple[int, int, int] | None = None,
    shared_mem: int | None = None,
    ...
    return knn_search_q1_tile_reduce_merge_v1.launch(
        *args,
        grid=grid,
        block=block,
        shared_mem=shared_mem,
