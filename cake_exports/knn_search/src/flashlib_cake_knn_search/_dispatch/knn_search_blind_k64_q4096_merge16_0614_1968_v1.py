...
SHAPE_DISPATCH_REGISTRY = _decode_capture(_json_loads('{"__tuple__": [{"guard": "B == 1 and Q == 4096 and M == 32768 and D == 128 and K == 64 and tcgen05_capable_arch", "route": "round19_1968_q4096_m32768_k64_twotile_merge16", "shape_key": "B1_Q4096_M32768_D128_K64"}, {"guard": "B == 1 and Q == 64 and M == 131072 and D == 128 and K == 64 and tcgen05_capable_arch", "route": "round19_50cc_q64_m131072_k64_twotile_hiermerge32", "shape_key": "B1_Q64_M131072_D128_K64"}, {"guard": "B == 1 and Q == 512 and M == 65536 and D == 128 and K == 64 and tcgen05_capable_arch", "route": "round19_50cc_q512_m65536_k64_twotile_merge32", "shape_key": "B1_Q512_M65536_D128_K64"}, {"guard": "B == 1 and Q == 4096 and M == 32768 and D == 128 and K == 64 and tcgen05_capable_arch", "route": "round19_50cc_q4096_m32768_k64_twotile_merge32", "shape_key": "B1_Q4096_M32768_D128_K64"}]}'))
knn_search_blind_k64_q4096_m32768_merge16_0614_1968_v1 = _ir_proxy('loom.examples.weave.knn_search_blind_k64_q4096_merge16_0614_1968_v1:knn_search_blind_k64_q4096_m32768_merge16_0614_1968_v1', 256)
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_k64_q4096_merge16_0614_1968_v1:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_k64_q4096_merge16_0614_1968_v1:ir"}'))

def _compile_q4096_merge16_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0316"}}'))
