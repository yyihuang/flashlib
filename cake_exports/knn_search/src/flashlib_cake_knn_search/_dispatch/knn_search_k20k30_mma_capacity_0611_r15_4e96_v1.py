...
K20_MAX = 20
K30_MAX = 30
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k20k30_mma_capacity_0611_r15_4e96_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
...
def _compile_bucket_kernels(k_max: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{base.knn_search_mma_split_partial_v1.name}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{base.knn_search_mma_split_merge_v1.name}')}
