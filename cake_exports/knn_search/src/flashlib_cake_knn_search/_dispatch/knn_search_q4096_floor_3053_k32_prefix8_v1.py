...
knn_search_q4096_m32768_k32_prefix8_merge_3053_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_q4096_m32768_k32_prefix8_merge_3053_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_", 32], ["K_PREFIX_", 8]], "cta_group": 1, "threads": 32}'))
...
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_q4096_m32768_k32_prefix8_merge_3053_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_", 32], ["K_PREFIX_", 8]], "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_q4096_m32768_k32_prefix8_merge_3053_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_", 32], ["K_PREFIX_", 8]], "cta_group": 1, "threads": 32}'))
...
def _compile_k32_prefix8_merge_kernel() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0404"}}'))
