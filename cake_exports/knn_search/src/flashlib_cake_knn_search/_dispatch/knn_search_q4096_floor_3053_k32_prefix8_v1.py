...
TARGET_SHAPES = _decode_capture(_json_loads('[{"label": "ksweep_q4096_m20000_d128_k1", "params": {"B": 1, "D": 128, "K": 1, "M": 20000, "Q": 4096, "dtype": "bfloat16", "min_recall": 1.0, "seed": 610310, "self_search": false}}, {"label": "blind_k32_q4096_m32768_d128_k32", "params": {"B": 1, "D": 128, "K": 32, "M": 32768, "Q": 4096, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610610, "self_search": false}}, {"label": "blind_k64_q4096_m32768_d128_k64", "params": {"B": 1, "D": 128, "K": 64, "M": 32768, "Q": 4096, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610507, "self_search": false}}]'))
K32_PREFIX8_SHAPES = _decode_capture(_json_loads('[{"label": "blind_k32_q4096_m32768_d128_k32", "params": {"B": 1, "D": 128, "K": 32, "M": 32768, "Q": 4096, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610610, "self_search": false}}]'))
_KNN_SEARCH_Q4096_M32768_K32_PREFIX8_KERNELS: dict[str, Any] = {}
knn_search_q4096_m32768_k32_prefix8_merge_3053_v1 = _ir_proxy('loom.examples.weave.knn_search_q4096_floor_3053_k32_prefix8_v1:knn_search_q4096_m32768_k32_prefix8_merge_3053_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_floor_3053_k32_prefix8_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_floor_3053_k32_prefix8_v1:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_floor_3053_k32_prefix8_v1:ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_floor_3053_k32_prefix8_v1:parent_ir"}'))
...
def _compile_k32_prefix8_merge_kernel() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0403"}}'))
