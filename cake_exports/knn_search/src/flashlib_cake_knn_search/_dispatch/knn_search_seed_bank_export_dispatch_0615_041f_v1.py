...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:partial_ir"}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:current_ir"}'))
q128_b08d_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:q128_b08d_ir"}'))
highq_a7f3_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:highq_a7f3_ir"}'))
ann_b72b_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:ann_b72b_ir"}'))
extk_5161_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:extk_5161_ir"}'))
lowd_7d36_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:lowd_7d36_ir"}'))
lowd_a597_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:lowd_a597_ir"}'))
lowd_a597_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:lowd_a597_partial_ir"}'))
lowd_a597_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:lowd_a597_merge_ir"}'))
midq_f48a_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:midq_f48a_ir"}'))
midq_f48a_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:midq_f48a_partial_ir"}'))
midq_f48a_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_041f_v1:midq_f48a_merge_ir"}'))
