...
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_merge16_d212_v1:partial_k1_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_merge16_d212_v1:parent_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_merge16_d212_v1:ir"}'))
_K1_MERGE16_KERNELS: dict[str, Any] = {}
_K1_MERGE16_SCRATCH: dict[tuple[int, int, int, int, int, int, str], tuple[Any, Any]] = {}
knn_search_k1_top1_merge16_d212_v1 = _ir_proxy('loom.examples.weave.knn_search_k1_top1_merge16_d212_v1:knn_search_k1_top1_merge16_d212_v1', 256)
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_merge16_d212_v1:merge_k1_ir"}'))
