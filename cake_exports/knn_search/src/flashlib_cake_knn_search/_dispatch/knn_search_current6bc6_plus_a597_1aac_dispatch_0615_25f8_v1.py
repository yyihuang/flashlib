...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
current_6bc6_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:current_6bc6_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
lowd_a597_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:lowd_a597_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 120576, "cta_group": 1, "threads": 640}'))
lowd_a597_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:lowd_a597_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 120576, "cta_group": 1, "threads": 640}'))
lowd_a597_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:lowd_a597_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
extendedk_r2_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:extendedk_r2_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
