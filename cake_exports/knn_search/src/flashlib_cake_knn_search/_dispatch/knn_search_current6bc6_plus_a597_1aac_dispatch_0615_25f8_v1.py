...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:parent_ir"}'))
current_6bc6_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:current_6bc6_ir"}'))
lowd_a597_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:lowd_a597_ir"}'))
lowd_a597_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:lowd_a597_partial_ir"}'))
lowd_a597_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:lowd_a597_merge_ir"}'))
extendedk_r2_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_current6bc6_plus_a597_1aac_dispatch_0615_25f8_v1:extendedk_r2_ir"}'))
