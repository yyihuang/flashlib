...
knn_search_k64_q128split512_twotile_partial_0614_r26_k64thin_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q128split512_twotile_partial_0614_r26_k64thin_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "constants": [["K_MAX_", 64]], "cta_group": 1, "threads": 512}'))
...
def _compile_q128_split512_twotile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0192"}, "group_merge": {"__kernel__": "dispatch_kernel_0191"}, "partial": {"__kernel__": "dispatch_kernel_0190"}}'))
