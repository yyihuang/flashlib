...
def _compile_q128_split512_twotile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0399"}, "group_merge": {"__kernel__": "dispatch_kernel_0398"}, "partial": {"__kernel__": "dispatch_kernel_0397"}}'))
