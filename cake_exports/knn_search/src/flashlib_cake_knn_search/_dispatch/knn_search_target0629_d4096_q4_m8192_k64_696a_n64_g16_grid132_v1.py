...
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_696a_n64_g16_grid132_v1:partial_ir"}'))
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_696a_n64_g16_grid132_v1:group_merge_ir"}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_696a_n64_g16_grid132_v1:final_merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_696a_n64_g16_grid132_v1:ir"}'))
