...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d128_k10_subfloor_455f_r116_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d128_k10_subfloor_455f_r116_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d128_k10_subfloor_455f_r116_v1:merge_ir"}'))
merge_stream_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d128_k10_subfloor_455f_r116_v1:merge_stream_ir"}'))
merge_q128_const148_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d128_k10_subfloor_455f_r116_v1:merge_q128_const148_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d128_k10_subfloor_455f_r116_v1:parent_ir"}'))
...
def _launch_entry(inputs: dict[str, Any], entry: dict[str, str]) -> dict[str, Any]:
    ...
    if route == ROUTE_SELF_Q3072_M3072_SPLIT6_FULL:
        return _launch_mma_split(inputs, split_m=Q3072_SPLIT_M, partial_key='partial_full', merge_key='merge_stream')
    raise ValueError(f'unsupported round116 route: {route}')
