"""Exact high-D D768/D1024 K10 kNN seed using direct-stride tcgen05 routes.

Minimum target architecture: sm_100a. This additive bucket seed owns
``B=1,M=32768,K=10`` for ``(Q,D) in {(32,768),(16,1024)}`` without a packed
side buffer. The partial producer stages directly from the original feature
stride, uses aligned BF16 vector loads for exact-D 128-wide chunks, runs one
tcgen05 MMA pass per chunk, and feeds the existing Q128 split-M merge consumer.
"""
...
_knn_accumulate_q_norm_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1:_knn_accumulate_q_norm_highd_direct_d', 256)
_knn_stage_q_pass_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1:_knn_stage_q_pass_highd_direct_d', 256)
_knn_stage_database_pass_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1:_knn_stage_database_pass_highd_direct_d', 256)
knn_search_dynamic_d768d1024_q32q16_tcgen05_partial_0618_9286_v1 = _ir_proxy('loom.examples.weave.knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1:knn_search_dynamic_d768d1024_q32q16_tcgen05_partial_0618_9286_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1:ir"}'))
...
def _compile_direct_mma_kernels(original_d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_dynamic_d768d1024_q32q16_tcgen05_partial_0618_9286_v1.name}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{lowd.merge_ir.name}'), 'shared_mem': HIGH_MMA_SMEM_BYTES}
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    raise ValueError('knn_search_dynamic_d768d1024_q32q16_tcgen05_0618_9286_v1 supports only B=1,M=32768,K=10,(Q,D) in {(32,768),(16,1024)}, self_search=false')
