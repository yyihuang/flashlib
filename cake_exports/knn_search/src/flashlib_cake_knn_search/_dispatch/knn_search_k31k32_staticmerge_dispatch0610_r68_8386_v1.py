...
def _compile_bucket_kernels(k_max: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{base.knn_search_mma_split_partial_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{knn_search_k31k32_q128_split148_static_lateidx_merge_r68_v1.symbol}')}
