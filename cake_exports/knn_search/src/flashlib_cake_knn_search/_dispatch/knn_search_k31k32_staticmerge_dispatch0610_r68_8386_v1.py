...
knn_search_k31k32_q128_split148_static_lateidx_merge_r68_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k31k32_q128_split148_static_lateidx_merge_r68_v1", "arg_keys": ["partial_distances", "partial_indices", "out_distances", "out_indices", "B", "Q", "K", "split_m", "num_q_tiles"], "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 32]], "cta_group": 1, "threads": 32}'))
...
def _compile_bucket_kernels(k_max: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, ''.join(['kernel_', format(base.knn_search_mma_split_partial_v1.symbol, '')])), 'merge': CUDAKernel(merge_cubin, ''.join(['kernel_', format(knn_search_k31k32_q128_split148_static_lateidx_merge_r68_v1.symbol, '')]))}
