...
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_partial_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "constants": [["EXPOSE_COL_COHORTS", 0], ["FULL_M_TILES", 1]], "cta_group": 1, "threads": 640}'))
