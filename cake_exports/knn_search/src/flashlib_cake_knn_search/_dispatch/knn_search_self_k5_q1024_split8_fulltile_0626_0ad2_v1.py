...
partial_full_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q1024_split8_fulltile_0626_0ad2_v1:partial_full_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q1024_split8_fulltile_0626_0ad2_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q1024_split8_fulltile_0626_0ad2_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q1024_split8_fulltile_0626_0ad2_v1:merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q1024_split8_fulltile_0626_0ad2_v1:parent_ir"}'))
...
Q1024_SELF_SHAPES = _decode_capture(_json_loads('[{"label": "flashml_self_b1_q1024_m1024_d128_k5", "params": {"B": 1, "D": 128, "K": 5, "M": 1024, "Q": 1024, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610602, "self_search": true}}]'))
