...
K_MAX = c08b.K_MAX
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:merge_ir"}'))
merge_stream_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:merge_stream_ir"}'))
merge_q128_const148_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:merge_q128_const148_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:parent_ir"}'))
c08b_parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:c08b_parent_ir"}'))
...
TARGET_SHAPES = _decode_capture(_json_loads('[{"label": "blind_ext_tail_q127_m131071_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 131071, "Q": 127, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610901, "self_search": false}}, {"label": "blind_ext_q513_m98304_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 98304, "Q": 513, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610905, "self_search": false}}, {"label": "blind_ext_highq_q3072_m49152_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 49152, "Q": 3072, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610906, "self_search": false}}, {"label": "blind_ext_self_q3072_m3072_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 3072, "Q": 3072, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610912, "self_search": true}}]'))
...
CANDIDATE_DISPATCHERS = _decode_capture(_json_loads('{"__tuple__": [{"consumed_seeds": ["weave-evolve-knn-search-c08b"], "entrypoint": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:launch_c08b_only_for_eval", "fallback": "084a current exported dispatcher for every non-target shape", "guard_plan": ["9d5c_c08b_q127_m131071_d128_k10_split148", "9d5c_c08b_q513_m98304_d128_k10_split49", "9d5c_c08b_q3072_m49152_d128_k10_split6", "9d5c_c08b_self_q3072_m3072_d128_k10_split6"], "id": "d128_k10_c08b_only"}, {"consumed_seeds": ["weave-evolve-knn-search-c08b", "weave-evolve-knn-search-f828"], "entrypoint": "loom.examples.weave.knn_search_dispatch0618_d128_k10_c08b_f828_synth_9d5c_v1:launch_for_eval", "fallback": "084a current exported dispatcher for every non-target shape", "guard_plan": ["9d5c_c08b_q127_m131071_d128_k10_split148", "9d5c_f828_q513_m98304_d128_k10_split32", "9d5c_c08b_q3072_m49152_d128_k10_split6", "9d5c_c08b_self_q3072_m3072_d128_k10_split6"], "id": "d128_k10_c08b_plus_f828_q513"}]}'))
...
def _entry_for_inputs(inputs: dict[str, Any], profile: str) -> dict[str, Any] | None:
    if profile not in _VALID_PROFILES:
        raise ValueError(f'unknown D128/K10 synthesis profile: {profile}')
