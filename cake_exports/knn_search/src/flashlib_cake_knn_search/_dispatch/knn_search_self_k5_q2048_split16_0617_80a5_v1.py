...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q2048_split16_0617_80a5_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q2048_split16_0617_80a5_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q2048_split16_0617_80a5_v1:merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_self_k5_q2048_split16_0617_80a5_v1:parent_ir"}'))
SELF_K5_EVAL_LABELS: tuple[str, ...] = (*parent.SELF_K5_EVAL_LABELS, 'blind_post6912_self_q2048_m2048_d128_k5')
SELF_K5_SHAPES = _decode_capture(_json_loads('[{"label": "flashml_self_b1_q256_m256_d128_k5", "params": {"B": 1, "D": 128, "K": 5, "M": 256, "Q": 256, "benchmark": true, "check_correctness": true, "dtype": "bfloat16", "min_recall": 0.99, "seed": 0, "self_search": true}}, {"label": "flashml_self_b1_q512_m512_d128_k5", "params": {"B": 1, "D": 128, "K": 5, "M": 512, "Q": 512, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610601, "self_search": true}}, {"label": "flashml_self_b1_q1024_m1024_d128_k5", "params": {"B": 1, "D": 128, "K": 5, "M": 1024, "Q": 1024, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610602, "self_search": true}}, {"label": "blind_post6912_self_q2048_m2048_d128_k5", "params": {"B": 1, "D": 128, "K": 5, "M": 2048, "Q": 2048, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610711, "self_search": true}}]'))
Q2048_SELF_LABELS: tuple[str, ...] = ('blind_post6912_self_q2048_m2048_d128_k5',)
Q2048_SELF_SHAPES = _decode_capture(_json_loads('[{"label": "blind_post6912_self_q2048_m2048_d128_k5", "params": {"B": 1, "D": 128, "K": 5, "M": 2048, "Q": 2048, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610711, "self_search": true}}]'))
