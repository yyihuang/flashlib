...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:partial_ir"}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:current_ir"}'))
base_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:base_ir"}'))
self_0ccc_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:self_0ccc_ir"}'))
highq_94dc_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:highq_94dc_ir"}'))
highq_2cf5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:highq_2cf5_ir"}'))
d384_5d25_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:d384_5d25_ir"}'))
lowq_fd31_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:lowq_fd31_ir"}'))
lowq_24fd_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_v1:lowq_24fd_ir"}'))
