...
knn_search_d4096_q1_m65536_k10_partial_compactsmem_69ea_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_d4096_q1_m65536_k10_partial_compactsmem_69ea_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 54656, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 512}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d4096_q1_m65536_k10_partial_compactsmem_69ea_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 54656, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 512}'))
...
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d4096_q1_m65536_k10_partial_compactsmem_69ea_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 54656, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 512}'))

def _matches(inputs: dict[str, Any]) -> bool:
    return parent._matches(inputs)

def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0467"}, "partial": {"__kernel__": "dispatch_kernel_0466"}}'))
