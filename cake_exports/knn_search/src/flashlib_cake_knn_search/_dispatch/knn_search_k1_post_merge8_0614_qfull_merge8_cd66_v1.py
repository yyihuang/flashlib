...
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:partial_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:merge_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
_K1_QFULL_MERGE8_KERNELS: dict[str, Any] = {}
_K1_QFULL_MERGE8_SCRATCH: dict[tuple[int, int, int, int, int, int, str], tuple[Any, Any]] = {}
...
def selected_route(inputs: dict[str, Any]) -> str:
    if _use_qfull_merge8_highq_k1(inputs):
        ...
        return f'{ROUTE_QFULL_MERGE8}_split{split_m}'
...
def _compile_qfull_merge8_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_k1": {"__kernel__": "dispatch_kernel_0322"}, "partial_k1": {"__kernel__": "dispatch_kernel_0321"}}'))
