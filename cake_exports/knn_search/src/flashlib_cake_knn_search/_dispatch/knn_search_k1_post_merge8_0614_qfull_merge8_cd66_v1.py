...
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:partial_k1_ir"}'))
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:merge_k1_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:parent_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_post_merge8_0614_qfull_merge8_cd66_v1:ir"}'))
...
SHAPE_SPLIT_M = _decode_capture(_json_loads('{"(2048, 20000)": 9, "(3072, 20000)": 6, "(4096, 16384)": 9, "(4096, 20000)": 9}'))
