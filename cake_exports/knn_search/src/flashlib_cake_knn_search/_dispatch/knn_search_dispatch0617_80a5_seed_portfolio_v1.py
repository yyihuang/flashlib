...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:current_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
base_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:base_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
q128_22d9_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q128_22d9_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
blockm640_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:blockm640_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
blockm640_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:blockm640_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
blockm640_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:blockm640_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "cta_group": 1, "threads": 256}'))
b2_q128_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:b2_q128_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
b2_q128_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:b2_q128_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
blockm896_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:blockm896_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
blockm896_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:blockm896_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
blockm896_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:blockm896_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "cta_group": 1, "threads": 256}'))
q2_blockm640_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q2_blockm640_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
q2_blockm640_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q2_blockm640_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
q2_blockm640_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q2_blockm640_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "cta_group": 1, "threads": 256}'))
cc76_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:cc76_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
cc76_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:cc76_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 384, "cta_group": 1, "threads": 128}'))
q3_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q3_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
q3_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q3_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 384, "cta_group": 1, "threads": 128}'))
scalar_capacity_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:scalar_capacity_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
self_q2048_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:self_q2048_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
self_q2048_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:self_q2048_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
k1_merge8_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:k1_merge8_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
k1_merge8_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:k1_merge8_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 128}'))
q1_m262144_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q1_m262144_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 5120, "cta_group": 1, "threads": 256}'))
q1_m262144_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:q1_m262144_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "cta_group": 1, "threads": 256}'))
b2_k64_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:b2_k64_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
b2_k64_group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:b2_k64_group_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
b2_k64_final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0617_80a5_seed_portfolio_v1:b2_k64_final_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
def _profile_overlays(profile: str) -> tuple[str, ...]:
    try:
        ...
        raise ValueError(f'unknown round-80a5 seed portfolio profile: {profile}') from exc
...
def launch_for_profile(inputs: dict[str, Any], profile: str) -> dict[str, Any]:
    ...
    raise RuntimeError(f'unsupported round-80a5 seed overlay: {overlay}')
