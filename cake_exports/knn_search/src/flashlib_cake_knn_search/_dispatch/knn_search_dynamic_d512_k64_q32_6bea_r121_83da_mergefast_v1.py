...
knn_search_d512_q32_k64_mergefast_partial_83da_r121_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_d512_q32_k64_mergefast_partial_83da_r121_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 88576, "cta_group": 1, "threads": 256}'))
knn_search_d512_q32_k64_mergefast_merge_83da_r121_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_d512_q32_k64_mergefast_merge_83da_r121_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d512_q32_k64_mergefast_partial_83da_r121_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 88576, "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d512_q32_k64_mergefast_merge_83da_r121_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d512_q32_k64_mergefast_partial_83da_r121_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 88576, "cta_group": 1, "threads": 256}'))
