...
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:partial_k1_ir"}'))
pairq_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:pairq_partial_ir"}'))
pairq_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:pairq_merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:parent_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:ir"}'))
_K1_OVERLAP_KERNELS: dict[str, Any] = {}
_K1_OVERLAP_SCRATCH: dict[tuple[int, int, int, int, int, int, str], tuple[Any, Any]] = {}
knn_search_k1_q128_split148_merge_0622_4201_v1 = _ir_proxy('loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:knn_search_k1_q128_split148_merge_0622_4201_v1', 256)
merge_q128_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:merge_q128_k1_ir"}'))
