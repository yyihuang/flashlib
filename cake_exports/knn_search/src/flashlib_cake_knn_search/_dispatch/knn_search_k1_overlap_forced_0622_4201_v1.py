...
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:partial_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
pairq_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:pairq_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 149760, "cta_group": 1, "threads": 640}'))
pairq_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:pairq_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
_K1_OVERLAP_KERNELS: dict[str, Any] = {}
_K1_OVERLAP_SCRATCH: dict[tuple[int, int, int, int, int, int, str], tuple[Any, Any]] = {}
knn_search_k1_q128_split148_merge_0622_4201_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:knn_search_k1_q128_split148_merge_0622_4201_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
merge_q128_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_overlap_forced_0622_4201_v1:merge_q128_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
def _compile_q128_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_q128_k1": {"__kernel__": "dispatch_kernel_0398"}, "partial_k1": {"__kernel__": "dispatch_kernel_0397"}}'))
