...
pairq_partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k1_top1_pairq_partial_0622_598a_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 149760, "constants": [], "cta_group": 1, "threads": 640}'))
pairq_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k1_top1_merge16_d212_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [], "cta_group": 1, "threads": 256}'))
...
knn_search_k1_q128_split148_merge_0622_4201_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k1_q128_split148_merge_0622_4201_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [], "cta_group": 1, "threads": 32}'))
merge_q128_k1_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k1_q128_split148_merge_0622_4201_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [], "cta_group": 1, "threads": 32}'))
...
def _compile_q128_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_q128_k1": {"__kernel__": "dispatch_kernel_0399"}, "partial_k1": {"__kernel__": "dispatch_kernel_0398"}}'))
