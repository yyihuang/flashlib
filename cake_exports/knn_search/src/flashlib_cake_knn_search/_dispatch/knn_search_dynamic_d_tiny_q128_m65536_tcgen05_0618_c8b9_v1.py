...
def _compile_tiny_dynamic_d_kernels(dim: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_dynamic_d_tiny_q128_m65536_tcgen05_partial_0618_c8b9_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{mma.knn_search_mma_split_merge_q128_const148_v1.symbol}')}
