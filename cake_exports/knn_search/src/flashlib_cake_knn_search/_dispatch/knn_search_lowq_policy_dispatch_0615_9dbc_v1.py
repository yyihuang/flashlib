...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_policy_dispatch_0615_9dbc_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_policy_dispatch_0615_9dbc_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_policy_dispatch_0615_9dbc_v1:merge_ir"}'))
tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_policy_dispatch_0615_9dbc_v1:tail_ir"}'))
tail_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_policy_dispatch_0615_9dbc_v1:tail_partial_ir"}'))
tail_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_policy_dispatch_0615_9dbc_v1:tail_merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_policy_dispatch_0615_9dbc_v1:parent_ir"}'))
...
LOWQ_GUARD_MISS_POLICY_SHAPES = _decode_capture(_json_loads('[{"label": "guardmiss_lowq_q2_m131071_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 131071, "Q": 2, "dtype": "bfloat16", "min_recall": 0.999, "seed": 775002, "self_search": false}}, {"label": "guardmiss_lowq_q4_m262145_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 262145, "Q": 4, "dtype": "bfloat16", "min_recall": 0.999, "seed": 775004, "self_search": false}}, {"label": "guardmiss_lowq_q4_m131072_d128_k8", "params": {"B": 1, "D": 128, "K": 8, "M": 131072, "Q": 4, "dtype": "bfloat16", "min_recall": 0.999, "seed": 775014, "self_search": false}}, {"label": "guardmiss_lowq_q4_m131072_d256_k10", "params": {"B": 1, "D": 256, "K": 10, "M": 131072, "Q": 4, "dtype": "bfloat16", "min_recall": 0.999, "seed": 775024, "self_search": false}}, {"label": "guardmiss_lowq_b2_q4_m131072_d128_k10", "params": {"B": 2, "D": 128, "K": 10, "M": 131072, "Q": 4, "dtype": "bfloat16", "min_recall": 0.999, "seed": 775034, "self_search": false}}]'))
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    if route == ROUTE_OUT_OF_CONTRACT:
        ...
        raise ValueError(f'low-Q 9dbc policy excludes shape: {info['selected_guard']}')
    if route == ROUTE_LOWQ_TAIL_ROW16:
