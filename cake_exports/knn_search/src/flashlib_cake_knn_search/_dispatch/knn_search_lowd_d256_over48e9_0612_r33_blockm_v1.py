...
def _compile_d256_scalar_kernels(d: int, k_cap: int, block_m: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{scalar_capacity.knn_search_scalar_capacity_partial_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{scalar_capacity.knn_search_scalar_capacity_merge_v1.symbol}')}
