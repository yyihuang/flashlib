"""Exact D1024/Q8/M65536/K10 tcgen05 kNN with a two-stripe TMEM top-k.
...
top-10 lists enter the existing fixed148 partial ABI.
"""
...
TARGET_ROUTE = 'q8_blockm256_two_stripe_tmem_fixed148_fragmentmap_v2'
...
_knn_accumulate_q_norm_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:_knn_accumulate_q_norm_highd_direct_d', 256)
_knn_stage_q_pass_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:_knn_stage_q_pass_highd_direct_d', 256)
_knn_stage_database_pass_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:_knn_stage_database_pass_highd_direct_d', 256)
_knn_accumulate_db_norm_blockm256 = _ir_proxy('loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:_knn_accumulate_db_norm_blockm256', 256)
_knn_mma_issue_blockm256 = _ir_proxy('loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:_knn_mma_issue_blockm256', 256)
knn_search_q8_blockm256_two_stripe_tmem_8d4fe4ead6cd_v1 = _ir_proxy('loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:knn_search_q8_blockm256_two_stripe_tmem_8d4fe4ead6cd_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:ir"}'))
