...
knn_search_q8_blockm256_two_stripe_tmem_8d4fe4ead6cd_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:knn_search_q8_blockm256_two_stripe_tmem_8d4fe4ead6cd_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 178432, "cta_group": 1, "threads": 640}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 178432, "cta_group": 1, "threads": 640}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q8_blockm256_8d4fe4ead6cd_v2:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 178432, "cta_group": 1, "threads": 640}'))
