...
knn_search_target0630_d4096_q4_m32768_k10_merge_independent_warp_q4tail237_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_target0630_d4096_q4_m32768_k10_merge_independent_warp_q4tail237_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 32}'))
...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0517"}, "partial": {"__kernel__": "dispatch_kernel_0516"}}'))
