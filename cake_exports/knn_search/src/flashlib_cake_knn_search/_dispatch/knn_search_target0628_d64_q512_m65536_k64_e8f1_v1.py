...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0533"}, "group_merge": {"__kernel__": "dispatch_kernel_0532"}, "partial": {"__kernel__": "dispatch_kernel_0531"}}'))
