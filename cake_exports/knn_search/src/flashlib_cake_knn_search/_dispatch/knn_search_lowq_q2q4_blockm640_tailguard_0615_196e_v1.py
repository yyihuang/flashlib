...
knn_search_lowq_tile_reduce_partial_0615_196e_blockm640_tailguard_v1 = _ir_proxy('loom.examples.weave.knn_search_lowq_q2q4_blockm640_tailguard_0615_196e_v1:knn_search_lowq_tile_reduce_partial_0615_196e_blockm640_tailguard_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_q2q4_blockm640_tailguard_0615_196e_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_q2q4_blockm640_tailguard_0615_196e_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_q2q4_blockm640_tailguard_0615_196e_v1:merge_ir"}'))
