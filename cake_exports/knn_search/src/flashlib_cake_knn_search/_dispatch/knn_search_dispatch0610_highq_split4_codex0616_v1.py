...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_highq_split4_codex0616_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_highq_split4_codex0616_v1:partial_ir"}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_highq_split4_codex0616_v1:current_ir"}'))
split4_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_highq_split4_codex0616_v1:split4_ir"}'))
