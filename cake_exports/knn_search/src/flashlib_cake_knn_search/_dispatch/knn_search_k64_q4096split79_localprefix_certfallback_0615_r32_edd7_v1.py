...
knn_search_k64_q4096split79_localprefix_certmerge_0615_r32_edd7_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix_certmerge_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 64], ["K_PREFIX_READ_", 8], ["K_STRIDE_", 9]], "cta_group": 1, "threads": 32}'))
knn_search_k64_q4096split79_localprefix_certflag_init_0615_r32_edd7_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix_certflag_init_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [], "cta_group": 1, "threads": 32}'))
knn_search_k64_q4096split79_localprefix_cert_0615_r32_edd7_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix_cert_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 64], ["K_PREFIX_READ_", 8], ["K_STRIDE_", 9]], "cta_group": 1, "threads": 32}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix9_partial_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "constants": [["K_MAX_", 64], ["K_PREFIX_", 9]], "cta_group": 1, "threads": 512}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix_certmerge_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 64], ["K_PREFIX_READ_", 8], ["K_STRIDE_", 9]], "cta_group": 1, "threads": 32}'))
certflag_init_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix_certflag_init_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [], "cta_group": 1, "threads": 32}'))
cert_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix_cert_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 64], ["K_PREFIX_READ_", 8], ["K_STRIDE_", 9]], "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split79_localprefix9_partial_0615_r32_edd7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "constants": [["K_MAX_", 64], ["K_PREFIX_", 9]], "cta_group": 1, "threads": 512}'))
...
def _launch_q4096_k64_prefixcert(inputs: dict[str, Any]) -> dict[str, Any]:
    if not _KNN_SEARCH_K64_Q4096_PREFIXCERT_KERNELS:
        _KNN_SEARCH_K64_Q4096_PREFIXCERT_KERNELS.update(_compile_k64_q4096_prefixcert_kernels())
    bsz = int(inputs['B'])
    q_rows = int(inputs['Q'])
    m_rows = int(inputs['M'])
    k = int(inputs['K'])
    ...
    partial_dist, partial_idx = _scratch_prefixcert(inputs, partial_list_count, num_q_tiles)
    overflow_flag = _cert_flag(inputs)
    _KNN_SEARCH_K64_Q4096_PREFIXCERT_KERNELS['certflag_init'].launch(grid=(1, 1, 1), block=(MERGE_THREADS, 1, 1), args=[overflow_flag], shared_mem=MERGE_SMEM_BYTES)
    _KNN_SEARCH_K64_Q4096_PREFIXCERT_KERNELS['partial'].launch(grid=(bsz * num_q_tiles * split_m, 1, 1), block=(THREADS, 1, 1), args=[inputs['queries'], inputs['database'], partial_dist, partial_idx, bsz, q_rows, m_rows, split_m, num_q_tiles, total_m_tiles, tiles_per_split], shared_mem=MMA_SMEM_BYTES)
    _KNN_SEARCH_K64_Q4096_PREFIXCERT_KERNELS['merge'].launch(grid=(bsz * q_rows, 1, 1), block=(MERGE_THREADS, 1, 1), args=[partial_dist, partial_idx, inputs['out_distances'], inputs['out_indices'], bsz, q_rows, k, partial_list_count, num_q_tiles], shared_mem=MERGE_SMEM_BYTES)
    _KNN_SEARCH_K64_Q4096_PREFIXCERT_KERNELS['cert'].launch(grid=(bsz * q_rows, 1, 1), block=(MERGE_THREADS, 1, 1), args=[partial_dist, partial_idx, inputs['out_distances'], inputs['out_indices'], overflow_flag, bsz, q_rows, k, partial_list_count, num_q_tiles], shared_mem=MERGE_SMEM_BYTES)
    ...
    _KNN_SEARCH_K64_Q4096_PREFIXCERT_STATS['last_overflow'] = overflow
    if overflow:
    ...
    _KNN_SEARCH_K64_Q4096_PREFIXCERT_STATS['certified_count'] = int(_KNN_SEARCH_K64_Q4096_PREFIXCERT_STATS['certified_count'] or 0) + 1
