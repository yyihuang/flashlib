...
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k64_q128split512_hiermerge32_indexfast_0614_r24_k64thin_v1:partial_ir"}'))
_KNN_SEARCH_K64_Q128_INDEXFAST_KERNELS: dict[str, Any] = {}
knn_search_k64_q128split512_groupmerge64_indexfast_0614_r24_k64thin_v1 = _ir_proxy('loom.examples.weave.knn_search_k64_q128split512_hiermerge32_indexfast_0614_r24_k64thin_v1:knn_search_k64_q128split512_groupmerge64_indexfast_0614_r24_k64thin_v1', 256)
knn_search_k64_q128split512_finalmerge32_indexfast_0614_r24_k64thin_v1 = _ir_proxy('loom.examples.weave.knn_search_k64_q128split512_hiermerge32_indexfast_0614_r24_k64thin_v1:knn_search_k64_q128split512_finalmerge32_indexfast_0614_r24_k64thin_v1', 256)
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k64_q128split512_hiermerge32_indexfast_0614_r24_k64thin_v1:group_merge_ir"}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k64_q128split512_hiermerge32_indexfast_0614_r24_k64thin_v1:final_merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k64_q128split512_hiermerge32_indexfast_0614_r24_k64thin_v1:ir"}'))
...
def _compile_q128_split512_indexfast_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0246"}, "group_merge": {"__kernel__": "dispatch_kernel_0245"}, "partial": {"__kernel__": "dispatch_kernel_0244"}}'))
