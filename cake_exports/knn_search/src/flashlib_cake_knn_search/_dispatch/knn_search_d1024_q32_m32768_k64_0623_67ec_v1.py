...
knn_search_d1024_q32_k64_targetd_partial_67ec_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q32_m32768_k64_0623_67ec_v1:knn_search_d1024_q32_k64_targetd_partial_67ec_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 92672, "cta_group": 1, "threads": 256}'))
knn_search_d1024_q32_k64_targetd_merge_67ec_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q32_m32768_k64_0623_67ec_v1:knn_search_d1024_q32_k64_targetd_merge_67ec_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q32_m32768_k64_0623_67ec_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 92672, "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q32_m32768_k64_0623_67ec_v1:merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q32_m32768_k64_0623_67ec_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 92672, "cta_group": 1, "threads": 256}'))
...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0449"}, "partial": {"__kernel__": "dispatch_kernel_0448"}}'))
