...
knn_search_d1024_q32_k64_targetd_partial_67ec_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_targetd_partial_67ec_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 92672, "cta_group": 1, "threads": 256}'))
knn_search_d1024_q32_k64_targetd_merge_67ec_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_targetd_merge_67ec_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_targetd_merge_67ec_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_targetd_partial_67ec_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 92672, "cta_group": 1, "threads": 256}'))
