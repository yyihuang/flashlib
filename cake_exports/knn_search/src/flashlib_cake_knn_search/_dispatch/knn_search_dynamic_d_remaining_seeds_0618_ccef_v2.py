...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 151296, "cta_group": 1, "threads": 256}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 151296, "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
pack_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:pack_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 126720, "cta_group": 1, "threads": 640}'))
parent_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:parent_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 126720, "cta_group": 1, "threads": 640}'))
parent_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:parent_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
parent_pack_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:parent_pack_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
d3_tile_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:d3_tile_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "cta_group": 1, "threads": 256}'))
scalar_capacity_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_remaining_seeds_0618_ccef_v2:scalar_capacity_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
