...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0145"}, "partial": {"__kernel__": "dispatch_kernel_0125"}}'))
