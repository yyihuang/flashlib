"""Exact D4096/Q4/M32768/K10 split-128 tcgen05 kNN seed.

Minimum target architecture: sm_100a.  The producer uses the direct-stride
tcgen05 path and partitions all 256 M128 tiles across 128 split CTAs.  Each
CTA retains its local top-10 before this module's exact four-head-per-lane
merge consumes all 128 producer lists.
"""
...
SPLIT_M = 128
MERGE_SLOTS = 4
ROUTE = 'r221_target0627_d4096_q4_m32768_k10_split128_tcgen05'
ENTRYPOINT = 'loom.examples.weave.knn_search_target0627_d4096_q4_m32768_k10_split128_r221_1900_v1:launch_for_eval'
...
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d4096_q4q8_m8192m16384_k10_partial_0623_5ff7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 159488, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 512}'))
knn_search_target0627_d4096_q4_m32768_k10_merge128_r221_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_target0627_d4096_q4_m32768_k10_merge128_r221_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 32}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_target0627_d4096_q4_m32768_k10_merge128_r221_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d4096_q4q8_m8192m16384_k10_partial_0623_5ff7_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 159488, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 512}'))
...
def route_info(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    return {'route': ROUTE, 'selected_route': ROUTE, 'selected_entrypoint': ENTRYPOINT, 'route_kind': 'specialized', 'route_source': 'shape-specific-seed', 'coverage_class': 'bucket_seed_target0627_d4096_q4_m32768_k10', 'production_policy': 'weave_only', 'external_fallback': None, 'guard_id': 'target0627_d4096_q4_m32768_k10_split128', 'guard_condition': 'B==1,Q==4,M==32768,D==4096,K==10,nonself,sm100a_or_sm103a', 'selected_seed': 'weave-evolve-knn-search-r221', 'padding_tag': 'none', 'uses_materialized_padding': False, 'uses_kernel_padding': False, 'padding_overhead_timed': False, 'padded_D': D_ORIG, 'workspace_reuse': True}

def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0511"}, "partial": {"__kernel__": "dispatch_kernel_0510"}}'))
