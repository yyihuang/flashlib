...
def _compile_kernels(original_d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{partial_ir.symbol}'), 'group_merge': CUDAKernel(merge_cubin, f'kernel_{group_merge_ir.symbol}'), 'final_merge': CUDAKernel(final_cubin, f'kernel_{final_merge_ir.symbol}')}
