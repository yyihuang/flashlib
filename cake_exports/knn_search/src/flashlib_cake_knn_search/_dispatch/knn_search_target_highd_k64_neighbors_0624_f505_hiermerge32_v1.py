...
SHAPE_DISPATCH_REGISTRY = _decode_capture(_json_loads('{"__tuple__": [{"arch_requirement": "sm_100a", "coverage_class": "bucket_seed_target_d768_q16_m32768_k64", "entrypoint": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:launch_for_eval", "guard": "B == 1 and Q == 16 and M == 32768 and D == 768 and K == 64 and not self_search and not forced_fallback and arch in {sm_100a,sm_103a}", "label": "target_d768_q16_m32768_k64", "labels": {"__tuple__": ["target_d768_q16_m32768_k64"]}, "parent_seed": "weave-evolve-knn-search-26d2-highd-k64-neighbors", "producer_seed": "weave-evolve-knn-search-f505-highd-k64-hiermerge32", "route": "f505_target_highd_k64_compact_hiermerge32_tcgen05", "selected_seed": "weave-evolve-knn-search-f505-highd-k64-hiermerge32", "shape": {"__tuple__": [1, 16, 32768, 768, 64, false]}, "shape_key": "f505_hiermerge32_target_d768_q16_m32768_k64", "source_entrypoint": "26d2 high-D K64 tcgen05 producer with 32-group merge in this module", "source_round_doc": "design_doc/active/weave_evolve_knn_search_round_149_f505_highdk64_hiermerge32.md"}, {"arch_requirement": "sm_100a", "coverage_class": "bucket_seed_target_d1024_q8_m16384_k64", "entrypoint": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:launch_for_eval", "guard": "B == 1 and Q == 8 and M == 16384 and D == 1024 and K == 64 and not self_search and not forced_fallback and arch in {sm_100a,sm_103a}", "label": "target_d1024_q8_m16384_k64", "labels": {"__tuple__": ["target_d1024_q8_m16384_k64"]}, "parent_seed": "weave-evolve-knn-search-26d2-highd-k64-neighbors", "producer_seed": "weave-evolve-knn-search-f505-highd-k64-hiermerge32", "route": "f505_target_highd_k64_compact_hiermerge32_tcgen05", "selected_seed": "weave-evolve-knn-search-f505-highd-k64-hiermerge32", "shape": {"__tuple__": [1, 8, 16384, 1024, 64, false]}, "shape_key": "f505_hiermerge32_target_d1024_q8_m16384_k64", "source_entrypoint": "26d2 high-D K64 tcgen05 producer with 32-group merge in this module", "source_round_doc": "design_doc/active/weave_evolve_knn_search_round_149_f505_highdk64_hiermerge32.md"}, {"arch_requirement": "sm_100a", "coverage_class": "bucket_seed_target_d2048_q4_m8192_k64", "entrypoint": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:launch_for_eval", "guard": "B == 1 and Q == 4 and M == 8192 and D == 2048 and K == 64 and not self_search and not forced_fallback and arch in {sm_100a,sm_103a}", "label": "target_d2048_q4_m8192_k64", "labels": {"__tuple__": ["target_d2048_q4_m8192_k64"]}, "parent_seed": "weave-evolve-knn-search-26d2-highd-k64-neighbors", "producer_seed": "weave-evolve-knn-search-f505-highd-k64-hiermerge32", "route": "f505_target_highd_k64_compact_hiermerge32_tcgen05", "selected_seed": "weave-evolve-knn-search-f505-highd-k64-hiermerge32", "shape": {"__tuple__": [1, 4, 8192, 2048, 64, false]}, "shape_key": "f505_hiermerge32_target_d2048_q4_m8192_k64", "source_entrypoint": "26d2 high-D K64 tcgen05 producer with 32-group merge in this module", "source_round_doc": "design_doc/active/weave_evolve_knn_search_round_149_f505_highdk64_hiermerge32.md"}]}'))
...
knn_search_target_highd_k64_group_merge_f505_hiermerge32_v1 = _ir_proxy('loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:knn_search_target_highd_k64_group_merge_f505_hiermerge32_v1', 256)
knn_search_target_highd_k64_final_merge_f505_hiermerge32_v1 = _ir_proxy('loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:knn_search_target_highd_k64_final_merge_f505_hiermerge32_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:partial_ir"}'))
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:group_merge_ir"}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:final_merge_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0624_f505_hiermerge32_v1:ir"}'))
...
def _compile_kernels(original_d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{partial_ir.name}'), 'group_merge': CUDAKernel(merge_cubin, f'kernel_{group_merge_ir.name}'), 'final_merge': CUDAKernel(final_cubin, f'kernel_{final_merge_ir.name}')}
