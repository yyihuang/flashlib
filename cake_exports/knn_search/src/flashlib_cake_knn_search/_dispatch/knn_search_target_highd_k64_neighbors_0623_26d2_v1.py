...
knn_search_target_highd_k64_partial_26d2_v1 = _ir_proxy('loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:knn_search_target_highd_k64_partial_26d2_v1', 256)
knn_search_target_highd_k64_merge_26d2_v1 = _ir_proxy('loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:knn_search_target_highd_k64_merge_26d2_v1', 256)
knn_search_target_highd_k64_group_merge_26d2_v1 = _ir_proxy('loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:knn_search_target_highd_k64_group_merge_26d2_v1', 256)
knn_search_target_highd_k64_final_merge_26d2_v1 = _ir_proxy('loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:knn_search_target_highd_k64_final_merge_26d2_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:partial_ir"}'))
flat_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:flat_merge_ir"}'))
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:group_merge_ir"}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:final_merge_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target_highd_k64_neighbors_0623_26d2_v1:ir"}'))
