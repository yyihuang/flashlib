...
knn_search_target_highd_k64_partial_26d2_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_partial_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 133632, "cta_group": 1, "threads": 256}'))
knn_search_target_highd_k64_merge_26d2_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_merge_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_target_highd_k64_group_merge_26d2_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_group_merge_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_target_highd_k64_final_merge_26d2_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_final_merge_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
flat_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_merge_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_group_merge_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_final_merge_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_group_merge_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_target_highd_k64_partial_26d2_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 133632, "cta_group": 1, "threads": 256}'))
