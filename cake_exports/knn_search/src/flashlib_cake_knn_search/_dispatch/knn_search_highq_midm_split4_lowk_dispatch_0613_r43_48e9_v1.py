...
K_MAX = parent.K_MAX
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:partial_ir"}'))
q4096_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:q4096_ir"}'))
q4096_lowk_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:q4096_lowk_merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:parent_ir"}'))
d256_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:d256_partial_ir"}'))
d256_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:d256_merge_ir"}'))
k64_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:k64_partial_ir"}'))
k64_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_midm_split4_lowk_dispatch_0613_r43_48e9_v1:k64_merge_ir"}'))
