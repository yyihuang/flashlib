...
q4096_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_partial_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "constants": [["K_MAX_", 10], ["EXPOSE_COL_COHORTS", 0], ["FULL_M_TILES", 0]], "cta_group": 1, "threads": 640}'))
q4096_lowk_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_merge_q4096_lowk_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_MAX_", 2]], "cta_group": 1, "threads": 32}'))
