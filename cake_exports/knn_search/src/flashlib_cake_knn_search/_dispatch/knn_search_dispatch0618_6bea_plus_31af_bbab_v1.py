...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:merge_ir"}'))
merge_stream_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:merge_stream_ir"}'))
merge_q128_const148_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:merge_q128_const148_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:parent_ir"}'))
c08b_parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:c08b_parent_ir"}'))
...
CANDIDATE_DISPATCHERS = _decode_capture(_json_loads('{"__tuple__": [{"consumed_seeds": ["weave-evolve-knn-search-bbab"], "entrypoint": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:launch_bbab_only_for_eval", "expected_shape_wins": ["blind_ext_dyn_d512_k64_q32_m32768"], "fallback": "5132 Weave-only full133 dispatcher", "guard_plan": ["bbab_distonlymerge_d512_q32_k64"], "id": "bbab_5132_plus_distonlymerge_d512_only", "rejected_reason": null}, {"consumed_seeds": ["weave-evolve-knn-search-bbab", "weave-evolve-knn-search-36bd"], "entrypoint": "loom.examples.weave.knn_search_dispatch0618_6bea_plus_31af_bbab_v1:launch_for_eval", "expected_shape_wins": ["blind_ext_dyn_d512_k64_q32_m32768", "blind_k64_q4096_m32768_d128_k64"], "fallback": "5132 Weave-only full133 dispatcher", "guard_plan": ["bbab_distonlymerge_d512_q32_k64", "round122_5132_q4096_m32768_d128_k64_prefix8"], "id": "bbab_5132_plus_distonlymerge_d512_k64_prefix8", "rejected_reason": null}]}'))
...
def _candidate_entries(profile: str) -> tuple[dict[str, Any], ...]:
    ...
    if profile == PROFILE_ALL:
        return _ALL_ENTRIES
    raise ValueError(f'unknown bbab dispatcher profile: {profile}')
