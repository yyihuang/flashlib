...
knn_search_mma_split_partial_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_partial_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
knn_search_mma_split_merge_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_mma_split_merge_stream_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_stream_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_mma_split_merge_q128_const148_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_q128_const148_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_mma_split_merge_q4096_pairlocal_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_q4096_pairlocal_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_mma_split_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0210"}, "merge_q128_const148": {"__kernel__": "dispatch_kernel_0212"}, "merge_q4096_pairlocal": {"__kernel__": "dispatch_kernel_0213"}, "merge_stream": {"__kernel__": "dispatch_kernel_0211"}, "partial": {"__kernel__": "dispatch_kernel_0206"}, "partial_col4": {"__kernel__": "dispatch_kernel_0207"}, "partial_col4_full": {"__kernel__": "dispatch_kernel_0209"}, "partial_full": {"__kernel__": "dispatch_kernel_0208"}}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    if int(inputs['K']) > K_MAX:
        raise ValueError(f'knn_search_mma_split_v1 supports K <= {K_MAX}, got {inputs['K']}')
...
def _select_contract_shapes(shape_labels: str | tuple[str, ...] | list[str] | None):
    ...
    if missing:
        raise ValueError(f'unknown knn_search shape label(s): {missing}')
