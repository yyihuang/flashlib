...
knn_search_mma_split_partial_v1 = _ir_proxy('loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_partial_v1', 256)
knn_search_mma_split_merge_v1 = _ir_proxy('loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_v1', 256)
knn_search_mma_split_merge_stream_v1 = _ir_proxy('loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_stream_v1', 256)
knn_search_mma_split_merge_q128_const148_v1 = _ir_proxy('loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_q128_const148_v1', 256)
knn_search_mma_split_merge_q4096_pairlocal_v1 = _ir_proxy('loom.examples.weave.knn_search_mma_split_v1:knn_search_mma_split_merge_q4096_pairlocal_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_mma_split_v1:ir"}'))
