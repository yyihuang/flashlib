...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_merge_0613_r41_48e9_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_merge_0613_r41_48e9_v1:partial_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_merge_0613_r41_48e9_v1:parent_ir"}'))
_LOWK_MERGE_KERNELS: dict[str, Any] = {}
knn_search_mma_split_merge_q4096_lowk_v1 = _ir_proxy('loom.examples.weave.knn_search_q4096_lowk_merge_0613_r41_48e9_v1:knn_search_mma_split_merge_q4096_lowk_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_merge_0613_r41_48e9_v1:ir"}'))
merge_lowk_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_merge_0613_r41_48e9_v1:merge_lowk_ir"}'))
...
def _compile_lowk_merge_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_lowk1": {"__kernel__": "dispatch_kernel_0291"}, "merge_lowk2": {"__kernel__": "dispatch_kernel_0292"}}'))
