...
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_merge_q4096_lowk_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_MAX_", 2]], "cta_group": 1, "threads": 32}'))
...
knn_search_mma_split_merge_q4096_lowk_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_merge_q4096_lowk_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_MAX_", 2]], "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_merge_q4096_lowk_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_MAX_", 2]], "cta_group": 1, "threads": 32}'))
merge_lowk_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_merge_q4096_lowk_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_OUT_MAX_", 2]], "cta_group": 1, "threads": 32}'))
