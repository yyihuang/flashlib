...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
q128_kexact_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:q128_kexact_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
q128_kexact_group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:q128_kexact_group_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
q128_kexact_final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:q128_kexact_final_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
q4096_prefixcert_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:q4096_prefixcert_partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
q4096_prefixcert_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:q4096_prefixcert_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
q4096_prefixcert_certflag_init_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:q4096_prefixcert_certflag_init_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
q4096_prefixcert_cert_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_ffb4_q4096k64_prefixcert_direct_dispatch_0615_922c_v1:q4096_prefixcert_cert_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
def _profile_overlays(profile: str) -> tuple[str, ...]:
    if profile not in CANDIDATE_PROFILES:
        raise ValueError(f'unknown 922c direct dispatcher profile: {profile}')
