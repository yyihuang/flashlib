...
def _compile_kernels(d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{partial_ir_for_d.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v2.symbol}')}
