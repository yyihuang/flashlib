...
knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v2 = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [["D_", 64], ["BLOCK_M_", 1280], ["SUBWARP_WIDTH_", 2], ["SUBWARPS_PER_WARP_", 16], ["NUM_ROW_WORKERS_", 128], ["ROWS_PER_WORKER_", 10], ["VECS_PER_LANE_", 4], ["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
knn_search_lowd_d96_tile_reduce_partial_0615_7d36_v2 = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_d96_tile_reduce_partial_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [], "cta_group": 1, "threads": 256}'))
knn_search_lowd_d192_tile_reduce_partial_0615_7d36_v2 = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_d192_tile_reduce_partial_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [], "cta_group": 1, "threads": 256}'))
knn_search_lowd_d320_tile_reduce_partial_0615_7d36_v2 = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_d320_tile_reduce_partial_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [], "cta_group": 1, "threads": 256}'))
knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v2 = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [["D_", 64], ["BLOCK_M_", 1280], ["SUBWARP_WIDTH_", 2], ["SUBWARPS_PER_WARP_", 16], ["NUM_ROW_WORKERS_", 128], ["ROWS_PER_WORKER_", 10], ["VECS_PER_LANE_", 4], ["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [["D_", 64], ["BLOCK_M_", 1280], ["SUBWARP_WIDTH_", 2], ["SUBWARPS_PER_WARP_", 16], ["NUM_ROW_WORKERS_", 128], ["ROWS_PER_WORKER_", 10], ["VECS_PER_LANE_", 4], ["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
...
def _config_for_d(d: int) -> dict[str, int]:
    if d == 64:
        ...
        raise ValueError(f'knn_search_lowd_non128_tile_reduce_0615_7d36_v2 unsupported D={d}')
...
def _compile_kernels(d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{partial_ir_for_d.name}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v2.name}')}
...
SHAPE_DISPATCH_REGISTRY = [{'shape_key': label, 'guard': f'B == 1 and Q == 128 and M == 65536 and D == {d} and K <= 10', 'candidate_entrypoint': 'loom.examples.weave.knn_search_lowd_non128_tile_reduce_0615_7d36_v2:launch_for_eval'} for label, d in (('blind_d64_q128_m65536_k10', 64), ('blind_d96_q128_m65536_k10', 96), ('blind_d192_q128_m65536_k10', 192), ('blind_d320_q128_m65536_k10', 320))]
