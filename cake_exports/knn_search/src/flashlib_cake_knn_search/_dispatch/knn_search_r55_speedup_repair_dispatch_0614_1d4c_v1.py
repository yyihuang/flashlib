...
K_MAX = r55.K_MAX
SPLIT_M = r55.SPLIT_M
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
q128_k64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:q128_k64_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:tail_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
