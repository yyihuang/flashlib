...
K_MAX = r55.K_MAX
SPLIT_M = r55.SPLIT_M
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:parent_ir"}'))
k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:k1_ir"}'))
q128_k64_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:q128_k64_ir"}'))
tail_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_r55_speedup_repair_dispatch_0614_1d4c_v1:tail_ir"}'))
