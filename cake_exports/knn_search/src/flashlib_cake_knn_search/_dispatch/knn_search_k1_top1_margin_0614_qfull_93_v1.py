...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:ir"}'))
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:partial_k1_ir"}'))
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:merge_k1_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:parent_ir"}'))
...
knn_search_k1_top1_margin_qfull_partial_0614_r93_v1 = _ir_proxy('loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:knn_search_k1_top1_margin_qfull_partial_0614_r93_v1', 256)
knn_search_k1_top1_margin_qfull_merge_0614_r93_v1 = _ir_proxy('loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:knn_search_k1_top1_margin_qfull_merge_0614_r93_v1', 256)
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:partial_k1_ir"}'))
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:merge_k1_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:ir"}'))
partial_k2_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:partial_k2_ir"}'))
merge_k2_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:merge_k2_ir"}'))
partial_k5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:partial_k5_ir"}'))
merge_k5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_margin_0614_qfull_93_v1:merge_k5_ir"}'))
...
K1_TARGET_SHAPES = _decode_capture(_json_loads('[{"label": "ksweep_q4096_m20000_d128_k1", "params": {"B": 1, "D": 128, "K": 1, "M": 20000, "Q": 4096, "dtype": "bfloat16", "min_recall": 1.0, "seed": 610310, "self_search": false}}]'))
