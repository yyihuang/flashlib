...
knn_search_lowq_tile_reduce_partial_0614_r11_e864_blockm896_v1 = _ir_proxy('loom.examples.weave.knn_search_lowq_q2q4_blockm896_0614_r11_e864_v1:knn_search_lowq_tile_reduce_partial_0614_r11_e864_blockm896_v1', 256)
knn_search_lowq_tile_reduce_merge_0614_r11_e864_blockm896_v1 = _ir_proxy('loom.examples.weave.knn_search_lowq_q2q4_blockm896_0614_r11_e864_v1:knn_search_lowq_tile_reduce_merge_0614_r11_e864_blockm896_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_q2q4_blockm896_0614_r11_e864_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_q2q4_blockm896_0614_r11_e864_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_q2q4_blockm896_0614_r11_e864_v1:merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowq_q2q4_blockm896_0614_r11_e864_v1:parent_ir"}'))

def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0340"}, "partial": {"__kernel__": "dispatch_kernel_0339"}}'))
...
def _launch_blockm896(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    if q_rows not in {2, 4}:
        raise ValueError(f'knn_search_lowq_tile_reduce_0614_r11_e864_blockm896_v1 supports Q in {{2, 4}}, got Q={q_rows}')
    if int(inputs['D']) != D_STATIC:
        raise ValueError(f'knn_search_lowq_tile_reduce_0614_r11_e864_blockm896_v1 supports D={D_STATIC}, got D={inputs['D']}')
    if int(inputs['K']) > K_MAX:
        raise ValueError(f'knn_search_lowq_tile_reduce_0614_r11_e864_blockm896_v1 supports K <= {K_MAX}, got K={inputs['K']}')
    if not _KERNELS:
