...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d511_q128_m65536_272c_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d511_q128_m65536_272c_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d511_q128_m65536_272c_v1:merge_ir"}'))
scalar_capacity_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d511_q128_m65536_272c_v1:scalar_capacity_ir"}'))
...
D511_Q128_SHAPES = _decode_capture(_json_loads('[{"label": "blind_dyn_d511_q128_m65536_k10", "params": {"B": 1, "D": 511, "K": 10, "M": 65536, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610806, "self_search": false}}]'))
