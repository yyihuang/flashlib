...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q128_fulltile_midbucket_dispatch0610_49f8_v1:ir"}'))
base_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q128_fulltile_midbucket_dispatch0610_49f8_v1:base_ir"}'))
...
Q128_FULLTILE_MIDBUCKET_SHAPES = _decode_capture(_json_loads('[{"label": "dispatch_q128_m8192_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 8192, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610201, "self_search": false}}, {"label": "dispatch_q128_m16384_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 16384, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610202, "self_search": false}}, {"label": "dispatch_q128_m32768_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 32768, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610203, "self_search": false}}, {"label": "dispatch_q128_m65536_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 65536, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610204, "self_search": false}}, {"label": "blind_tail_q128_m65535_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 65535, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610501, "self_search": false}}, {"label": "blind_tail_q128_m65537_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 65537, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610502, "self_search": false}}, {"label": "blind_midbucket_q128_m98304_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 98304, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610515, "self_search": false}}, {"label": "rag_batch_q128_m131072_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 131072, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610109, "self_search": false}}, {"label": "dispatch_q128_m262144_d128_k10", "params": {"B": 1, "D": 128, "K": 10, "M": 262144, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610205, "self_search": false}}]'))
...
def selected_route(inputs: dict[str, Any]) -> str:
    if _use_q128_fulltile_midbucket(inputs):
        ...
        return f'q128_fulltile_midbucket_split{split_m}_{partial_key}'
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    if int(inputs['K']) > K_MAX:
        raise ValueError(f'knn_search_q128_fulltile_midbucket_dispatch0610_49f8_v1 supports K <= {K_MAX}, got {inputs['K']}')
    if _use_q128_fulltile_midbucket(inputs):
