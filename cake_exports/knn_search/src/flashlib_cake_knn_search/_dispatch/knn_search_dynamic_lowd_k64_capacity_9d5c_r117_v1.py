...
TARGET_SHAPES = _decode_capture(_json_loads('[{"label": "blind_ext_dbscan_self_q4096_m4096_d3_k32", "params": {"B": 1, "D": 3, "K": 32, "M": 4096, "Q": 4096, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610932, "self_search": true}}, {"label": "blind_ext_dyn_d130_k64_q64_m65536", "params": {"B": 1, "D": 130, "K": 64, "M": 65536, "Q": 64, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610929, "self_search": false}}, {"label": "blind_ext_dyn_d512_k64_q32_m32768", "params": {"B": 1, "D": 512, "K": 64, "M": 32768, "Q": 32, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610930, "self_search": false}}]'))
pack_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_lowd_k64_capacity_9d5c_r117_v1:pack_ir"}'))
k64_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_lowd_k64_capacity_9d5c_r117_v1:k64_partial_ir"}'))
k64_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_lowd_k64_capacity_9d5c_r117_v1:k64_merge_ir"}'))
scalar_capacity_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_lowd_k64_capacity_9d5c_r117_v1:scalar_capacity_ir"}'))
...
knn_search_d3_dbscan_q4096_k32_direct_9d5c_r117_v1 = _ir_proxy('loom.examples.weave.knn_search_dynamic_lowd_k64_capacity_9d5c_r117_v1:knn_search_d3_dbscan_q4096_k32_direct_9d5c_r117_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_lowd_k64_capacity_9d5c_r117_v1:ir"}'))
