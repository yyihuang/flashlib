...
knn_search_target0628_d4096_q4_m8192_k64_partial_e750_v1 = _ir_proxy('loom.examples.weave.knn_search_target0628_d4096_q4_m8192_k64_e750_v1:knn_search_target0628_d4096_q4_m8192_k64_partial_e750_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d4096_q4_m8192_k64_e750_v1:partial_ir"}'))
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d4096_q4_m8192_k64_e750_v1:group_merge_ir"}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d4096_q4_m8192_k64_e750_v1:final_merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d4096_q4_m8192_k64_e750_v1:ir"}'))
...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0481"}, "group_merge": {"__kernel__": "dispatch_kernel_0480"}, "partial": {"__kernel__": "dispatch_kernel_0479"}}'))
...
def _launch(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    kernels['partial'].launch(grid=(128, 1, 1), block=(THREADS, 1, 1), args=[inputs['queries'], inputs['database'], partial[0], partial[1], 1, 4, 8192, 128, 1], shared_mem=SMEM_BYTES)
