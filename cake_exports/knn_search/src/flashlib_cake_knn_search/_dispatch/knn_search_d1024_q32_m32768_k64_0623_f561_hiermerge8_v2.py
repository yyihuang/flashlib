...
knn_search_d1024_q32_k64_hiermerge8_group_f561_v2 = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_hiermerge8_group_f561_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_d1024_q32_k64_hiermerge8_final_f561_v2 = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_hiermerge8_final_f561_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_hiermerge8_group_f561_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_hiermerge8_final_f561_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_d1024_q32_k64_hiermerge8_group_f561_v2", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
