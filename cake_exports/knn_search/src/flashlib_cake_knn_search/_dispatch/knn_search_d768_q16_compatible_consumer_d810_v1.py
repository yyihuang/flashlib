...
def _compile_direct_mma_kernels(original_d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_q8_blockm256_two_stripe_tmem_8d4fe4ead6cd_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{lowd.merge_ir.symbol}'), 'shared_mem': HIGH_MMA_SMEM_BYTES}
...
def _target_merge_kernel() -> Any:
    ...
    if _TARGET_MERGE_KERNEL is None:
        ...
        _TARGET_MERGE_KERNEL = CUDAKernel(cubin, f'kernel_{merge_ir.symbol}')
