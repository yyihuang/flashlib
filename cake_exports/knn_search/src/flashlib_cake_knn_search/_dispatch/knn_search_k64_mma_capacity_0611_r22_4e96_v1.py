...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k64_mma_capacity_0611_r22_4e96_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
...
def _compile_k64_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0221"}, "partial": {"__kernel__": "dispatch_kernel_0220"}}'))
