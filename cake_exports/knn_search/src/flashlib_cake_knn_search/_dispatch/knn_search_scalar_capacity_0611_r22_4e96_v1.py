...
def _compile_kernels(d: int, k_cap: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_scalar_capacity_partial_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{knn_search_scalar_capacity_merge_v1.symbol}'), 'direct': CUDAKernel(direct_cubin, f'kernel_{knn_search_scalar_capacity_direct_v1.symbol}')}
