...
K31_MAX = 31
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_partial_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "constants": [["K_MAX_", 31], ["EXPOSE_COL_COHORTS", 0]], "cta_group": 1, "threads": 512}'))
...
def _compile_k31_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0229"}, "partial": {"__kernel__": "dispatch_kernel_0228"}}'))
