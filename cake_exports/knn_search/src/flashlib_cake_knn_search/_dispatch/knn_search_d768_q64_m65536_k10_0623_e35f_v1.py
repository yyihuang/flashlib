...
knn_search_d768_q64_m65536_k10_partial_0623_e35f_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_d768_q64_m65536_k10_partial_0623_e35f_v1", "arg_keys": ["queries", "database", "partial_distances", "partial_indices", "B", "Q", "M", "split_m", "num_q_tiles", "total_m_tiles"], "cluster_dims": [1, 1, 1], "computed_smem_bytes": 106240, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 512}'))
...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0009"}, "partial": {"__kernel__": "dispatch_kernel_0187"}}'))
