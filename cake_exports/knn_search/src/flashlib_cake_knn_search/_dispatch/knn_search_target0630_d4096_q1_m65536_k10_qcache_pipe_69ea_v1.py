...
knn_search_d4096_q1_m65536_k10_partial_qcache_pipe_69ea_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_d4096_q1_m65536_k10_partial_qcache_pipe_69ea_v1", "arg_keys": ["queries", "database", "partial_distances", "partial_indices", "B", "Q", "M", "split_m", "num_q_tiles", "total_m_tiles"], "cluster_dims": [1, 1, 1], "computed_smem_bytes": 62848, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 512}'))
...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0143"}, "partial": {"__kernel__": "dispatch_kernel_0142"}}'))
