...
K_MAX = parent.K_MAX
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:merge_ir"}'))
direct_highd_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:direct_highd_partial_ir"}'))
direct_highd_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:direct_highd_merge_ir"}'))
d768d1024_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:d768d1024_partial_ir"}'))
d768d1024_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:d768d1024_merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_scalar_breakthrough_0621_r124_f670_extrows_v1:parent_ir"}'))
