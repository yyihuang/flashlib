"""Exact D1024/Q8/M65536/K10 tcgen05 kNN with coalesced DB staging.
...
top-10 lists enter the existing fixed148 partial ABI. Adjacent lanes own the
four D32 norm chunks of each database row, making their global loads row-local.
"""
...
TARGET_ROUTE = 'd1024_q8_n256_tcgen05_fixed148_coalesced_db_staging_1c61_v1'
...
_knn_accumulate_q_norm_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:_knn_accumulate_q_norm_highd_direct_d', 256)
_knn_stage_q_pass_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:_knn_stage_q_pass_highd_direct_d', 256)
_knn_stage_database_pass_highd_direct_d = _ir_proxy('loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:_knn_stage_database_pass_highd_direct_d', 256)
_knn_accumulate_db_norm_blockm256 = _ir_proxy('loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:_knn_accumulate_db_norm_blockm256', 256)
_knn_mma_issue_blockm256 = _ir_proxy('loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:_knn_mma_issue_blockm256', 256)
knn_search_q8_blockm256_two_stripe_tmem_8d4fe4ead6cd_v1 = _ir_proxy('loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:knn_search_q8_blockm256_two_stripe_tmem_8d4fe4ead6cd_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:ir"}'))
...
def route_info(inputs: dict[str, Any]) -> dict[str, Any]:
    if selected_route(inputs) == TARGET_ROUTE:
        return {'route': TARGET_ROUTE, 'selected_route': TARGET_ROUTE, 'selected_entrypoint': 'loom.examples.weave.knn_search_d1024_q8_stagingownership_1c61_v1:launch_for_eval', 'route_kind': 'specialized', 'route_source': '1c61-row-local-db-staging', 'coverage_class': 'target0627_d1024_q8_k10', 'classification': 'seed-produced', 'coverage_only': False, 'production_policy': 'weave_only', 'external_fallback': None, 'guard_id': TARGET_LABEL, 'fallback': None, 'missing_weave_route': False, 'arch_requirement': 'sm_100a', 'padding_tag': 'none', 'uses_materialized_padding': False, 'uses_kernel_padding': False, 'padding_overhead_timed': False, 'padded_D': HIGH_D_MAX, 'workspace_reuse': 'producer partial scratch cache', 'staging_ownership': 'adjacent lanes own the four D32 chunks of each database row'}
