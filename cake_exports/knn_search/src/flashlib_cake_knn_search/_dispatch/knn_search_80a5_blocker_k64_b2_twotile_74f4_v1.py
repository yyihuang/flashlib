...
knn_search_80a5_b2_q128m65536_k64_twotile_partial_74f4_v1 = _ir_proxy('loom.examples.weave.knn_search_80a5_blocker_k64_b2_twotile_74f4_v1:knn_search_80a5_b2_q128m65536_k64_twotile_partial_74f4_v1', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_80a5_blocker_k64_b2_twotile_74f4_v1:partial_ir"}'))
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_80a5_blocker_k64_b2_twotile_74f4_v1:group_merge_ir"}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_80a5_blocker_k64_b2_twotile_74f4_v1:final_merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_80a5_blocker_k64_b2_twotile_74f4_v1:ir"}'))
B2_K64_TARGET_LABELS: tuple[str, ...] = ('blind_post6912_k64_b2_q128_m65536_d128',)
B2_K64_TARGET_SHAPES = _decode_capture(_json_loads('[{"label": "blind_post6912_k64_b2_q128_m65536_d128", "params": {"B": 2, "D": 128, "K": 64, "M": 65536, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610709, "self_search": false}}]'))
