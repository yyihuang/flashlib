...
knn_search_lowd_dbscan_direct_dispatch0610_r1_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowd_dbscan_dispatch0610_r1_v1:knn_search_lowd_dbscan_direct_dispatch0610_r1_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 16512, "cta_group": 1, "threads": 256}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowd_dbscan_dispatch0610_r1_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 16512, "cta_group": 1, "threads": 256}'))
