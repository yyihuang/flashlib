...
knn_search_lowd_dbscan_direct_dispatch0610_r1_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_dbscan_direct_dispatch0610_r1_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 16512, "constants": [["D_", 2], ["K_MAX_", 64], ["LOCAL_LIST_CAP_", 8], ["NUM_WARPS_", 8]], "cta_group": 1, "threads": 256}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_dbscan_direct_dispatch0610_r1_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 16512, "constants": [["D_", 2], ["K_MAX_", 64], ["LOCAL_LIST_CAP_", 8], ["NUM_WARPS_", 8]], "cta_group": 1, "threads": 256}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    if not _use_lowd_capacity(inputs):
        ...
        raise ValueError(f'knn_search_lowd_dbscan_dispatch0610_r1_v1 supports K>10 only for D={D_STATIC}, Q%4==0, M%4==0, M<={M_MAX}; got Q={inputs['Q']}, D={inputs['D']}, M={inputs['M']}, K={inputs['K']}')
    if not _KERNELS:
