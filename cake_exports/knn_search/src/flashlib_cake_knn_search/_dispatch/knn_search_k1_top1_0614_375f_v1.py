...
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_0614_375f_v1:partial_k1_ir"}'))
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_0614_375f_v1:merge_k1_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_0614_375f_v1:parent_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k1_top1_0614_375f_v1:ir"}'))
...
K1_TOP1_SHAPES = _decode_capture(_json_loads('[{"label": "ksweep_q4096_m20000_d128_k1", "params": {"B": 1, "D": 128, "K": 1, "M": 20000, "Q": 4096, "dtype": "bfloat16", "min_recall": 1.0, "seed": 610310, "self_search": false}}, {"label": "round92_375f_q2048_m20000_d128_k1", "params": {"B": 1, "D": 128, "K": 1, "M": 20000, "Q": 2048, "dtype": "bfloat16", "min_recall": 1.0, "seed": 710101, "self_search": false}}, {"label": "round92_375f_q3072_m20000_d128_k1", "params": {"B": 1, "D": 128, "K": 1, "M": 20000, "Q": 3072, "dtype": "bfloat16", "min_recall": 1.0, "seed": 710104, "self_search": false}}, {"label": "round92_375f_q4096_m16384_d128_k1", "params": {"B": 1, "D": 128, "K": 1, "M": 16384, "Q": 4096, "dtype": "bfloat16", "min_recall": 1.0, "seed": 710102, "self_search": false}}]'))
...
def selected_route(inputs: dict[str, Any]) -> str:
    if _use_round92_375f_highq_k1_top1(inputs):
        ...
        return f'round92_375f_highq_k1_top1_split{split_m}'
