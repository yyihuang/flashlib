...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:partial_ir"}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:current_ir"}'))
base_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:base_ir"}'))
q128_22d9_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:q128_22d9_ir"}'))
blockm640_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:blockm640_ir"}'))
blockm640_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:blockm640_partial_ir"}'))
blockm640_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0616_seed_bank_6912_q128_20c7_lowq_8a2e_v1:blockm640_merge_ir"}'))
