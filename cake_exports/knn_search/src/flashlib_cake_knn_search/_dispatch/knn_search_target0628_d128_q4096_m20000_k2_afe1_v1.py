"""AFE1 D128/Q4096/M20000/K2 exact seed with constant producer ownership.

Minimum target architecture: sm_100a. This additive bucket-kernel candidate
targets only ``B=1, Q=4096, M=20000, D=128, K=2``. It keeps the prior split9
tcgen05 producer/merge contract path, but folds exact split/tile ownership
constants into the producer and merge kernels.
"""
...
Q4096_ROWS = 4096
Q4096_LOWK_M = 20000
Q4096_LOWK_SPLIT_M = 9
Q4096_LOWK_NUM_Q_TILES = Q4096_ROWS // BLOCK_Q
Q4096_LOWK_TOTAL_M_TILES = (Q4096_LOWK_M + BLOCK_M - 1) // BLOCK_M
Q4096_LOWK_VALUES: tuple[int, ...] = (2,)
TARGET_LABELS: tuple[str, ...] = ('target0627_d128_q4096_m20000_k2_floor14',)
ROUTE_TARGET0628_D128_Q4096_M20000_K2_AFE1 = 'target0628_d128_q4096_m20000_k2_afe1_constowner_split9'
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_lowk_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:merge_lowk_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
_LOWK_KERNELS: dict[str, Any] = {}
_LOWK_SCRATCH: dict[tuple[int, int, int, int, int, int, str], tuple[Any, Any]] = {}
_knn_lowk2_insert_sorted_pair = _ir_proxy('loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:_knn_lowk2_insert_sorted_pair', 256)
_knn_lowk2_insert_batch_merge = _ir_proxy('loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:_knn_lowk2_insert_batch_merge', 256)
_knn_store_lowk2_pairs = _ir_proxy('loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:_knn_store_lowk2_pairs', 256)
knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
knn_search_q4096_lowk_k2partial_merge_0613_r45_48e9_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:knn_search_q4096_lowk_k2partial_merge_0613_r45_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_lowk_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:merge_lowk_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0628_d128_q4096_m20000_k2_afe1_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
Q4096_LOWK_LABELS: tuple[str, ...] = TARGET_LABELS
...
def _compile_lowk_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_lowk2": {"__kernel__": "dispatch_kernel_0500"}, "partial_lowk": {"__kernel__": "dispatch_kernel_0499"}}'))
...
def _launch_q4096_lowk(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    _LOWK_KERNELS['merge_lowk2'].launch(grid=(bsz * q_rows, 1, 1), block=(MERGE_THREADS, 1, 1), args=[partial_dist, partial_idx, inputs['out_distances'], inputs['out_indices'], bsz, q_rows, k, Q4096_LOWK_SPLIT_M, num_q_tiles], shared_mem=mma.MERGE_SMEM_BYTES)
...
def launch_for_eval_target0628_d128_q4096_m20000_k2_afe1(inputs: dict[str, Any]) -> dict[str, Any]:
    return launch_for_eval(inputs)
