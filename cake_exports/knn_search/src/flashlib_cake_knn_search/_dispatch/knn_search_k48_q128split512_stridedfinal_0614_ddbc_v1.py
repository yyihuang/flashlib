...
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q128split512_stridedfinal_0614_ddbc_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q128split512_stridedfinal_0614_ddbc_v1:group_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q128split512_stridedfinal_0614_ddbc_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
_KNN_SEARCH_K48_Q128_KERNELS: dict[str, Any] = {}
knn_search_k48_q128split512_finalmerge32_strided_0614_ddbc_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q128split512_stridedfinal_0614_ddbc_v1:knn_search_k48_q128split512_finalmerge32_strided_0614_ddbc_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q128split512_stridedfinal_0614_ddbc_v1:final_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
