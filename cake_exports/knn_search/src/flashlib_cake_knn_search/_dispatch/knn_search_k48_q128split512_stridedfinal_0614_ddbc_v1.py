...
def _compile_q128_k48_stridedfinal_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0312"}, "group_merge": {"__kernel__": "dispatch_kernel_0311"}, "partial": {"__kernel__": "dispatch_kernel_0310"}}'))
