...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_extk_sweep_176c_r2_v1:ir"}'))
incumbent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_extk_sweep_176c_r2_v1:incumbent_ir"}'))
extk_portfolio_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_extk_sweep_176c_r2_v1:extk_portfolio_ir"}'))
truek48_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dispatch0610_extk_sweep_176c_r2_v1:truek48_ir"}'))
