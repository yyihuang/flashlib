...
SUPPORTED_D = {384}
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_d384_tcgen05_dispatch0610_r1_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 122624, "cta_group": 1, "threads": 640}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_d384_tcgen05_dispatch0610_r1_v1:merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_d384_tcgen05_dispatch0610_r1_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 122624, "cta_group": 1, "threads": 640}'))
...
knn_search_blind_d384_tcgen05_partial_dispatch0610_r1_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_d384_tcgen05_dispatch0610_r1_v1:knn_search_blind_d384_tcgen05_partial_dispatch0610_r1_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 122624, "cta_group": 1, "threads": 640}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_d384_tcgen05_dispatch0610_r1_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 122624, "cta_group": 1, "threads": 640}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_blind_d384_tcgen05_dispatch0610_r1_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 122624, "cta_group": 1, "threads": 640}'))
...
def _compile_d384_mma_kernels(dim: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_blind_d384_tcgen05_partial_dispatch0610_r1_v1.name}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{mma.knn_search_mma_split_merge_q128_const148_v1.name}')}
