...
def _compile_d384_mma_kernels(dim: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_blind_d384_tcgen05_partial_dispatch0610_r1_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{mma.knn_search_mma_split_merge_q128_const148_v1.symbol}')}
