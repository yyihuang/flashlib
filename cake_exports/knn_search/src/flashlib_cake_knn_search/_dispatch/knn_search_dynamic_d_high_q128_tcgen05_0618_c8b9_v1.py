...
def _compile_high_d511_mma_kernels(padded_d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_dynamic_d511_tcgen05_partial_0618_c8b9_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{lowd.merge_ir.symbol}'), 'shared_mem': HIGH_MMA_SMEM_BYTES}
