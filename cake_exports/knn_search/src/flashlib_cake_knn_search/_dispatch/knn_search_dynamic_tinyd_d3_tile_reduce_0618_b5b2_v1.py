...
def _compile_kernels(d: int, block_m: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{partial_ir_for_d.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{knn_search_dynamic_tinyd_tile_reduce_merge_0618_c8b9_v1.symbol}')}
