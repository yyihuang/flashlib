...
TINYD_SHAPES = _decode_capture(_json_loads('[{"label": "blind_dyn_d3_q128_m65536_k10", "params": {"B": 1, "D": 3, "K": 10, "M": 65536, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610801, "self_search": false}}]'))
ROUTE_TINYD_D3_TILE_REDUCE = 'b5b2_dynamic_d3_tinyd_tile_reduce'
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:merge_ir"}'))
_KERNELS: dict[tuple[int, int], dict[str, Any]] = {}
_SCRATCH: dict[tuple[int, int, int, int, int, int, str], tuple[Any, Any]] = {}
knn_search_dynamic_tinyd_tile_reduce_partial_0618_c8b9_v1 = _ir_proxy('loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:knn_search_dynamic_tinyd_tile_reduce_partial_0618_c8b9_v1', 256)
knn_search_dynamic_d63_tile_reduce_partial_0618_c8b9_v1 = _ir_proxy('loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:knn_search_dynamic_d63_tile_reduce_partial_0618_c8b9_v1', 256)
knn_search_dynamic_tinyd_tile_reduce_merge_0618_c8b9_v1 = _ir_proxy('loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:knn_search_dynamic_tinyd_tile_reduce_merge_0618_c8b9_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:merge_ir"}'))
d63_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_tinyd_d3_tile_reduce_0618_b5b2_v1:d63_partial_ir"}'))
