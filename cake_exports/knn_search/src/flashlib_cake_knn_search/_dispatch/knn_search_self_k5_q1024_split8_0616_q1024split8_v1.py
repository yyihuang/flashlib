...
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_merge_stream_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 32}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_self_k5_direct_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 384, "constants": [["D_", 128], ["K_MAX_", 5], ["NUM_WARPS_", 8]], "cta_group": 1, "threads": 256}'))
