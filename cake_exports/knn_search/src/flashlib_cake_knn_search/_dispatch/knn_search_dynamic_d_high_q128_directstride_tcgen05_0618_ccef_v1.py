...
def _compile_direct_mma_kernels(original_d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_dynamic_d_high_directstride_tcgen05_partial_0618_ccef_v1.symbol}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{lowd.merge_ir.symbol}'), 'shared_mem': HIGH_MMA_SMEM_BYTES}
