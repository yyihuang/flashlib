...
knn_search_k64_q4096split80_twotile_partial_0612_r25_4e2c_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k64_q4096split80_twotile_partial_0612_r25_4e2c_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "constants": [["K_MAX_", 64]], "cta_group": 1, "threads": 512}'))
...
def _compile_k64_twotile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0228"}, "partial": {"__kernel__": "dispatch_kernel_0227"}}'))
