...
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_8048_n64_g8_grid132_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 105984, "cta_group": 1, "threads": 256}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_8048_n64_g8_grid132_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 105984, "cta_group": 1, "threads": 256}'))
_KERNELS: dict[str, Any] | None = None
_SCRATCH: dict[tuple[Any, ...], tuple[Any, Any]] = {}
_GROUP_SCRATCH: dict[tuple[Any, ...], tuple[Any, Any]] = {}
group_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_8048_n64_g8_grid132_v1:group_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
final_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_target0629_d4096_q4_m8192_k64_8048_n64_g8_grid132_v1:final_merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
