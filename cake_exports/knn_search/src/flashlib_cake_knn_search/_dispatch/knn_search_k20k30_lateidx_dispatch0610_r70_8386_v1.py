...
knn_search_k20k30_q128_split148_lateidx_merge_r70_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_k20k30_q128_split148_lateidx_merge_r70_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_MAX_", 20]], "cta_group": 1, "threads": 32}'))
...
def _compile_bucket_kernels(k_max: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{base.knn_search_mma_split_partial_v1.name}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{knn_search_k20k30_q128_split148_lateidx_merge_r70_v1.name}')}
