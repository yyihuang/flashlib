...
knn_search_mma_split_partial_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k32_mma_capacity_0611_r12_v1:knn_search_mma_split_partial_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
knn_search_mma_split_merge_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k32_mma_capacity_0611_r12_v1:knn_search_mma_split_merge_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_mma_split_merge_stream_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k32_mma_capacity_0611_r12_v1:knn_search_mma_split_merge_stream_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_mma_split_merge_q128_const148_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k32_mma_capacity_0611_r12_v1:knn_search_mma_split_merge_q128_const148_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
knn_search_mma_split_merge_q4096_pairlocal_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k32_mma_capacity_0611_r12_v1:knn_search_mma_split_merge_q4096_pairlocal_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k32_mma_capacity_0611_r12_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 165120, "cta_group": 1, "threads": 512}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    if int(inputs['K']) > K_MAX:
        raise ValueError(f'knn_search_k32_mma_capacity_0611_r12_v1 supports K <= {K_MAX}, got {inputs['K']}')
    if int(inputs['D']) != D_STATIC:
        raise ValueError(f'knn_search_k32_mma_capacity_0611_r12_v1 supports D={D_STATIC}, got {inputs['D']}')
