...
K_MAX = mma.K_MAX
SPLIT_M = 4
partial_full_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:partial_full_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:parent_ir"}'))
merge_stream_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:merge_stream_ir"}'))
