...
K_MAX = mma.K_MAX
SPLIT_M = 4
partial_full_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:partial_full_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 96000, "cta_group": 1, "threads": 512}'))
merge_stream_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_highq_q4096_m65536_k10_fulltile_0615_a7f3_v1:merge_stream_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
def selected_route_for_profile(inputs: dict[str, Any], profile: str) -> str:
    if profile not in {PROFILE_PARENT, PROFILE_ALL}:
        raise ValueError(f'unknown round-a7f3 profile: {profile}')
