...
def _compile_q128_split512_hiermerge_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final_merge": {"__kernel__": "dispatch_kernel_0361"}, "group_merge": {"__kernel__": "dispatch_kernel_0360"}, "partial": {"__kernel__": "dispatch_kernel_0359"}}'))
