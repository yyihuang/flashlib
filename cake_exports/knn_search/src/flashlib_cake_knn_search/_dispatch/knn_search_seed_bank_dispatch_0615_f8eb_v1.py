...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:ir"}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:current_ir"}'))
q128_b08d_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:q128_b08d_ir"}'))
q128_49f8_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:q128_49f8_ir"}'))
highq_a7f3_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:highq_a7f3_ir"}'))
ann_b72b_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:ann_b72b_ir"}'))
extk_bbd5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:extk_bbd5_ir"}'))
extk_5161_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:extk_5161_ir"}'))
lowd_7d36_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_dispatch_0615_f8eb_v1:lowd_7d36_ir"}'))
