...
knn_search_ivf_q12_m100_d64_k20_direct_6bea_r118_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_ivf_q12_m100_d64_k20_direct_6bea_r118_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 128, "constants": [["D_", 64], ["K_MAX_", 20], ["NUM_WARPS_", 4]], "cta_group": 1, "threads": 128}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_ivf_q12_m100_d64_k20_direct_6bea_r118_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 128, "constants": [["D_", 64], ["K_MAX_", 20], ["NUM_WARPS_", 4]], "cta_group": 1, "threads": 128}'))
...
def _compile_ivf_kernel():
    return _decode_capture(_json_loads('{"__kernel__": "dispatch_kernel_0414"}'))
