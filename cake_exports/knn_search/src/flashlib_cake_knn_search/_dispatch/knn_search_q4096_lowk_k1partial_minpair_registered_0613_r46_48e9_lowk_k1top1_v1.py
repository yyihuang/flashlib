"""Round-46 registered Q4096 low-K K1 min-pair route for exact BF16 kNN.
...
and 16-lane split merge. K2, K5, K10, and every guard miss delegate to the
round-51 registered dispatcher unchanged.
"""
...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:partial_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:merge_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
_LOWK_K1_KERNELS: dict[str, Any] = {}
_LOWK_K1_SCRATCH: dict[tuple[int, int, int, int, int, int, str], tuple[Any, Any]] = {}
_knn_lowk1_insert_min = _ir_proxy('loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:_knn_lowk1_insert_min', 256)
_knn_lowk1_insert_batch_min = _ir_proxy('loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:_knn_lowk1_insert_batch_min', 256)
_knn_store_lowk1_pair = _ir_proxy('loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:_knn_store_lowk1_pair', 256)
knn_search_q4096_lowk_k1partial_minpair_0613_r46_48e9_lowk_k1top1_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:knn_search_q4096_lowk_k1partial_minpair_0613_r46_48e9_lowk_k1top1_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
knn_search_q4096_lowk_k1partial_minpair_merge_0613_r46_48e9_lowk_k1top1_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:knn_search_q4096_lowk_k1partial_minpair_merge_0613_r46_48e9_lowk_k1top1_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
partial_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:partial_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_k1_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:merge_k1_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
partial_k2_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:partial_k2_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_k2_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:merge_k2_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
partial_k5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:partial_k5_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_k5_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k1partial_minpair_registered_0613_r46_48e9_lowk_k1top1_v1:merge_k5_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
...
SHAPE_DISPATCH_REGISTRY: tuple[dict[str, str], ...] = ({'shape_key': 'registered_d128_q4096_lowk_k1partial_minpair_split9', 'guard': 'B == 1 and Q == 4096 and M == 20000 and D == 128 and K == 1 and tcgen05', 'route': 'round46_registered_q4096_lowk_k1partial_minpair_split9'}, *registered.SHAPE_DISPATCH_REGISTRY)
...
def selected_route(inputs: dict[str, Any]) -> str:
    if _use_q4096_k1(inputs):
        return 'round46_registered_q4096_lowk_k1partial_minpair_split9'
...
def _compile_k1_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_k1": {"__kernel__": "dispatch_kernel_0276"}, "partial_k1": {"__kernel__": "dispatch_kernel_0275"}}'))
