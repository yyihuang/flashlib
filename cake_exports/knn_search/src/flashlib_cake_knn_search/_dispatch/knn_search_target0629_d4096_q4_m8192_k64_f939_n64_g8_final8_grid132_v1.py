"""Exact D4096/Q4/M8192/K64 N64 tcgen05 seed with an 8-lane final merge.

Minimum target architecture: sm_100a.  This additive Group8 variant retains
the 132-CTA native-N64 tcgen05 producer and Group8 partial consumer, while
the final top-64 merge reduces exactly its eight valid group heads.
"""
from __future__ import annotations
from json import loads as _json_loads
from .._dispatch_runtime import _capture_cuTensorMapEncodeTiled, _decode_capture, _import_dispatch_module, _ir_proxy
from typing import Any
from . import knn_search_target0629_d4096_q4_m8192_k64_8048_n64_g8_grid132_v1 as parent
PRODUCER_GRID = parent.PRODUCER_GRID
THREADS = parent.THREADS
MERGE_THREADS = parent.MERGE_THREADS
BLOCK_Q = parent.BLOCK_Q
K64_MAX = parent.K64_MAX
HIERMERGE_GROUPS = parent.HIERMERGE_GROUPS
...
def route_info(inputs: dict[str, Any]) -> dict[str, Any]:
    if _active(inputs):
        return {**parent.route_info(inputs), 'selected_route': ROUTE, 'selected_entrypoint': ENTRYPOINT, 'coverage_class': 'bucket_seed_target0627_d4096_q4_m8192_k64_native_n64_g8_final8_grid132'}
    return parent.route_info(inputs)

def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"final": {"__kernel__": "dispatch_kernel_0148"}, "group": {"__kernel__": "dispatch_kernel_0147"}, "partial": {"__kernel__": "dispatch_kernel_0146"}}'))
