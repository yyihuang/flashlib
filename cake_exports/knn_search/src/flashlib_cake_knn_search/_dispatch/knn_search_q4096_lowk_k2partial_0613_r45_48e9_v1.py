...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_lowk_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:merge_lowk_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:parent_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
...
knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
knn_search_q4096_lowk_k2partial_merge_0613_r45_48e9_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:knn_search_q4096_lowk_k2partial_merge_0613_r45_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
merge_lowk_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:merge_lowk_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q4096_lowk_k2partial_0613_r45_48e9_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "cta_group": 1, "threads": 640}'))
...
def _compile_lowk_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_lowk1": {"__kernel__": "dispatch_kernel_0285"}, "merge_lowk2": {"__kernel__": "dispatch_kernel_0286"}, "partial_lowk": {"__kernel__": "dispatch_kernel_0284"}}'))
