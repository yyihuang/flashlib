...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_q128_small_mid_split_v2:ir"}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    if int(inputs['K']) > K_MAX:
        raise ValueError(f'knn_search_q128_small_mid_split_v2 supports K <= {K_MAX}, got {inputs['K']}')
