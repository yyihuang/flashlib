...
def _compile_pack_kernel(original_d: int, padded_d: int):
    ...
    return CUDAKernel(cubin, f'kernel_{knn_search_dynamic_d_tiny_pack_bf16_0618_c8b9_v1.symbol}')
...
def _compile_d3_tile_reduce_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0254"}, "partial": {"__kernel__": "dispatch_kernel_0253"}}'))
