...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_rag_q4096_m20000_d128_k10_repair_q4096_seed3_real_scratch_v1:ir"}'))
...
def launch_for_eval(inputs: dict[str, Any]) -> dict[str, Any]:
    ...
    if missing:
        raise ValueError(f'pairlocal72 repair missing tensor fields: {missing}')
