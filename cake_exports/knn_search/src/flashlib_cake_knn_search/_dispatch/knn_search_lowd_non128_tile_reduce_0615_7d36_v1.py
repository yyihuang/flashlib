...
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [["D_", 64], ["K_MAX_", 10], ["BLOCK_M_", 1280], ["NUM_ROW_WORKERS_", 128], ["SUBWARP_WIDTH_", 2], ["SUBWARPS_PER_WARP_", 16], ["CHUNKS_", 4], ["LOCAL_LIST_CAP_", 10]], "cta_group": 1, "threads": 256}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [["D_", 64], ["K_MAX_", 10], ["BLOCK_M_", 1280], ["NUM_ROW_WORKERS_", 128], ["SUBWARP_WIDTH_", 2], ["SUBWARPS_PER_WARP_", 16], ["CHUNKS_", 4], ["LOCAL_LIST_CAP_", 10]], "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
...
def _config_for_d(d: int) -> dict[str, int]:
    if d == 64:
        ...
        raise ValueError(f'unsupported low-D non-D128 dimension: {d}')
...
knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [["D_", 64], ["K_MAX_", 10], ["BLOCK_M_", 1280], ["NUM_ROW_WORKERS_", 128], ["SUBWARP_WIDTH_", 2], ["SUBWARPS_PER_WARP_", 16], ["CHUNKS_", 4], ["LOCAL_LIST_CAP_", 10]], "cta_group": 1, "threads": 256}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10240, "constants": [["D_", 64], ["K_MAX_", 10], ["BLOCK_M_", 1280], ["NUM_ROW_WORKERS_", 128], ["SUBWARP_WIDTH_", 2], ["SUBWARPS_PER_WARP_", 16], ["CHUNKS_", 4], ["LOCAL_LIST_CAP_", 10]], "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 640, "constants": [["K_MAX_", 10]], "cta_group": 1, "threads": 256}'))
...
def _compile_kernels(d: int) -> dict[str, Any]:
    ...
    return {'partial': CUDAKernel(partial_cubin, f'kernel_{knn_search_lowd_non128_tile_reduce_partial_0615_7d36_v1.name}'), 'merge': CUDAKernel(merge_cubin, f'kernel_{knn_search_lowd_non128_tile_reduce_merge_0615_7d36_v1.name}')}

def _scratch(inputs: dict[str, Any], num_m_tiles: int) -> tuple[Any, Any]:
    import torch
    key = (int(inputs['B']), int(inputs['Q']), int(inputs['D']), int(num_m_tiles), int(inputs['queries'].device.index or 0), int(inputs['K']), str(inputs['queries'].dtype))
