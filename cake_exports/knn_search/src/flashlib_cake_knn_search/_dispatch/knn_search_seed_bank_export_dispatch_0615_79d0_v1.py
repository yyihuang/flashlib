...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:partial_ir"}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:current_ir"}'))
base_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:base_ir"}'))
lowd_a597_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:lowd_a597_partial_ir"}'))
lowd_a597_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:lowd_a597_merge_ir"}'))
midq_f48a_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:midq_f48a_ir"}'))
midq_f48a_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:midq_f48a_partial_ir"}'))
midq_f48a_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0615_79d0_v1:midq_f48a_merge_ir"}'))
