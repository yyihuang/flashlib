...
partial_k5_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_mma_split_partial_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "constants": [["K_MAX_", 10], ["EXPOSE_COL_COHORTS", 0], ["FULL_M_TILES", 0]], "cta_group": 1, "threads": 640}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_q4096_lowk_k1partial_0613_r44_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 108800, "constants": [], "cta_group": 1, "threads": 640}'))
_LOWK_K5_MERGE_KERNELS: dict[str, Any] = {}
knn_search_q4096_lowk_k5_stride10_merge_0613_r48_48e9_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_q4096_lowk_k5_stride10_merge_0613_r48_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_STRIDE_", 10], ["K_OUT_MAX_", 5]], "cta_group": 1, "threads": 32}'))
merge_k5_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_q4096_lowk_k5_stride10_merge_0613_r48_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_STRIDE_", 10], ["K_OUT_MAX_", 5]], "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_q4096_lowk_k5_stride10_merge_0613_r48_48e9_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "constants": [["K_STRIDE_", 10], ["K_OUT_MAX_", 5]], "cta_group": 1, "threads": 32}'))
...
def _compile_k5_merge_kernel() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge_k5": {"__kernel__": "dispatch_kernel_0282"}}'))
