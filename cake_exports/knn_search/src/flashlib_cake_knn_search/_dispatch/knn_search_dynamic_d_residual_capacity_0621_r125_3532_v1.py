...
K_MAX = parent.K_MAX
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:merge_ir"}'))
parent_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:parent_ir"}'))
tinyd_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:tinyd_partial_ir"}'))
tinyd_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:tinyd_merge_ir"}'))
highd_direct_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:highd_direct_partial_ir"}'))
highd_direct_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:highd_direct_merge_ir"}'))
d384_q32_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:d384_q32_partial_ir"}'))
d384_q32_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:d384_q32_merge_ir"}'))
k64_dynamic_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:k64_dynamic_partial_ir"}'))
k64_dynamic_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:k64_dynamic_merge_ir"}'))
b2_dynamic_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_residual_capacity_0621_r125_3532_v1:b2_dynamic_ir"}'))
...
TARGET_SHAPES = _decode_capture(_json_loads('[{"label": "blind_dyn_d7_q128_m65536_k10", "params": {"B": 1, "D": 7, "K": 10, "M": 65536, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610802, "self_search": false}}, {"label": "blind_dyn_d511_q128_m65536_k10", "params": {"B": 1, "D": 511, "K": 10, "M": 65536, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610806, "self_search": false}}, {"label": "blind_dyn_d384_q32_m131072_k10", "params": {"B": 1, "D": 384, "K": 10, "M": 131072, "Q": 32, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610807, "self_search": false}}, {"label": "blind_dyn_d257_k64_q64_m65536", "params": {"B": 1, "D": 257, "K": 64, "M": 65536, "Q": 64, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610808, "self_search": false}}, {"label": "blind_dyn_b2_q64_m65536_d129_k10", "params": {"B": 2, "D": 129, "K": 10, "M": 65536, "Q": 64, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610809, "self_search": false}}]'))
