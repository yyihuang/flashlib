...
knn_search_lowd_dbscan_d2_t128_m1536_0613_r56_cd72_v1 = _ir_proxy('loom.examples.weave.knn_search_lowd_dbscan_t128_m1536_dispatch0610_r56_cd72_v1:knn_search_lowd_dbscan_d2_t128_m1536_0613_r56_cd72_v1', 256)
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_lowd_dbscan_t128_m1536_dispatch0610_r56_cd72_v1:ir"}'))
DBSCAN_D2_LABELS: tuple[str, ...] = ('dbscan_lowd_self_q1500_m1500_d2_k32', 'dbscan_lowd_self_q1500_m1500_d2_k64')
DBSCAN_D2_SHAPES = _decode_capture(_json_loads('[{"label": "dbscan_lowd_self_q1500_m1500_d2_k32", "params": {"B": 1, "D": 2, "K": 32, "M": 1500, "Q": 1500, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610405, "self_search": true}}, {"label": "dbscan_lowd_self_q1500_m1500_d2_k64", "params": {"B": 1, "D": 2, "K": 64, "M": 1500, "Q": 1500, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610407, "self_search": true}}]'))
...
def _compile_lowd_coop_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"direct": {"__kernel__": "dispatch_kernel_0274"}}'))
