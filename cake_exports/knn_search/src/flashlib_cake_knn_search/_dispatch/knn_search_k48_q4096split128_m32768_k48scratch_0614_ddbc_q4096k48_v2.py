...
knn_search_k48_q4096split128_m32768_k48scratch_partial_0614_ddbc_q4096k48_v2 = _ir_proxy('loom.examples.weave.knn_search_k48_q4096split128_m32768_k48scratch_0614_ddbc_q4096k48_v2:knn_search_k48_q4096split128_m32768_k48scratch_partial_0614_ddbc_q4096k48_v2', 256)
knn_search_k48_q4096split128_m32768_k48scratch_merge16_0614_ddbc_q4096k48_v2 = _ir_proxy('loom.examples.weave.knn_search_k48_q4096split128_m32768_k48scratch_0614_ddbc_q4096k48_v2:knn_search_k48_q4096split128_m32768_k48scratch_merge16_0614_ddbc_q4096k48_v2', 256)
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q4096split128_m32768_k48scratch_0614_ddbc_q4096k48_v2:partial_ir"}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q4096split128_m32768_k48scratch_0614_ddbc_q4096k48_v2:merge_ir"}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_k48_q4096split128_m32768_k48scratch_0614_ddbc_q4096k48_v2:ir"}'))
K48_Q4096_SPLIT128_M32768_SHAPES = _decode_capture(_json_loads('[{"label": "blind_k48_q4096_m32768_d128_k48", "params": {"B": 1, "D": 128, "K": 48, "M": 32768, "Q": 4096, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610519, "self_search": false}}]'))
K48_Q4096_PRESERVE_SHAPES = _decode_capture(_json_loads('[{"label": "blind_k48_q128_m131072_d128_k48", "params": {"B": 1, "D": 128, "K": 48, "M": 131072, "Q": 128, "dtype": "bfloat16", "min_recall": 0.999, "seed": 610518, "self_search": false}}]'))
...
def _compile_q4096_k48_split128_k48scratch_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0312"}, "partial": {"__kernel__": "dispatch_kernel_0311"}}'))
