...
knn_search_dynamic_d3_self_q2048_r123_7d2a_direct_v1 = _decode_capture(_json_loads('{"__ir__": "knn_search_dynamic_d3_self_q2048_r123_7d2a_direct_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10368, "constants": [["D_", 3], ["K_MAX_", 10], ["LOCAL_LIST_CAP_", 10], ["ROWS_PER_THREAD_", 16], ["NUM_WARPS_", 4]], "cta_group": 1, "threads": 128}'))
ir = _decode_capture(_json_loads('{"__ir__": "knn_search_dynamic_d3_self_q2048_r123_7d2a_direct_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 10368, "constants": [["D_", 3], ["K_MAX_", 10], ["LOCAL_LIST_CAP_", 10], ["ROWS_PER_THREAD_", 16], ["NUM_WARPS_", 4]], "cta_group": 1, "threads": 128}'))
...
def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"direct": {"__kernel__": "dispatch_kernel_0451"}}'))
