"""Round-135/4201 D129 M-tail K10 seed for kNN search.

Minimum target architecture: sm_100a for the tcgen05/TMEM producer path. This
additive bucket-kernel module targets ``B=1,Q=128,M=65537,D=129,K=10`` by
reusing the source-clean direct-stride dynamic-D tcgen05 producer from ccef.
The producer already guards the final M tile and zero-fills the partial D pass;
this module only adds the exact M-tail guard and keeps production dispatch
unchanged.
"""
...
parent_ir = _decode_capture(_json_loads('{"__ir__": "knn_search_dynamic_d_high_directstride_tcgen05_partial_0618_ccef_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 126720, "constants": [["K_MAX_", 10], ["D_ORIG_", 512], ["NUM_D_PASSES_", 4], ["Q_NORM_PARTS_", 32]], "cta_group": 1, "threads": 640}'))
ROUTE_D129_Q128_M65537 = '4201_d129_q128_m65537_k10_directstride_tcgen05'
ROUTE_PARENT_FLOOR13_DYNAMIC_D = '5f25_floor13_dynamic_d_parent'
CONSUMED_HIGH_D_SEED = highd.CONSUMED_SEED
CONSUMED_PARENT_SEEDS = _decode_capture(_json_loads('{"__tuple__": ["weave-evolve-knn-search-b5b2", "weave-evolve-knn-search-449d", "weave-evolve-knn-search-ccef-highd-directstride", "weave-evolve-knn-search-a2ab", "weave-evolve-knn-search-9286-d512-q64-row16-directstride", "weave-evolve-knn-search-ccef-highd-directstride", "weave-evolve-knn-search-ccef-highd-directstride", "weave-evolve-knn-search-9286-d768d1024-directstride-tcgen05", "weave-evolve-knn-search-449d", "weave-evolve-knn-search-ccef-highd-directstride", "weave-evolve-knn-search-5847-d384-q32-exact", "weave-evolve-knn-search-ccef-dynamic-d257-q64-k64-v2", "weave-evolve-knn-search-a2ab", "weave-evolve-knn-search-c8b9-tinyd-generated-d33", "weave-evolve-knn-search-ccef-highd-directstride", "weave-evolve-knn-search-9286-d768d1024-directstride-tcgen05"]}'))
CONSUMED_SEEDS: tuple[str, ...] = (*CONSUMED_PARENT_SEEDS, CONSUMED_HIGH_D_SEED)
TARGET_LABELS: tuple[str, ...] = ('exp_tail_q128_m65537_d129_k10',)
TARGET_SHAPES: list[dict[str, Any]] = [{'label': 'exp_tail_q128_m65537_d129_k10', 'params': {'B': 1, 'Q': 128, 'M': 65537, 'D': 129, 'K': 10, 'dtype': 'bfloat16', 'self_search': False}}]
ENTRYPOINT = 'loom.examples.weave.knn_search_d129_mtail_q128_k10_0622_4201_v1:launch_for_eval'
...
_TARGET_ENTRY: dict[str, Any] = {'shape_key': '4201_d129_q128_m65537_k10_directstride_tcgen05', 'label': 'exp_tail_q128_m65537_d129_k10', 'shape': (1, 128, 65537, 129, 10, False), 'guard': 'B == 1 and Q == 128 and M == 65537 and D == 129 and K == 10 and not self_search and not forced_fallback and arch in {sm_100a,sm_103a}', 'route': ROUTE_D129_Q128_M65537, 'entrypoint': ENTRYPOINT, 'source_entrypoint': SOURCE_ENTRYPOINT, 'selected_seed': CONSUMED_HIGH_D_SEED, 'source_round_doc': SOURCE_ROUND_DOC, 'coverage_class': 'bucket_seed_exp_tail_q128_m65537_d129_k10', 'arch_requirement': 'sm_100a', 'route_source': 'shape-specific-seed'}
...
def knn_search_compile_and_launch_d129_mtail_q128_k10_0622_4201(*, benchmark: bool=True, shapes: list[dict[str, Any]] | None=None) -> dict[str, Any]:
