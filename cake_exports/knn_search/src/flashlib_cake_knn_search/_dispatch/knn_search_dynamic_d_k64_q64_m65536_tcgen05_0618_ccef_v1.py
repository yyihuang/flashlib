...
K64 single-row merge consumer. Guard misses delegate to the scalar-capacity
parent route.
"""
...
_knn_mma_issue_stage128 = _ir_proxy('loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:_knn_mma_issue_stage128', 256)
_knn_accumulate_q_norm_d512 = _ir_proxy('loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:_knn_accumulate_q_norm_d512', 256)
_knn_stage_q_pass_d512 = _ir_proxy('loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:_knn_stage_q_pass_d512', 256)
_knn_stage_database_pass_d512 = _ir_proxy('loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:_knn_stage_database_pass_d512', 256)
knn_search_dynamic_d257_k64_q64_partial_0618_ccef_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:knn_search_dynamic_d257_k64_q64_partial_0618_ccef_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 151296, "cta_group": 1, "threads": 256}'))
knn_search_dynamic_d257_k64_q64_merge_0618_ccef_v1 = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:knn_search_dynamic_d257_k64_q64_merge_0618_ccef_v1", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
pack_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:pack_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 256}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:partial_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 151296, "cta_group": 1, "threads": 256}'))
merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:merge_ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 0, "cta_group": 1, "threads": 32}'))
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:ir", "cluster_dims": [1, 1, 1], "computed_smem_bytes": 151296, "cta_group": 1, "threads": 256}'))
ROUTE_DYNAMIC_D257_Q64_K64 = 'ccef_dynamic_d257_q64_m65536_k64_tcgen05'
CONSUMED_SEED = 'weave-evolve-knn-search-ccef-dynamic-d257-q64-k64'
...
SHAPE_DISPATCH_REGISTRY: tuple[dict[str, Any], ...] = ({'overlay': 'dynamic_d257_q64_m65536_k64_tcgen05_ccef', 'shape_key': 'B=1,Q=64,M=65536,D=257,K=64', 'labels': DYNAMIC_D257_Q64_K64_LABELS, 'guard': 'B == 1 and Q == 64 and M == 65536 and D == 257 and K == 64 and not self_search and not forced_fallback', 'route': ROUTE_DYNAMIC_D257_Q64_K64, 'entrypoint': 'loom.examples.weave.knn_search_dynamic_d_k64_q64_m65536_tcgen05_0618_ccef_v1:launch_for_eval', 'selected_seed': CONSUMED_SEED, 'source_task': 'generalize-auto-tuning ccef dynamic-D K64 Q64 bucket', 'coverage_class': 'bucket_seed_dynamic_d_k64_q64_m65536', 'workflow_mode': 'generalize_auto_tuning', 'auto_tuning_stage': 'bucket-kernel'},)
...
def _compile_pack_kernel():
    return _decode_capture(_json_loads('{"__kernel__": "dispatch_kernel_0258"}'))

def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0260"}, "partial": {"__kernel__": "dispatch_kernel_0259"}}'))
...
def _padded_buffers(inputs: dict[str, Any]) -> tuple[Any, Any]:
    import torch
    key = (int(inputs['B']), int(inputs['Q']), int(inputs['M']), int(inputs['D']), D_PAD, int(inputs['queries'].device.index or 0), id(inputs['queries']), str(inputs['queries'].dtype))
