...
def _compile_pack_kernel():
    return _decode_capture(_json_loads('{"__kernel__": "dispatch_kernel_0324"}'))

def _compile_kernels() -> dict[str, Any]:
    return _decode_capture(_json_loads('{"merge": {"__kernel__": "dispatch_kernel_0326"}, "partial": {"__kernel__": "dispatch_kernel_0325"}}'))
