...
ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0616_ed52_shared_synthesis_v1:ir"}'))
partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0616_ed52_shared_synthesis_v1:partial_ir"}'))
current_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0616_ed52_shared_synthesis_v1:current_ir"}'))
base_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0616_ed52_shared_synthesis_v1:base_ir"}'))
lowq_r3_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0616_ed52_shared_synthesis_v1:lowq_r3_ir"}'))
c027_prefix5_partial_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0616_ed52_shared_synthesis_v1:c027_prefix5_partial_ir"}'))
c027_prefix5_merge_ir = _decode_capture(_json_loads('{"__ir__": "loom.examples.weave.knn_search_seed_bank_export_dispatch_0616_ed52_shared_synthesis_v1:c027_prefix5_merge_ir"}'))
