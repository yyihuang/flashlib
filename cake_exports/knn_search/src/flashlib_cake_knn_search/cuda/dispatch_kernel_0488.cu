...
kernel_knn_search_target0628_d1024_q32_m65536_k64_final_merge16_9571_v2(float* __restrict__ group_distances, int* __restrict__ group_indices, float* __restrict__ out_distances, int* __restrict__ out_indices)
{
