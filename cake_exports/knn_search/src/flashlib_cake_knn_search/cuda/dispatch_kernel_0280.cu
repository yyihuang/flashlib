...
kernel_knn_search_target_highd_k64_final_merge_f505_hiermerge32_v1(float* __restrict__ group_distances, int* __restrict__ group_indices, float* __restrict__ out_distances, int* __restrict__ out_indices, int B, int Q, int K)
{
