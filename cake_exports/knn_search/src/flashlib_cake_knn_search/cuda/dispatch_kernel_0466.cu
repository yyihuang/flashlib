...
kernel_knn_search_d1024_q32_k64_hiermerge8_final_f561_v2(float* __restrict__ group_distances, int* __restrict__ group_indices, float* __restrict__ out_distances, int* __restrict__ out_indices)
{
