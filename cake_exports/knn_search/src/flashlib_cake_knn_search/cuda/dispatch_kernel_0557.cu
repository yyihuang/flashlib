...
kernel_knn_search_target0628_d1024_q32_m65536_k64_merge_9571_v1(float* __restrict__ partial_distances, int* __restrict__ partial_indices, float* __restrict__ out_distances, int* __restrict__ out_indices)
{
