...
#define K_MAX_ 10
#define D_ORIG_ 640
#define NUM_D_PASSES_ 5
#define Q_NORM_PARTS_ 40
                ...
                if (q_global < Q) {
                    ...
                    for (int j_rel = 0; j_rel < 32; j_rel += 8) {
                        ...
                        for (int _lf = 0; _lf < 1; _lf++)
                            fma_f32x2_inplace(&reinterpret_cast<float2*>(dist_pair0)[_lf], _fma_b2_11, _fma_c2_12);
                        ...
                        #pragma unroll
                        for (int _lf = 0; _lf < 1; _lf++)
                            fma_f32x2_inplace(&reinterpret_cast<float2*>(dist_pair1)[_lf], _fma_b2_13, _fma_c2_14);
                        ...
                        #pragma unroll
                        for (int _lf = 0; _lf < 1; _lf++)
                            fma_f32x2_inplace(&reinterpret_cast<float2*>(dist_pair2)[_lf], _fma_b2_15, _fma_c2_16);
                        ...
                        #pragma unroll
                        for (int _lf = 0; _lf < 1; _lf++)
                            fma_f32x2_inplace(&reinterpret_cast<float2*>(dist_pair3)[_lf], _fma_b2_17, _fma_c2_18);
