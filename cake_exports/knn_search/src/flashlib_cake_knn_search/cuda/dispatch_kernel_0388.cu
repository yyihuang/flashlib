...
kernel_knn_search_k48_q128split512_finalmerge32_strided_0614_ddbc_v1(float* __restrict__ group_distances, int* __restrict__ group_indices, float* __restrict__ out_distances, int* __restrict__ out_indices, int B, int Q, int K)
{
