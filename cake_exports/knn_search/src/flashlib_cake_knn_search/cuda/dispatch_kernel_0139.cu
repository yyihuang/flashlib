                    ...
                    for (int _blk = 0; _blk < 2; _blk++) {
                        ...
                        for (int _pair = 0; _pair < 4; _pair++) {
                            asm volatile(
                                ...
                                "mov.b64 %0, {lo, hi};\n\t"
                                "}\n"
                                : "=l"(*reinterpret_cast<unsigned long long*>(&q_vals_7[0 + _blk * 8 + _pair * 2]))
                                : "r"(_vpairs_13[_pair]));
                        }
                    }
                }
                                    ...
                                    for (int _blk = 0; _blk < 2; _blk++) {
                                        ...
                                        for (int _pair = 0; _pair < 4; _pair++) {
                                            asm volatile(
                                                ...
                                                "mov.b64 %0, {lo, hi};\n\t"
                                                "}\n"
                                                : "=l"(*reinterpret_cast<unsigned long long*>(&db_vals_6[0 + _blk * 8 + _pair * 2]))
                                                : "r"(_vpairs_14[_pair]));
                                        }
                                    }
                                }
                    ...
                    for (int _blk = 0; _blk < 2; _blk++) {
                        ...
                        for (int _pair = 0; _pair < 4; _pair++) {
                            asm volatile(
                                ...
                                "mov.b64 %0, {lo, hi};\n\t"
                                "}\n"
                                : "=l"(*reinterpret_cast<unsigned long long*>(&q_vals_8[0 + _blk * 8 + _pair * 2]))
                                : "r"(_vpairs_15[_pair]));
                        }
                    }
                }
                                    ...
                                    for (int _blk = 0; _blk < 2; _blk++) {
                                        ...
                                        for (int _pair = 0; _pair < 4; _pair++) {
                                            asm volatile(
                                                ...
                                                "mov.b64 %0, {lo, hi};\n\t"
                                                "}\n"
                                                : "=l"(*reinterpret_cast<unsigned long long*>(&db_vals_7[0 + _blk * 8 + _pair * 2]))
                                                : "r"(_vpairs_16[_pair]));
                                        }
                                    }
                                }
