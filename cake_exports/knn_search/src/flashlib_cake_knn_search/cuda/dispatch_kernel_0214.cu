...
kernel_knn_search_lowq_tile_reduce_partial_dispatch0610_r8_blockm512_v1(__nv_bfloat16* __restrict__ queries, __nv_bfloat16* __restrict__ database, float* __restrict__ partial_distances, int32_t* __restrict__ partial_indices, int B, int Q, int M, int K, int num_m_tiles)
{
