...
kernel_knn_search_d256_split256_groupmerge64_ownerless_7ce6_v1(float* __restrict__ partial_distances, int32_t* __restrict__ partial_indices, float* __restrict__ group_distances, int32_t* __restrict__ group_indices, int B, int Q, int K, int num_q_tiles)
{
