...
kernel_knn_search_k64_q4096split79_localprefix_cert_0615_r32_edd7_v1(float* __restrict__ partial_distances, int* __restrict__ partial_indices, float* __restrict__ out_distances, int* __restrict__ out_indices, int* __restrict__ overflow_flag, int B, int Q, int K, int partial_list_count, int num_q_tiles)
{
