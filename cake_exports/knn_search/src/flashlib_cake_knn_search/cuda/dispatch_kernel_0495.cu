...
kernel_knn_search_target0628_d64_q512_m65536_k64_finalmerge_e8f1_v1(float* __restrict__ group_distances, int32_t* __restrict__ group_indices, float* __restrict__ out_distances, int32_t* __restrict__ out_indices, int B, int Q, int K)
{
