...
kernel_knn_search_k64_q128split512_finalmerge32_indexfast_0614_r24_k64thin_v1(float* __restrict__ group_distances, int* __restrict__ group_indices, float* __restrict__ out_distances, int* __restrict__ out_indices, int B, int Q, int K)
{
