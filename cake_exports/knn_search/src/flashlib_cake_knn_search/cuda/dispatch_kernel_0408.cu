...
kernel_knn_search_k1_top1_margin_qfull_partial_0614_r93_v1(__nv_bfloat16* __restrict__ queries, __nv_bfloat16* __restrict__ database, float* __restrict__ partial_distances, int* __restrict__ partial_indices, int B, int Q, int M, int split_m, int num_q_tiles, int total_m_tiles, int tiles_per_split)
{
                ...
                if (tid < 512) {
                    ...
                    for (int vv_2 = 0; vv_2 < 2; vv_2++) {
                        ...
                        for (int vi_6 = 0; vi_6 < 16; vi_6++) {
                            acc_part_4_1 += db_vals_2[vi_6] * db_vals_2[vi_6];
                        }
                    }
