...
kernel_knn_search_target0628_d64_q256_m131072_k10_groupmerge_885d_hmerge8_v1(float* __restrict__ partial_distances, int32_t* __restrict__ partial_indices, float* __restrict__ group_distances, int32_t* __restrict__ group_indices, int B, int Q, int K, int num_q_tiles)
{
    ...
    int list_group_base = group_id * 256;
    float head_d[8];
    int head_i[8];
    int head_k[8];
    #pragma unroll
