...
kernel_knn_search_ext_k_capacity_q4096_m49152_merge24_0618_28ec_v1(float* __restrict__ partial_distances, int* __restrict__ partial_indices, float* __restrict__ out_distances, int* __restrict__ out_indices)
{
