...
kernel_knn_search_d256_split256_rows8_finalmerge8_hier9c25_v1(float* __restrict__ group_distances, int32_t* __restrict__ group_indices, float* __restrict__ out_distances, int32_t* __restrict__ out_indices, int B, int Q, int K)
{
