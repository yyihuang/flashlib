...
kernel_knn_search_k64_q4096split79_localprefix5_rowflag_fusedcert_merge_0615_r5_9a85_v1(float* __restrict__ partial_distances, int32_t* __restrict__ partial_indices, float* __restrict__ out_distances, int32_t* __restrict__ out_indices, int32_t* __restrict__ overflow_rows, int B, int Q, int K, int partial_list_count, int num_q_tiles)
{
