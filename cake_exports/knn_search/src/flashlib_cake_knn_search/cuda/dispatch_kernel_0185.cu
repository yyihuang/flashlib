...
kernel_knn_search_target0628_d64_q256_m131072_k10_finalmerge_885d_hmerge8_v1(float* __restrict__ group_distances, int* __restrict__ group_indices, float* __restrict__ out_distances, int* __restrict__ out_indices, int B, int Q, int K)
{
