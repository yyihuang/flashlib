...
kernel_knn_search_d1024_q8_tcgen05_partial_16warp_b3fc_v1(__nv_bfloat16* __restrict__ queries, __nv_bfloat16* __restrict__ database, float* __restrict__ partial_distances, int* __restrict__ partial_indices, int B, int Q, int M, int split_m, int num_q_tiles, int total_m_tiles, int active_split_m)
{
            ...
            if (tid < 512) {
                ...
                for (int vv_3 = 0; vv_3 < 2; vv_3++) {
                    ...
                    for (int vi_9 = 0; vi_9 < 16; vi_9++) {
                        acc_part_4_2 += db_vals_3[vi_9] * db_vals_3[vi_9];
                    }
                }
            ...
            if (tid < 512) {
                ...
                for (int vv_4 = 0; vv_4 < 2; vv_4++) {
                    ...
                    for (int vi_11 = 0; vi_11 < 16; vi_11++) {
                        acc_part_4_3 += db_vals_4[vi_11] * db_vals_4[vi_11];
                    }
                }
            ...
            if (tid < 512) {
                ...
                for (int vv_5 = 0; vv_5 < 2; vv_5++) {
                    ...
                    for (int vi_13 = 0; vi_13 < 16; vi_13++) {
                        acc_part_4_4 += db_vals_5[vi_13] * db_vals_5[vi_13];
                    }
                }
            ...
            if (tid < 512) {
                ...
                for (int vv_6 = 0; vv_6 < 2; vv_6++) {
                    ...
                    for (int vi_15 = 0; vi_15 < 16; vi_15++) {
                        acc_part_4_5 += db_vals_6[vi_15] * db_vals_6[vi_15];
                    }
                }
            ...
            if (tid < 512) {
                ...
                for (int vv_7 = 0; vv_7 < 2; vv_7++) {
                    ...
                    for (int vi_17 = 0; vi_17 < 16; vi_17++) {
                        acc_part_4_6 += db_vals_7[vi_17] * db_vals_7[vi_17];
                    }
                }
