...
EXPECTED_ROUTES = {row["label"]: row["selected_route"] for row in ROUTE_MANIFEST["routes"]}
...
def _run_shape(
    ...
    *,
    ...
    k = int(shape["K"])
    out, route_info = knn_search(query, database, k, arch=arch, return_info=True)
...
def main() -> int:
    ...
    payload: dict[str, Any] = {
        ...
        "semantic_entrypoint": ROUTE_MANIFEST["semantic_entrypoint"],
